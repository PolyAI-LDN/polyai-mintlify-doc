...
Define custom HTTP APIs in Agent Studio so your agent can fetch data, create records, and trigger downstream systems without hardcoding request logic in functions. This provides centralized API configuration, environment-aware routing, and a consistent runtime interface.
...
<Frame caption="Define APIs in Agent Studio">
...
<CardGroup cols={3}>
  <Card title="Functions" icon="code" href="/tools/introduction">
    Call defined APIs from your agent functions.
  </Card>
