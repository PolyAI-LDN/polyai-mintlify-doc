...
<Info>
**This page requires Python familiarity.** It covers defining and calling external APIs from Python functions inside Agent Studio. If you are a non-technical user, share this page with your developer. For pre-built integrations that don't require code, see [Integrations](/integrations/introduction).
</Info>
...
The **APIs** tab (under **Configure** in the Agent Studio sidebar) lets you define external HTTP APIs and reference them when building [functions](/function/introduction) and [flows](/flows/introduction).
