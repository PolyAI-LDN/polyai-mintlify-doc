...
description: 'Step-by-step guide to integrating a phone number hosted on Twilio with the PolyAI Agent Studio'
---

Follow these steps to integrate a phone number hosted on Twilio in-platform:

## Step 1: Navigate to your agent page

1. **Navigate to agent page**
   - Log in to your PolyAI account and go to the agent page.
...
4. **Click 'Generate SIP'**
   - Click the "Generate SIP" button. This will generate a SIP for your agent.
...
7. **Select the Phone Number**
   - Choose the phone number you want to integrate.
...
Once these steps are completed, your Twilio phone number will be integrated with our platform, allowing you to use it for voice services with your agent.
