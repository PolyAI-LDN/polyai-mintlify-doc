...
The PolyAI Agent Studio supports both inbound and outbound calling. For inbound calls, you can buy a number directly from our platform or integrate with your own Twilio account. For outbound calls, you can use the Outbound Calling API or route through your existing SIP infrastructure.
