...
1. **Go to the [knowledge base](/managed-topics/introduction) build page**
    - Ensure you are on the knowledge base builder page.

2. **Add an action to a knowledge base card**
    - In any knowledge base card, click ["Add Actions."](/managed-topics/how-to-setup-action/send-sms)
