...
3. **Set SMS action**
    ...
    ```plaintext
    After the user confirms that they would like to receive an SMS message with further details, use {{SMS_template}} to send the SMS out.
    ```
...
- **Personalization**: Use placeholders (e.g., username or account details) to personalize messages.
