...
Supported chat handoff integrations include [Salesforce](/integrations/chat/salesforce), [Zendesk](/integrations/chat/zendesk), [NICE CXone](/integrations/chat/nice-cxone), [Amazon Connect](/integrations/chat/amazon-connect), [Genesys Cloud](/integrations/chat/genesys), and [Webex by Cisco](/integrations/chat/webex).

## Example: Triggering an SMS alongside a voice handoff
Combine a [voice handoff](/call-handoff/introduction) with an outbound SMS:
