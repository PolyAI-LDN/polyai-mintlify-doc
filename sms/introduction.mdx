...
2. Fill in the form:
   - **Title**: A descriptive name for the SMS template (e.g., "CPNI_Password").
...
- **Personalization**: Use variables or dynamic fields (e.g., user name or account details) to enhance engagement.
...
For example, after transferring a call to the "School Visits" team, the assistant can send a follow-up SMS with details about booking school group visits.

For more information on handoffs, see the [Call Handoff documentation](/call-handoff/introduction).

By connecting Twilio and managing SMS templates effectively, you can enhance your assistant's capabilities and improve the user experience.