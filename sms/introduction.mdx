...
1. **Navigate to the [knowledge base](/knowledge-base/introduction) build page**
...
SMS can be triggered as part of a [function](/function/introduction) using [the `conv` objects](/function/conv-object):
 - `conv.send_sms`
