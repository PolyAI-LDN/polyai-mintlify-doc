...
<Tip>For full attributes and methods, see the [`conv` object](/tools/classes/conv-object) page.</Tip>
...
<Tip>For full voice configuration examples including ElevenLabs model IDs, Cartesia emotions, and cache behavior, see the [Voice class reference](/tools/classes/voice).</Tip>
