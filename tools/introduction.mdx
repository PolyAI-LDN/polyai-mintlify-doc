...
**This section requires Python familiarity.** If you are a non-technical operator, share this page with your developer. For no-code alternatives, see [Managed Topics](/knowledge/faqs/introduction) (actions) or [no-code flows](/flows/no-code/introduction).
...
If you are looking to use functions to enable multi-site configuration – for example, handling enquiries for multiple store or branch locations – visit the [variant management](/knowledge/variants/introduction) feature page.
...
- **Test thoroughly** – Use [Test Cases and Test Sets](/simulation-testing/introduction) to validate function behavior across scenarios.
