---
title: "Using tools"
description: "Attach functions to Managed Topics actions to call APIs and perform logic when topics match."
tag: "Code"
keywords:
  - using tools
  - function in topic
...
<CardGroup cols={3}>
  ...
  <Card title="Managed Topics actions" icon="bolt" href="/knowledge/faqs/actions/introduction">
