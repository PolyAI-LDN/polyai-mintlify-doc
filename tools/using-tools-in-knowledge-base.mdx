---
title: "Using tools"
description: "Attach functions to FAQs actions to call APIs and perform logic when topics match."
tag: "Code"
keywords:
  - using tools
  - function in topic
...
<CardGroup cols={3}>
  ...
  <Card title="FAQs actions" icon="bolt" href="/knowledge/faqs/actions/introduction">
