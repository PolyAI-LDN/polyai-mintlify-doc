...
<Info>
**This page requires Python familiarity.** It covers disabling [Managed Topics](/knowledge/faqs/introduction) from Python functions so they are excluded from retrieval for the rest of the conversation.
</Info>
...
- [Managed Topics](/knowledge/faqs/introduction)
