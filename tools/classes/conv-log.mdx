...
sidebarTitle: "Log"
description: "Write structured log entries visible in Conversation Review diagnostics using conv.log methods."
tag: "Code"
---
...
Users without PII permission won't see PII logs in Review or API responses. In addition, the live conversations endpoints that power the **[Live conversations panel](/analytics/conversations/review#live-conversations)** require PII access — requests from users without it are rejected with `403 Forbidden`, since live records always include un-redacted transcripts and contact details.
