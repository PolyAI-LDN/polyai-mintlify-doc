...
sidebarTitle: "API"
description: "Call configured APIs from functions using conv.api with automatic environment and auth handling."
tag: "Code"
---
...
- Staging base URL in Staging (`pre-release` in code)
