...
```python
@func_description("Configures ASR biasing for hospitality terms")
...
```python
@func_description("Sets weighted ASR biasing for booking-related terms")
...
```python
@func_description("Combines keyword and weighted ASR biasing for medical terms")
...
```python
@func_description("Sets ASR biasing for booking verification details")
...
```python
@func_description("Biases ASR toward the expected reference number, then clears it")
