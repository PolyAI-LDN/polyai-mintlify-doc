---
title: 'End tool'
description: 'Run post-call processing asynchronously after a PolyAI conversation ends, from writing metrics and CRM updates to triggering downstream workflows.'
tag: "Code"
keywords:
  - end tool
  - end function
