...
The end tool is a built-in tool that ships with every agent – you don't create it from scratch. Find it under **Build > Tools**, in the **Start and end tool calls** section at the top of the page. This section contains two pre-built cards (**Start tool** and **End tool**) that are automatically invoked before and after every conversation.

{/* TODO: add screenshot at /images/tools/end-tool-location.png showing the End tool card in the Start and end tool calls section */}
...
{/* TODO: add screenshot at /images/tools/end-tool-editor.png showing the end_function editor */}
