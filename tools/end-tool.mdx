...
For LLM-based extraction of categorized reasons, sentiment, and other transcript-wide fields, see [Post-call reporting](/analytics/custom-metrics/introduction).
