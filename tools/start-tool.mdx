...
![Start tool card highlighted in the Start and end tool calls section](/images/tools/start-tool-location.png)
...
<AccordionGroup>
  <Accordion title="Multi-site variant routing">
    ...
    **Full article:** [Variant management](/knowledge/variants/introduction)
  </Accordion>
