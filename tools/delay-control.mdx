...
This feature is ideal for **API-based functions** and **LLM utility functions** that experience irregular latency. It's **not** suitable for conversational steps where the function is near-instant or where multiple branches could be chosen. For near-instant functions, delay utterances will fire unnecessarily – causing a worse user experience than silence.
