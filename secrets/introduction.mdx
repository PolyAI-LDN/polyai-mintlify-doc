...
Store API keys, tokens, and credentials securely. Your agent's [functions](/tools/introduction) retrieve them at runtime – no hardcoded secrets in code, logs, or version history.
