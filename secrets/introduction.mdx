...
<Info>
**This section requires Python familiarity.** Secrets are retrieved from within Python [functions](/function/introduction). Creating and managing secrets in the UI does not require code.
</Info>
