...
<Tip>
Need to call the Agents API as yourself for a local script or coding agent? Use a [personal access token](/secrets/personal-access-tokens) instead — PATs inherit your user permissions and don't require key-level configuration.
</Tip>
...
<img src="/images/secrets/api-keys-configuration-button.png" alt="Configuration button on the API Keys page" />
...
<img src="/images/secrets/api-keys-metrics-configuration.png" alt="Metrics configuration panel showing response metrics and conversation transcript options" />
