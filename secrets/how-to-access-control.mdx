...
Open the secret details page of the specific secret for which you want to manage access control. Here, you'll find various details about the secret, including its name, description, and value.
