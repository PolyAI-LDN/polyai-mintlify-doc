...
PolyAI is an enterprise voice AI platform. Agents handle real customer calls – answering questions, making bookings, resolving issues, and handing off to humans. Most agents run on [Raven](/agent-settings/raven), PolyAI's proprietary LLM with sub-300ms latency across 24+ languages.
