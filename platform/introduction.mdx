...
description: Enterprise voice AI platform. Three surfaces for building, deploying, and managing agents that handle real customer calls.
mode: wide
keywords:
  - PolyAI platform
  - Agent Studio
...
PolyAI is an enterprise voice AI platform. Agents handle real customer calls — answering questions, making bookings, resolving issues, and handing off to humans. Every agent runs on [Raven](/agent-settings/raven), PolyAI's proprietary LLM with sub-300ms latency across 24+ languages.
...
<CardGroup cols={3}>
  <Card title="Agent Studio" icon="browser" href="/get-started/introduction">
    **Build with or without code**
    ...
    Build and maintain agents, view analytics, and manage deployments through a visual interface. No code required.
  </Card>
