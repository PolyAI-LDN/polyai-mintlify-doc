...
<Frame caption="Admin account role in user management">
...
<Frame caption="Permission level options (None, Read, Edit)">
...
<Frame caption="Example permission configurations">
