...
description: "Reference guide to the granular permissions PolyAI supports and how they map to roles for role-based access control across projects and environments."
keywords:
  - role permissions
  - access control
  - RBAC
...
<Note>
[Wren](/wren/introduction) is **available to everyone with access to a project**, not just admins. What Wren can do for you follows your per-area permissions: with **Edit** access it can build, modify, branch, and apply changes; with **Read** access you can still ask questions, explore the project, investigate calls, and analyze conversations, but Wren won't build, modify, create branches, or apply changes.
</Note>
