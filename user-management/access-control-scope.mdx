...
1. **Build**: Contains sections related to creating and configuring agent functionality, such as knowledge base, voice settings, about, rules, functions, call handoffs, and SMS settings.
2. **Analyze**: Includes features for analyzing and monitoring agent performance, such as overview (dashboard) and conversations.
