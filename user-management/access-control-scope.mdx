...
| Item | Controls |
|------|----------|
| **Agent analytics** | The **Analytics** page, which shows the agent analytics dashboard and the metrics panel |
| **Agent analysis** | The **Agent analysis** pages, where you create one-time analyses and performance-over-time analyses of conversations. Agent analysis is a legacy feature that is enabled on some accounts only. |
| **Metrics** | Custom metric definitions |
| **Analytics homepage** | Authoring of analytics homepage dashboards: create, edit, rename, duplicate, set as default, and delete. Every project member can view these dashboards. **Edit** is required to author them. |
