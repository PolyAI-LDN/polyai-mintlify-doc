...
- Use [Agent Builder](/agent-builder/introduction) (Beta) on enterprise clusters

<Note>
During the Beta, [Agent Builder](/agent-builder/introduction) is **available only to project admins** on enterprise clusters. Permissions will become more granular over time.
</Note>
