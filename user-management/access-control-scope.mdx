...
| Knowledge | Managed topics and connected knowledge |
...
| Configuration builder | Real-time config tools |
...
| Chat | Chat configuration, widget settings |
...
1. Go to **Configure > User Management**.
