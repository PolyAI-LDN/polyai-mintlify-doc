...
<Note>
**Permission migration.** If you notice unexpected changes to user permissions (such as Admin access being downgraded or project-level access being removed), this may be related to a permissions schema migration. Contact PolyAI support if you experience any permission discrepancies.
</Note>
