...
description: "Manage team members, invite users, and assign role-based permissions for your PolyAI account across Agent Studio projects and environments."
keywords:
  - user management
  - users
  - team
...
|------|------------------|
| **Home** | Wren, the natural-language builder |
...
- Expand **Analytics** to set separate permissions for **Conversations** vs **Dashboards**
