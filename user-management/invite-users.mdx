...
Navigate to the account landing page and locate the "Users" tab at the top alongside other tabs like Billing and Secrets. Click on the "Users" tab to proceed. Note that only "Admin" users have access to the user management feature.
