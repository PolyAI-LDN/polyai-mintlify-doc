...
<Steps>
  <Step title="Open user management">
    Go to **Account > Users** from the account landing page.
  </Step>
...
<Tip>After inviting a Member, configure their [permissions](/user-management/access-control-scope) to control which areas of Agent Studio they can access.</Tip>

<Note>
If a Member is added to an account but not assigned to any projects, they will see a "Page not found" screen when they log in. Make sure to assign at least one project to new Members after inviting them.
</Note>
