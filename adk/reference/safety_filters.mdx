...
<CardGroup>
  <Card title="Project-level (General)" href="https://docs.poly.ai/settings/introduction">
    Defaults applied across every channel.
  </Card>
  <Card title="Voice channel" href="https://docs.poly.ai/voice/voice-configuration#safety-filters">
    Per-channel overrides for voice.
  </Card>
  <Card title="Chat channel" href="https://docs.poly.ai/webchat/chat-configuration#safety-filters">
...
<CardGroup>
  ...
  <Card title="Chat settings" href="/adk/reference/chat_settings">
