...
<CardGroup>
  <Card title="Agent settings reference" href="/adk/reference/agent_settings">
    Configure personality, role, and rules that define agent behavior.
  </Card>
  <Card title="Flows reference" href="/adk/reference/flows">
