---
title: "SMS templates"
description: "Define reusable SMS text messages for confirmations, links, and verification codes in config/sms_templates.yaml, with dynamic variables from conversation state."
---
