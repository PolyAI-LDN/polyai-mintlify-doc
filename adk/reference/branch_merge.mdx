...
description: "Merge a feature branch back into main with poly branch merge, and resolve conflicts interactively or from a JSON file using the PolyAI ADK CLI."
---
