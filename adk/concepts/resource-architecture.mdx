...
<CardGroup>
  <Card title="Anti-patterns" href="/adk/concepts/anti-patterns">
  ...
  <Card title="Managed Topics (platform)" href="https://docs.poly.ai/managed-topics/introduction">
    How topics are retrieved, ranked, and used by the platform — including RAG mechanics and topic types.
  </Card>
  <Card title="Start function (platform)" href="https://docs.poly.ai/tools/start-function">
    Lifecycle hook reference — when it runs, what it can read, and common initialization patterns.
  </Card>
  <Card title="Connected Knowledge (platform)" href="https://docs.poly.ai/connected-knowledge/introduction">
