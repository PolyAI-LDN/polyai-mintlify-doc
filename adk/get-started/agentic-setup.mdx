...
description: "Get a PolyAI account and an API key for the PolyAI APIs and Dialog RSN from Claude Code, Cursor, or Codex by pasting one prompt. The assistant installs the PolyAI CLI and runs `poly apikey --region studio`, a non-interactive GitHub sign-in that saves your key and exports POLY_API_KEY."
---
