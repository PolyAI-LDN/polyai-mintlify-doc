...
description: "Return a fixed closing utterance from a function with hangup: True so the agent says exactly the intended goodbye and ends the call atomically."
---
