...
description: "Voice agent pattern that offers to send a link by SMS, and transfers the caller to a live agent when SMS isn't an option, using a deterministic function."
---
