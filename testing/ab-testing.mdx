...
- A version in Pre-release that you want to test against it (this becomes the variant). Get there with the standard [Staging flow](/environments-and-versions/branches-mode#make-a-small-change).
