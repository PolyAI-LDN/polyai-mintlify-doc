...
<Note>
Tests run against the Branch or Sub-branch you have open. Open the Branch you want to test before you start a run.
</Note>
...
<Tabs>
  ...
  2. Make sure the Branch you want to test is open.
...
- **Run after every significant change to your Branch** – catching regressions early saves time and prevents issues from reaching Live.
