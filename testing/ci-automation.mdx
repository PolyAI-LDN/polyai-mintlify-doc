...
description: "Gate PolyAI deployments on simulation test results by chaining Agents API publish and promote calls behind a passing test set in your CI pipeline."
keywords:
  - CI
  - automation
  - agents API
