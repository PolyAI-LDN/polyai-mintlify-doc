...
<Tip>
**Use [Agent Builder](/studio-assistant/introduction) to maintain topics in natural language.** Ask it to *"add a topic for store hours"*, *"tighten the refund answer"*, or *"create topics from `https://example.com/faq`"* — it edits Managed Topics on a branch you review before merging. You can also edit topics directly in this tab.
</Tip>
...
<Frame caption="How retrieval finds the best-matching topic">
  <img src="/images/managed-topics/kb-rag-ven.png" alt="Retrieval-augmented generation flow for Managed Topics" style={{ maxWidth: '720px', width: '100%', margin: '0 auto', display: 'block' }} />
</Frame>
