...
2. To create a new template, click **+ add sms template**. You will be redirected to the [SMS](/voice-channel/message-templates) section (**Messaging**) to define the message content and phone number.
