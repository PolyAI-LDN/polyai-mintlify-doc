...
2. To create a new template, click **+ add sms template**. You will be redirected to the [SMS](/messaging-channel/sms) section (**Build > SMS**) to define the message content and phone number.
