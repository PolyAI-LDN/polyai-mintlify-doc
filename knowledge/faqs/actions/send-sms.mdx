...
<Note>You must complete the [SMS setup](/messaging-channel/sms) (connect Twilio, create templates) before you can add SMS actions to topics.</Note>
...
2. To create a new template, click **+ add sms template**. You will be redirected to the [SMS](/messaging-channel/sms) section (**Messaging**) to define the message content and phone number.
