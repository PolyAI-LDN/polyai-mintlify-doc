...
<CardGroup cols={2}>
  <Card title="Send SMS actions" icon="message" href="/knowledge/faqs/actions/send-sms">
    Trigger SMS messages from Managed Topic actions.
  </Card>
  <Card title="Tool calls" icon="code" href="/knowledge/faqs/actions/tool-call">
    Call custom functions from topic actions.
  </Card>
  <Card title="Call Handoffs setup" icon="phone-forward" href="/voice-channel/handoffs">
