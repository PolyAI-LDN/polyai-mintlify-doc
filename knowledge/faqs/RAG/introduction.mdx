---
title: "RAG"
description: "How retrieval-augmented generation finds the right FAQ topic or Source content, then feeds it to the language model to answer a caller's question accurately."
keywords:
  - RAG
