...
You do not need to retrain a model when you update your Knowledge. RAG retrieves from the current Knowledge at query time. Updates are available in Sandbox straight away. They reach customers as soon as you [publish them to Live](/environments-and-versions/introduction).
