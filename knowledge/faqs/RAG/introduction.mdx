...
This page explains how your agent finds the right topic to answer a caller's question. You do not need to configure RAG directly – it works automatically based on how you structure your [Managed Topics](/knowledge/faqs/introduction) and [Connected Knowledge](/knowledge/sources/introduction).
