...
description: 'Serve multiple locations, brands, or configurations from one PolyAI agent by storing per-site attributes such as numbers, addresses, and hours as variants.'
tag: "Advanced"
keywords:
  - variants
  - Variants
