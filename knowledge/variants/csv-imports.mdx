...
<Steps>
  ...
  <Step title="Confirm import">
    Review the diff carefully and click **Confirm import**. Changes take effect immediately in the Branch you are editing.
  </Step>
</Steps>

Imports apply to the Branch you are editing in Sandbox. Publish the Branch to Live when you are ready. See the [variants overview](/knowledge/variants/introduction) for more on testing workflows.

## Best practices

- **Test before you publish** - Import into your Branch in Sandbox and check the result before publishing to Live
...
<CardGroup cols={2}>
  <Card title="Variants" icon="layer-group" href="/knowledge/variants/introduction">
