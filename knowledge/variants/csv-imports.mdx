---
title: 'CSV imports'
description: 'Create or update multiple PolyAI variants at once with a CSV file, useful for multi-site deployments and bulk changes to variant attributes.'
tag: "Advanced"
keywords:
  - CSV import
  - bulk import
