...
See [Variant management](/knowledge/variants/introduction) for the conceptual model.
...
<CardGroup cols={2}>
  ...
  <Card title="Variant management" icon="sitemap" href="/knowledge/variants/introduction">
