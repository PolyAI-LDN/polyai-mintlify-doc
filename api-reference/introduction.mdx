...
<Card title="PolyAI Conversation Endpoints" icon="telephone_receiver" href="https://github.com/gimki/docs/blob/main/api-reference/conversations/openapi.json">
  View the OpenAPI specification file for voice calls
</Card>

<Card title="PolyAI Chat Endpoints" icon="telephone_receiver" href="https://github.com/gimki/docs/blob/main/api-reference/conversations/openapi.json">
  View the OpenAPI specification file for web chat
</Card>
