...
|------|----|------|-------------|
| `AUTH_USER_NOT_FOUND` | 3001 | 403 | Token is valid but the user is not provisioned in the auth system. |
...
| `AUTH_USER_FORBIDDEN` | 3008 | 403 | Token is valid but the user cannot access the platform. |
