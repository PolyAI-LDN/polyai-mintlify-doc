...
description: "Track concurrent conversations over time for capacity planning and monitoring."
---
...
Example:
`GET https://api.uk-1.platform.polyai.app/v1/ws-t53y16r3/PROJECT-f76d75c2/conversations/concurrency`
