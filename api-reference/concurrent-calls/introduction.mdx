...
|-------|-------------|--------|
| `variant` | Separate series per variant with `variant_id` and `variant_name` | Implemented |
| `language` | Separate series per language | Not implemented (501) |
| `phone_number` | Separate series per phone number | Not implemented (501) |
