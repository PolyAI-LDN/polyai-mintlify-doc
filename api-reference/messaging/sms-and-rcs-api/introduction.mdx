---
title: "SMS API"
sidebarTitle: "SMS API"
description: "Trigger outbound SMS from your systems and let your PolyAI agent handle inbound replies over Twilio-hosted numbers with automatic session creation."
---
