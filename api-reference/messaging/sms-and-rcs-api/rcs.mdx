---
title: "RCS API"
sidebarTitle: "RCS API"
description: "Send and receive rich, interactive messages (images, videos, rich cards, carousels, location pins) over RCS, with automatic SMS fallback."
...
Your agent can send rich media to customers, including images, pdfs, links, and hosted videos, using the same attachments mechanism as other channels. For RCS, we also support `weblink` as an attachment type, which PolyAI automatically renders as:

- A [**<u>carousel</u>**](https://www.twilio.com/docs/content/carousel) of 1–10 cards (Note: carousels can incur a significant cost to serve, consult with your PolyAI Rep on expected volumes and requirements before implementing)
- A single [**<u>rich card</u>**](https://www.twilio.com/docs/content/twiliocard#message-preview) if there's only one attachment
