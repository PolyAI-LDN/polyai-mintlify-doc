...
Your agent can send rich media to customers, including images, pdfs, links, and hosted videos, using the same attachments mechanism as other channels. For RCS, the only supported attachment type is `weblink`, which PolyAI automatically renders as:

- A [**<u>carousel</u>**](https://www.twilio.com/docs/content/carousel) of 1–10 cards (Note: carousels incur a significant cost to serve, consult with your PolyAI Rep on expected volumes and requirements before implementing)
