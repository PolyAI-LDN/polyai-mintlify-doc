...
_A media widget with an image_
...
_Serialisation of the media widget with an image_
...
**LLM description:** _Returns an image attachment_
...
**LLM description:** _Returns a video attachment_
...
_A carousel widget with some items_
...
**LLM description:** _Returns a carousel_
...
_Response suggestions as chips_
...
<Frame>
  <img
    src="/images/chip-fall-back-1.png"
    alt="Chip Fall Back"
    title="Chip Fall Back"
    style={{ width:"64%" }}
  />
</Frame>

_Serialisation of response suggestions_
...
**LLM description:** _Returns a list of response suggestions_
