...
The Messaging API lets you embed real-time text conversations into your application. End users chat with a PolyAI agent, and when needed, the conversation can be seamlessly handed off to a live human agent — all within the same session.
