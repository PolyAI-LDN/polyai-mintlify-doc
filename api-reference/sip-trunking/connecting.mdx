...
4. Set the dialed user part to a configured **extension** so the call reaches the right agent, or configure a [default route](/api-reference/sip-trunking/introduction#default-route) for numbers without one.
