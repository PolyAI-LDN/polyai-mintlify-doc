...
```bash curl
curl -X GET \
  "https://api.us-1.platform.polyai.app/v1/ws-xxxxxxxx/PROJECT-xxx/handoff_state?id=CONV-1234567890" \
...
response = requests.get(
    "https://api.us-1.platform.polyai.app/v1/ws-xxxxxxxx/PROJECT-xxx/handoff_state",
...
const res = await fetch(
  `https://api.us-1.platform.polyai.app/v1/ws-xxxxxxxx/PROJECT-xxx/handoff_state?${params}`,
  { headers: { "x-api-key": "YOUR_API_KEY" } }
);
