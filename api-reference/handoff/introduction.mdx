...
response = requests.get(
    "https://api.<region>.platform.polyai.app/v1/ws-xxxxxxxx/PROJECT-xxx/handoff_state",
...
const res = await fetch(
  `https://api.<region>.platform.polyai.app/v1/ws-xxxxxxxx/PROJECT-xxx/handoff_state?${params}`,
  { headers: { "x-api-key": "YOUR_API_KEY" } }
);
