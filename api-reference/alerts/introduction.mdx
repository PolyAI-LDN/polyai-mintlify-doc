...
<Note>
API keys are not yet available through self-service. API keys must be manually whitelisted for access — contact the API team to enable your key. This will eventually be self-serve. To request an API key, email [developers@poly.ai](mailto:developers@poly.ai).
</Note>
