...
<Info>
**The example below requires Python familiarity.** It shows how a developer can access `integration_attributes` inside a start function. If you only need to set up the Chat API endpoints, you can skip this section.
</Info>
