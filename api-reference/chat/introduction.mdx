...
```bash curl
curl -X POST \
  "https://api.us-1.platform.polyai.app/v1/ws-xxxxxxxx/PROJECT-xxx/chat/create" \
...
```bash curl
curl -X POST \
  "https://api.us-1.platform.polyai.app/v1/ws-xxxxxxxx/PROJECT-xxx/chat/respond" \
  -H "X-API-KEY: YOUR_API_KEY" \
  -H "X-TOKEN: YOUR_TOKEN" \
  -H "Content-Type: application/json" \
  -d '{
...
```bash curl
curl -X PUT \
  "https://api.us-1.platform.polyai.app/v1/ws-xxxxxxxx/PROJECT-xxx/chat/close" \
  -H "X-API-KEY: YOUR_API_KEY" \
  -H "X-TOKEN: YOUR_TOKEN" \
  -H "Content-Type: application/json" \
