...
Smart Analyst analyzes up to **500 conversations** for patterns (10× the previous limit). Conversations are sampled **randomly** or **based on a [custom metric](/settings/metrics) / PolyScore**.
...
<Tip>
Deep sampling is useful for exploratory analysis when you want to understand broad trends across many conversations. Well-defined [custom metrics](/settings/metrics) improve sampling quality — the clearer your metric definitions, the more targeted Smart Analyst's analysis becomes.
</Tip>
