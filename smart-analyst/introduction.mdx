...
**Smart Analyst** uses AI to review calls from the past 24 hours. Ask natural-language questions like *"What are the top escalation reasons?"* and get immediate answers without writing queries.

The analyst appears as a chatbot inside Studio, analyzing recent calls and surfacing insights on agent usage, customer sentiment, and conversation drop-off patterns.

### Key benefits
- Ask freeform questions about call data
