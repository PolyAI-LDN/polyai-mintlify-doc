...
description: "Localise your PolyAI web chat widget UI and agent responses to serve customers in multiple languages, with translated strings and per-locale settings."
---
