...
description: "Configure the LLM, greeting message, and safety filters for your PolyAI web chat agent, and control how it opens and closes each session."
keywords: ["chat configuration", "chat settings", "LLM config", "chat greeting", "safety filters"]
sidebarTitle: "Chat Agent Configuration"
---
...
<ParamField path="Style prompt" type="string">
