...
Some regulated markets require you to tell users plainly when they are talking to an AI. Two settings in **Widget Configuration → Styling** control how that disclosure appears in the widget, so you can choose a visible per-message label, a lighter footer credit, or both.
