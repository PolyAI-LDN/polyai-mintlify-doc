...
<Columns cols={2}>
  <Card title="Disclaimers and privacy policies" icon="file-text" href="/messaging-channel/advanced/disclaimers-and-privacy-policies">
    Configure your legal disclosures, consent and privacy policy links.
  </Card>

  <Card title="Chat configuration" icon="sliders" href="/messaging-channel/advanced/chat-configuration">
...
<Columns cols={2}>
  <Card title="Web chat localisation" icon="globe" href="/messaging-channel/advanced/localisation">
