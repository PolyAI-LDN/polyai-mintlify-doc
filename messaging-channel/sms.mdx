...
1. **Go to [Build > Knowledge > Managed Topics tab](/knowledge/faqs/introduction)**
...
Combine [handoff](/voice-channel/handoffs) functionality with SMS:
...
<CardGroup cols={3}>
  <Card title="Managed Topics actions" icon="bolt" href="/knowledge/faqs/actions/send-sms">
