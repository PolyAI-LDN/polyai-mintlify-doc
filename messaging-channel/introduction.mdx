...
description: "Deploy a web chat version of your PolyAI agent alongside voice, with an embeddable widget, custom styling, disclaimers, and localisation support."
mode: "wide"
