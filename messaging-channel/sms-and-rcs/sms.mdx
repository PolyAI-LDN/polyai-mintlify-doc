...
<CardGroup cols={3}>
  <Card title="Inbound (2-way)" icon="inbox">
    Customer texts the agent number. Best for FAQ, account servicing, and queue callback replies.
  </Card>
...
<CardGroup cols={2}>
  <Card title="FAQ and inbound support" icon="circle-question">
    Store hours, eligibility, status checks. Highest volume, lowest complexity SMS traffic.
  </Card>

  <Card title="Queue callback and voice deflection" icon="phone-arrow-down-left">
    Deflect from a busy voice queue. Customers wait outside the queue, agents work down the backlog.
  </Card>

  <Card title="Appointment reminders and confirmations" icon="calendar-check">
    Booking system triggers a templated confirmation. Reschedule replies route to a live agent.
  </Card>

  <Card title="Post-call follow-up and surveys" icon="message-check">
    Send a CSAT link or open survey prompt after a voice call ends.
  </Card>

  <Card title="Order updates and delivery tracking" icon="box">
    OMS or WMS fires status updates. Tracking questions route to an inbound agent.
  </Card>

  <Card title="Re-engagement and lifecycle campaigns" icon="rotate">
    Marketing CRM triggers templated sends. Two-way replies route into the inbound flow.
  </Card>
  ...
  <Card title="Account alerts and fraud notifications" icon="shield-check">
    Banking or FS system triggers alerts with one-tap reply for identity verification.
  </Card>

  <Card title="OTPs and auth confirmations" icon="key">
    Fire-and-forget one-time passwords and authentication confirmations.
  </Card>
</CardGroup>
