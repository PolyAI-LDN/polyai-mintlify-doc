...
Source Hub is a fast way of exposing external knowledge to your agent. You can connect URLs, files, or platform integrations, keep them synced, and toggle availability across environments or variants.

Source Hub does **not** replace the [Knowledge Base](/knowledge-base/introduction). They work together, and each offers different levels of control and complexity.
...
Both Source Hub and the Knowledge Base expose information to your agent. They differ in the following ways:
...
| --- | --- | --- |
| **Source Hub** | Helps teams avoid maintaining another curated knowledge base and gives non-technical users a simple, fast way to connect and manage external data. | Best for FAQ bots, quickly incorporating external knowledge, and controlling data access across environments or variants. |
...
### Data structure
Source Hub splits content into 2000-character chunks with 500-character overlap. Very large documents or widely separated related sections may struggle more with relevance.
