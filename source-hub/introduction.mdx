...
This feature reduces the need for Dialogue Designers or developers to manually copy content into the Knowledge Base, and it gives you traceability through citations in Conversation Review.
...
Source Hub allows you to bring these together, update them in place, and reuse them across agent projects without rewriting content.

<Info>
This supports the long-term goal of making PolyAI an **enterprise-grade knowledge grounding platform**.
</Info>
...
More integrations are planned, including Salesforce, webhooks, and API-based source ingestion.
