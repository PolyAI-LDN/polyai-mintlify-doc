...
Explore the update cards for release summaries:
    ...
    <Update label="April 2025">
      ...
      - **[Utility functions – extract address](./notes/25.04#utility-function-extract-address)**: The first utility function. Parse user-provided addresses, and returns structured fields and handles errors. Currently an **opt-in** feature.
