...
Explore the update cards for release summaries:
    ...
    <Update label="April 2025">
      ...
      - **[Call categorization](./notes/25.04#call-categorization)**: Call metrics can be applied to check for tone, compliance, or intent success. Categories are defined per project by the PolyAI team, so contact your representative for more details.
      - **[Enhanced diagnosis logging in Agent Studio](./notes/25.04#enhanced-diagnosis-logging)**: View grouped logs—flows, functions, LLM requests, and more—directly in conversation review. Diagnose behaviour without needing Datadog access.
