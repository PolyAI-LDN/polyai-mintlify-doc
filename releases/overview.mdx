...
<Update label="May 2026">
  <Card>![may-release-main-image](/images/release-notes/2605/polyscore-webchat.png)</Card>

  Click the **bolded** titles for a breakdown of what's new, or go to the [notes tab](./notes/26.05) for full details.

  - **[PolyScore for webchat](./notes/26.05#polyscore-webchat)**: Every eligible webchat session now receives the same automated 0–10 quality score used for voice – same dimensions, same color coding, same QA workflows across both channels.
