...
<Update label="July 2025">
  <Card>![july-release-main-image](/images/release-notes/2507/aws-quicksight.png)</Card>

  Click the **bolded** titles for a breakdown of what's new, or go to the [notes tab](./notes/25.07) for full details.

  - **[AWS QuickSight integration](./notes/25.07#aws-quicksight**: Connect dashboards via AWS QuickSight in **Nebula** for smoother BI integration.
  - **[Rich text refactor](./notes/25.07#rich-text-refactor)**: The rich text editor has been refactored for improved usability and future extensibility.
  - **[New Amazon voice option](./notes/25.07#new-amazon-voice-option)**: A new high-quality Amazon Polly voice is now available in the voice library.
  - **[Smart Analyst v2](./notes/25.07#smart-analyst-v2)**: Improvements to our LLM-powered QA tool for scoring, summarization, and containment flagging.
