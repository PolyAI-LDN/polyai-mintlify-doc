...
<Update label="March 2026">
  ...
  - **[LLM Request visibility](./notes/26.03#llm-prompt-visibility)**: Click the Request button on any turn to see the full LLM request payload — conversation history, system prompt, and model metadata — in a side panel.
  ...
  - **[New voice providers: Cartesia and Hume](./notes/26.03#new-voice-providers)**: Cartesia and Hume are now available as TTS providers, with emotion control, voice description, and ultra-low latency options.
</Update>
