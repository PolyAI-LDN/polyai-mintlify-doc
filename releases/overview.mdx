...
Explore the update cards for release summaries:
    ...
    <Update label="March 2025">
      ...
      - **[Faster knowledge base imports](./notes/25.03#faster-knowledge-base-imports)**: CSV upload speeds have improved significantly thanks to GPU-powered embedding inference.
