...
<Update label="June 2025">
  ...
  - **[Smart analyst (Beta)](./notes/25.06#smart-analyst-v1-beta)**: This LLM-powered QA tool can rate calls, summarize agent behavior, and flag weak containment. Contact your PolyAI rep to participate in the Smart Analyst **beta**.
