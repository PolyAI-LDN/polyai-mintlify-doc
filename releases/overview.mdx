...
<Update label="Coming 24 June 2026">
  **New Agent Studio layout.** On 24 June we're rolling out a cleaner Studio sidebar that consolidates 25+ pages into 15 grouped sections. No functionality changes — agents behave exactly as before.
  ...
  See **[Meet the new Agent Studio](/get-started/ia-redesign)** for the full migration guide, including a section-by-section "was → now" map and a list of features that have moved.
