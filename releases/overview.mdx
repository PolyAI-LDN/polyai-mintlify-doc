...
<Update label="June 2026">
  ...
  - **[PII redaction – new pipeline](./notes/26.06#pii-redaction-pipeline)**: Redaction now runs on the new LLM data pipeline (replacing Azure Language Services) with more sensitive detection across transcripts and recordings; for PII-restricted users, Diagnosis layers and the AI summary are also hidden on conversations that contain PII.
</Update>
