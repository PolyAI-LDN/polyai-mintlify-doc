...
Explore the update cards for release summaries:
    ...
    <Update label="April 2025">
      <Card>![april-release-main-image](/images/release-notes/2504/main.png)</Card>

      Click the **bolded** titles for a detailed breakdown of the released feature, or navigate to the [notes tab](./notes/25.04) on the sidebar for the full release notes.

      - **[Call analysis and categorisation](./notes/25.04#call-analysis-and-categorisation)**: Call metrics can be applied to check for tone, compliance, or intent success. Categories are defined per project by the PolyAI team, so contact your representative for more details.
      - **[Enhanced diagnosis logging in Agent Studio](./notes/25.04#enhanced-diagnosis-logging-in-agent-studio)**: View grouped logs—flows, functions, LLM requests, and more—directly in conversation review. Diagnose behaviour without needing Datadog access.
      - **[Custom columns in conversation review](./notes/25.04#custom-columns-in-conversations)**: Choose which metrics appear by default—whether standard fields or custom project-specific metrics.
      - **[Workspace filter in Conversations](./notes/25.04#workspace-filter-in-conversations)**: Narrow reviews by workspace for easier triage across teams, versions, or QA scopes.
      - **[Utility function – extract address](./notes/25.04#utility-function-extract-address)**: Parse user-provided addresses with an LLM-powered method. Returns structured fields and handles errors gracefully. Currently in private beta.
      - **[Importing and exporting variants](./notes/25.04#import-and-export-variants)**: Export and edit variant data via CSV, then re-import with overwrite warnings and change summaries. Designed for large multi-site agents.
      - **[Variant ID added to conversations](./notes/25.04#variant-id-added-to-conversations)**: See which variant was active in each call—ideal for QA, debugging, and traceability.
    </Update>
    ...
    <Update label="March 2025">
      ...
      - **[Live collaboration support](./notes/25.03#live-collaboration-and-edit-history)**: Agent Studio now shows who else is editing a draft, alerts you when updates are saved, and lets you review edit history to avoid accidental overwrites.
