...
<Update label="March 2026">
  ...
  - **[MCP tool connections](./notes/26.03#mcp-tool-connections)**: Connect MCP servers to your agent to access external tools and data sources during conversations, with per-tool filtering and multiple auth methods.
  - **[Public Deployments API](./notes/26.03#public-deployments-api)**: Manage environment promotions programmatically — list, promote, roll back, and publish deployments via authenticated API calls.
  - **[NICE CXone integration](./notes/26.03#nice-cxone-integration)**: Hand off chat conversations to **NICE CXone DFO** agents with end-to-end state tracking.
  - **[Webhook improvements](./notes/26.03#webhook-improvements)**: Rotate signing secrets in place, receive `alerts.resolved` webhook events, and benefit from server-side resource limits.
  - **[Smart Analyst updates](./notes/26.03#smart-analyst-updates)**: Run analyses against webchat conversations, get CSAT metrics by default, test in Brazilian Portuguese, and configure deep sampling prompts.
  - **[Voice and multilingual improvements](./notes/26.03#voice-multilingual-improvements)**: Automatic voice switching on language change, filler utterances that chain across consecutive functions, and ASR corrections in no-code flows.
  - **[Dashboard and analytics updates](./notes/26.03#dashboard-analytics-updates)**: Dashboards now use your local timezone, and agent memory supports custom lookup keys beyond phone number.
  - **[Bug fixes](./notes/26.03#bug-fixes)**: Fixed test case execution and improved Zendesk integration reliability.
</Update>

<Update label="February 2026">
  <Card>![february-release-main-image](/images/release-notes/2602/csat.png)</Card>
  ...
  - **[Smart Analyst deep sampling](./notes/26.02#deep-sampling)**: Analyze up to 500 conversations (10× the previous limit) with random or metric-based sampling to uncover patterns and get directional insights at scale.
...
<Update label="December 2025">
  <Card>![december-release-main-image](/images/release-notes/2512/no-code-flows.png)</Card>
...
<Update label="November 2025">
  <Card>![november-release-main-image](/images/release-notes/2511/source-hub.png)</Card>

  Click the **bolded** titles for a breakdown of what's new, or go to the [notes tab](./notes/25.11) for full details.

  - **[Connected Knowledge](./notes/25.11#source-hub)**: Add, group, and refresh multiple knowledge sources in the Knowledge area — files, URLs, and third-party integrations — with environment/variant scoping and per-chunk citations in Conversation Review.
  - **[Integrations overview page](./notes/25.11#integrations-overview-page)**: Browse a searchable, filterable catalogue of supported telephony, chat, CRM, vertical, and KB integrations directly inside Agent Studio.
...
<Update label="October 2025">
  <Card>![october-release-main-image](/images/release-notes/2510/live-listening.png)</Card>
  ...
  - **[Email from Functions](./notes/25.10#email-from-functions)**: Use `conv.send_email()` in functions to send templated notifications, confirmations, or alerts — with support for HTML, CC/BCC, and file attachments.
</Update>

<Update label="September 2025">
  <Card>![september-release-main-image](/images/release-notes/2509/webchat.png)</Card>
  ...
  - **[Home page updates](./notes/25.09#home-page-updates)**: Average PolyScore summary, evolution charts for Containment and PolyScore, and clearer distribution labelling.
  - **[Smart Analyst: chat history + structured answers](./notes/25.09#smart-analyst-reasoning-logic-and-chat-history)**: Resume past analyses, rename or delete conversations, and view answers with sources and steps.
  - **[Numbers tab](./notes/25.09/#numbers-tab): Buy and manage numbers quickly and assign them to variants for multi-site deployments.
