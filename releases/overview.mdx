...
<Update label="April 2026">
  ...
  - **[Multilingual configuration](./notes/26.04#multilingual-configuration)**: Add up to 10 languages per project, assign per-language voices with auto-switching, and manage translation overrides in the new **Language Hub** — all from the UI.
</Update>
