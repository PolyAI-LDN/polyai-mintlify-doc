...
<Update label="August 2025">
  <Card>![august-release-main-image](/images/release-notes/2508/august-release.png)</Card>
  ...
  - **[Home page improvements](./notes/25.08#homepage-optimisation)**: Faster load times and a cleaner layout on the Agent Studio homepage dashboard.
  ...
  - **[Enhanced call review filters](./notes/25.08#enhanced-call-review-filters)**: New options for delivery status, channel, and other metadata—plus snappier filtering.
