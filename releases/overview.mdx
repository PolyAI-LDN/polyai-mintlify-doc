...
<Update label="May 2025">
  ...
  - **[Handoff reason and utterance](./notes/25.05#handoff-reason-and-utterance)**: You can now include structured `reason` and `utterance` fields when triggering a built-in handoff, ensuring clarity in logs.
</Update>
