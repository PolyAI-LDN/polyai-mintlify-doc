...
<Update label="August 2025">
  ...
  - **[In-app calling with variants](./notes/25.08#in-app-calling-with-variants)**: Run voice test calls against specific variants from the Test panel, with transcripts tagged by `variant_id`.
  - **[Smart Analyst improvements](./notes/25.08#smart-analyst-improvements)**: Clickable call IDs link directly to Conversation Review, SQL query range expanded, and improved search performance. Smart Analyst now runs on **nebula-api** for reliability.
  - **[Start/End function error warnings](./notes/25.08#start-end-function-error-warnings)**: Clear UI alerts when Start or End functions contain errors that prevent execution.
</Update>
