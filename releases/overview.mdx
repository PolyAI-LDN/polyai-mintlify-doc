...
<Update label="November 2025">
  ...
  - **[Source Hub](./notes/25.11#knowledge-source-hub)**: Add, group, and update multiple knowledge sources — including files, URLs, and external integrations — with citations now appearing in Conversation Review.
  - **[SMS messaging-service IDs](./notes/25.11#sms-messaging-service-ids)**: Use Twilio Messaging Service IDs (`MGxxxx`) in SMS fields, which were previously restricted to phone numbers.
</Update>
