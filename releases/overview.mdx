...
<Update label="February 2026">
  <Card>![february-release-main-image](/images/release-notes/2602/chat-config.png)</Card>

  Click the **bolded** titles for a breakdown of what's new, or go to the [notes tab](./notes/26.02) for full details.

  - **[Channels and navigation reorganization](./notes/26.02#channels-navigation-reorg)**: New **Channels** section with dedicated Voice, Chat, and Widget configuration pages, plus sidebar restructuring under Build and Deployments.
  - **[Webchat enhancements](./notes/26.02#webchat-markdown)**: Chat/Webchat is now generally available with improved configuration flows and full markdown rendering in Test Chat and Conversation Review.
  - **[Easy telephony integrations](./notes/26.02#ccaas-integrations)**: Click-based integrations for **Dialpad, Twilio, and Five9**, with streamlined routing via the updated Handoffs page.
  ...
  - **[Voice, security & usability updates](./notes/26.02#security-usability-updates)**: Delay control visibility, disclaimer sync improvements, secret value masking, expanded sample questions, and simplified conversation filtering.
