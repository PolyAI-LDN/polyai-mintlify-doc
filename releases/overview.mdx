...
<Update label="February 2026">
  <Card>![february-release-main-image](/images/release-notes/2602/main.png)</Card>

  Click the **bolded** titles for a breakdown of what's new, or go to the [notes tab](./notes/26.02) for full details.

  - **[Channels reorganisation](./notes/26.02#channels-navigation-reorg)**: New **Channels** section in the sidebar with dedicated Voice, Chat, and Widget configuration pages, separating channel-specific settings from shared project resources.
  - **[Webchat & Chat enhancements (GA)](./notes/26.02#webchat-markdown)**: Chat/Webchat is now generally available, with markdown rendering in Test Chat and Conversation Review, plus clearer chat and widget configuration flows.
  - **[CCaaS telephony integrations](./notes/26.02#ccaas-integrations)**: Click-based integrations for **Dialpad, Twilio, and Five9**, with streamlined routing via the updated Handoffs page.
  - **[Compare versions and environments](./notes/26.02#version-comparison)**: Side-by-side environment comparison with newest-first version ordering for safer promotions.
  - **[In-app calling with variants](./notes/26.02#in-app-call-variants)**: Test calls against specific variants directly in Studio, with cleaner configuration and naming consistency.
  - **[Configuration, security & review updates](./notes/26.02#security-usability-updates)**: Custom integration edit forms, inline delay control visibility, secret value masking, expanded sample questions, and simplified conversation filtering.
</Update>
...
<Update label="November 2025">
  ...
  - **[Connected Knowledge](./notes/25.11#source-hub)**: Add, group, and refresh multiple knowledge sources — files, URLs, and third-party integrations — with environment/variant scoping and per-chunk citations in Conversation Review.
