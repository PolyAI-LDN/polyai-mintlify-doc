...
<Update label="April 2025">
  ...
  - **[Metrics](./notes/25.04#metrics)**: Use the new Assistant Analysis tab run custom metrics across batches of calls and generate insight-rich evaluations.
  ...
  - **[Enhanced diagnosis logging in Agent Studio](./notes/25.04#enhanced-diagnosis-logging)**: Grouped logs for real time—flows, functions, LLM calls, and more.
  ...
  - **[Utility function – extract_address](./notes/25.04#utility-function-extract_address)**: Extracts a structured address from a user message. Returns a typed object, or a clear error. Opt-in only.
