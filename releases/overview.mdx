...
<Update label="November 2025">
  ...
  - **[Source Hub](./notes/25.11#knowledge-source-hub)**: Add, group, and refresh multiple knowledge sources — files, URLs, and third-party integrations — with environment/variant scoping and per-chunk citations in Conversation Review.
