...
<Update label="July 2025">
  ...
  - **[Smart Analyst v2](./notes/25.07#smart-analyst-enhancements)**: Improvements to our LLM-powered QA tool with support for better visualization, including charts and diagrams.
  - **[Rich text refactor](./notes/25.07#rich-text-refactor)**: Text fields now operate using intuitive **rich text**, so you can search for flow, function, or other project item by typing a slash **/**.
  - **[New Amazon voice option](./notes/25.07#add-amazon-polly-voices)**: You can now add voices from [Amazon Polly](https://aws.amazon.com/polly/) directly to your Agent Studio project in the **Agent voice** tab.
