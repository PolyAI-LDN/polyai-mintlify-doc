...
<Update label="September 2025">
  <Card>![september-release-main-image](/images/release-notes/2509/hero.png)</Card>

  Click the **bolded** titles for a breakdown of what's new, or go to the [notes tab](./notes/25.09) for full details.

  - **[Webchat configuration](./notes/25.09#webchat-config)**: Customize assistant name, button text, and widget colors; preview via iframe; deploy with a script tag.
  ...
  - **[Reworked exports: Calls & Annotations](./notes/25.09#reworked-exports)**: Export All now respects custom table columns with a 10k cap; internal **Export Annotations** preserved.
