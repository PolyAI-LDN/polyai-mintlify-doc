...
<Update label="May 2025">
  ...
  - **[Handoff reason and utterance](./notes/25.05#handoff-reason-and-utterance)**: You can now include include `reason` and `utterance` fields when writing a handoff implementation in a KB topic, flow, or other open configuration field.
</Update>
