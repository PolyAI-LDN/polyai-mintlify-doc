...
<Update label="August 2026">
  ...
  - **[New PolyScore](./notes/26.08#new-polyscore)**: Released 5 August. PolyScore moved from a 0–10 scale to a **1–5 scale**, backed by a transparent rubric that natively scores voice, messaging, and email (inbound and outbound). Two dimensions — **Agent quality** and **Task success** — combine into the overall score, with explicit rules for handoffs, self-service paths, and design-driven declines. See [PolyScore](/analytics/polyscore).
</Update>
