...
<Update label="February 2026">
  ...
  - **[Compare versions and environments](./notes/26.02#version-comparison)**: Review Sandbox, Pre-release, and Live side by side before promotion, with clearer ordering and navigation.
  - **[User permissions](./notes/26.02#user-permissions)**: Assign mixed access per area (None/Read/Edit) — for example, let users edit the Knowledge Base while keeping Functions read-only — aligned to the new navigation structure.
