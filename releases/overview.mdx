...
<Update label="March 2026">
  ...
  - **[Source Hub file preview in Conversation Review](./notes/26.03#source-hub-file-preview)**: View source documents (such as PDFs from Connected Knowledge) inline in Conversation Review, alongside existing topic citations on the Diagnosis tab.
  - **[LLM prompt visibility](./notes/26.03#llm-prompt-visibility)**: The LLM Request section in Conversation Review now renders the raw prompt with cleaner formatting and tidied whitespace for easier debugging.
...
<Update label="September 2025">
  ...
  - **[Home page updates](./notes/25.09#home-page-v2)**: Average PolyScore summary, evolution charts for Containment and PolyScore, and clearer distribution labelling.
