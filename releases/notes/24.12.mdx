...
[functions](/function/introduction), and [Knowledge](/managed-topics/introduction) entries, with the `${variant_foo}` format:
...
<Tip>You can add logic to your [start function](/function/start-function) to direct the agent to likely variant Knowledge items
