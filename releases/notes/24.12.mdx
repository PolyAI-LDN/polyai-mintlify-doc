...
The **December 2024** release adds variants, which enable multi-site configuration with individual agent now able to access multiple partitioned knowledge bases. This release also refines ASR capabilities,
...
![variants](/images/release-notes/2412/variant-management.png)

Use variants to manage [knowledge base](/knowledge-base/introduction) content for multiple locations in a single agent, and use one agent to handle
...
<Tip>You can add logic to your [start function](/function/start-function) to direct the agent to likely variant knowledge base items
...
![latency](/images/release-notes/2412/interaction-style.png)
...
![copy-paste-flows](/images/release-notes/2412/copy-paste-flows.png)
