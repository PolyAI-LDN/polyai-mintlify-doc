...
Use variants to manage [knowledge base](/managed-topics/introduction) content for multiple locations in a single agent, and use one agent to handle
...
[functions](/function/introduction), and [knowledge base](/managed-topics/introduction) entries, with the `${variant_foo}` format:
