...
- Auto-detects key attributes such as **language**, **accent**, and **gender**
- Lets you assign **attribute tags** to help organise and apply voices consistently
- Streamlined voice config cards tailored for Amazon (no stability/clarity sliders)

<Tip>This is part of a broader move toward multi-provider TTS support. Voices from PlayHT and other vendors will follow soon.</Tip>
