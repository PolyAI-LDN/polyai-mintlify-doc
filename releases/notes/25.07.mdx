...
<Accordion title="Smart Analyst enhancements" icon="magnifying-glass-chart" id="smart-analyst-enhancements">
...
<Accordion title="New homepage" icon="house" id="new-homepage">
...
<Accordion title="Rich text refactor" icon="pen-to-square" id="rich-text-refactor">
...
<Accordion title="Add Amazon Polly voices" icon="waveform" id="add-amazon-polly-voices">
...
<Accordion title="Adjust voice speed" icon="gauge" id="adjust-voice-speed">
...
<Accordion title="Claude integration for Agent Studio functions" icon="brain-circuit" id="claude-integration-for-agent-studio-functions">
...
<Accordion title="Channel filter and call metadata improvements" icon="filter" id="channel-filter-and-call-metadata-improvements">
...
<Accordion title="Outbound call delivery tracking" icon="truck" id="outbound-call-delivery-tracking">
