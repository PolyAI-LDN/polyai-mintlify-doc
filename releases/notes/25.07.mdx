...
Reviewing calls just got faster. Agent Studio now displays an **AI-generated summary** at the top of every call review.

![ai-call-summary](/images/release-notes/2507/ai-summary.png)

**What’s new:**

- New **AI Summary** module in the **Conversation Review** screen
- Generated after a call using GPT.
- Appears by default for projects that have signed the **current DPA and support Azure AI**.

<Note>If a project does not support AI summaries, the Conversation Details panel will display by default.</Note>
