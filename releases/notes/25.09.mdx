...
![phone-numbers](/images/release-notes/2509/numbers-tab.png)
...
Functions can now write structured logs [Conversation Review](/analytics/conversations/annotations) and the [Conversations API](/api-reference/conversations) using [`conv.log`](/function/classes/conv-log).

![conv-log](/images/release-notes/2509/conv-log.png)
