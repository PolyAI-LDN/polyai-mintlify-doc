...
- **Chat history**: resume previous analyzes; conversations stored with redacted transcript data
- **Auto titles** with the ability to rename and delete old analyzes from the history list.
