...
![home-v2](/images/release-notes/2509/home-v2.png)
...
<Accordion title="No-code flows (v1 preview)" icon="diagram-project" id="no-code-flows-v1">

Initial release of **no-code flows** for projects that opt in to the new **event sourcing** architecture.

![no-code-flows](/images/release-notes/2509/no-code-flows.png)

**What's new (preview):**
- Visual step configuration with common **entity types** (alphanumeric, number, date, time, phone, name, address, free text, multiple choice)
- Early UI for configuring prompts and extraction without writing code

<Warning>Available **only** for projects that opt in to **event sourcing**. Feature-flagged; expect incremental fixes in a fast follow-up.</Warning>
