...
![agent-analysis](/images/release-notes/2504/call-categorization.png)
...
<Tip>See the full [variant management](/knowledge/variants/introduction) page for advanced use cases like SMS personalization or routing.</Tip>
</Accordion>
