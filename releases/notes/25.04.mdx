...
The diagnosis view now shows state variables and logs grouped by step.

![state-variables](/images/release-notes/2504/state-vars.png)

**What you can see:**
- Flow entry/exit, LLM calls, and function outputs
- Real-time state and slot values
- Everything in one place, no Datadog required
