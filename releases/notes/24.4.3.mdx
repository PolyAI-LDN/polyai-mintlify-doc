...
![variants](/images/release-notes/2443/variant-management.png)
...
[functions](/function/introduction), and [knowledge base](/knowledge-base/introduction) entries, with the `${variant_foo}` format:
...
![transcript-corrections](/images/release-notes/2443/transcript-correction.png)
...
![latency](/images/release-notes/2443/interaction-style.png)
...
- Import any subsidiary global or transition [functions](/function/introduction) without overwriting existing templates.

![copy-paste-flows](/images/release-notes/2443/copy-paste-flows.png)
