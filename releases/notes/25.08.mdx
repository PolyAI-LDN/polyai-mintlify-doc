...
<Accordion title="Home page updates" icon="house" id="home-page-updates">
...
<Accordion title="AI call summaries" icon="file-lines" id="ai-call-summaries">
...
<Warning>AI Call Summaries are available for eligible projects. Contact your PolyAI representative to confirm availability for your project.</Warning>

</Accordion>

<Accordion title="Multi-voice limit increase" icon="waveform" id="multi-voice-limit-increase">
...
<Accordion title="New call review filters" icon="filter" id="new-call-review-filters">
...
<Accordion title="Updated channel display" icon="list" id="updated-channel-and-metadata-display">
...
<Accordion title="GPT‑5 models in Agent Studio (experimental)" icon="sparkles" id="gpt-5-models-in-agent-studio-experimental">
...
<Accordion title="In-app calling with variants" icon="phone" id="in-app-calling-with-variants">
...
<Accordion title="Smart Analyst improvements" icon="magnifying-glass-chart" id="smart-analyst-improvements">

It's now easier to jump from answers to exact conversations. New and more complex SQL data enquires have also been added to the Analyst.
...
<Accordion title="Start/End function error warnings" icon="triangle-exclamation" id="start-end-function-error-warnings">
...
<Accordion title="Agent Analysis – Multi-task" icon="chart-pie" id="agent-analysis-multi-task">

Agent Analysis now supports multiple analysis tasks per project.

![agent-analysis-multitask](/images/release-notes/2508/agent-analysis.png)
...
<Tip>Use multiple tasks to mimic QA workflows, track quality across different call types, and monitor continuous improvement.</Tip>
