...
**Key highlights:**
- **Halt responses:** Interrupt the agent's response when certain words or phrases (configured via RegEx) are detected in user input.
...
For additional support or questions about the release, contact us at [platform-support@poly-ai.com](mailto:platform-support@poly-ai.com).