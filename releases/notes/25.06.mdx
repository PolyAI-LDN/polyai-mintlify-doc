...
The [Test Suite](/simulation-testing/introduction) lets you save real conversations as test cases and re-run them against draft or sandbox versions to check for behavioral drift.
