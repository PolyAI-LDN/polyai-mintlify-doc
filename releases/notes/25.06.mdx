...
- Keeps business settings out of hardcoded flows
- Splits responsibility cleanly between technical and non-technical users
- Enables safe experimentation in sandbox or pre-release environments
