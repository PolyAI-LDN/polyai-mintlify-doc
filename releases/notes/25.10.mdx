...
The **October 2025** PolyAI Agent Studio release includes live call monitoring and expanded configuration for Webchat and API configuration.
...
You can now write structured logs from inside functions using `conv.log`, with entries visible in **Conversation Review → Diagnosis**.
...
**What's new:**
- **Test Sets** can now be configured to run automatically when [publishing and promoting](/environments-and-versions/introduction).
