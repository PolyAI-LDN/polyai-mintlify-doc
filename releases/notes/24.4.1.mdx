...
Set a distinct **greeting message and dial tone** before the assistant interaction begins.
...
Gain full control over **Safety Filters** directly in the platform UI. Builders can fine-tune severity settings or disable specific filters to better align with project requirements.
