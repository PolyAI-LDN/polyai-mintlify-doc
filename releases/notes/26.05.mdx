...
The **May 2026** PolyAI Agent Studio release ships a redesigned **Conversations** workspace built for high-volume review, adds a one-click **Tripleseat** integration for restaurant agents, and starts populating the **HANDOFF_TO** response metric for voice handoffs.
