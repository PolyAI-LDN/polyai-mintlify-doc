...
Agent Studio now includes a dedicated **Channels** section in the sidebar. It separates channel-specific configuration from shared project resources such as flows, knowledge base content, and variants.
...
![compare-versions](/images/release-notes/2602/compare-versions.png)
...
![in-app-calling-variants](/images/release-notes/2602/in-app-calling-variants.png)
