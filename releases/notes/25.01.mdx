...
description: In-browser calling, a new safety dashboard, custom analytics dashboards, restructured Knowledge, and updates to functions and the Conversations API.
---
