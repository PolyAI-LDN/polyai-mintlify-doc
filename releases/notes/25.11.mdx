...
The **November 2025** PolyAI Agent Studio release introduces the Connected Knowledge tab (now part of the Knowledge area), KB topic activation controls, an in-app integrations catalogue, multi-channel dashboards, Smart Analyst visual updates, and improved SMS configuration.
