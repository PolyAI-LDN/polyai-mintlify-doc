...
You can now create new [knowledge base](/managed-topics/introduction) topics by [uploading a PDF](/variant-management/csv-imports#pdf) or simply by [providing a website URL](/variant-management/csv-imports#csv).
