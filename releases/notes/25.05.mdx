...
You can now create new [knowledge base](/managed-topics/introduction) topics by [uploading a PDF](/essentials/imports/#pdf) or simply by [providing a website URL](/essentials/imports/#csv).
