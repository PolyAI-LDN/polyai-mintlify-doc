---
title: Common issues
description: Quick fixes for the problems you’re most likely to hit when maintaining a live agent.
---
...
Contact **[platform-support@poly-ai.com](mailto:platform-support@poly-ai.com)** or your PS lead if:

- You see repeated **4XX/5XX** errors in call logs.
- SIP handoffs fail after you’ve validated the number/URI.
- Dashboards or transcripts don’t load at all.
- You need code-level changes (Python functions, integrations, multi-env DevOps).

For broader troubleshooting, see the main [FAQ](/troubleshoot/faq) and [Support guide](/troubleshoot/support-guide).

<Tip> Keep a short changelog of what you tweak.</Tip>

You now have the fastest path to resolve common problems and know when to pull in the experts. Happy maintaining!