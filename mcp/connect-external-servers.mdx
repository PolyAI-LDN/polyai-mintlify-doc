---
title: Connect external servers
sidebarTitle: Connect external servers
...
<Note>This page covers connecting Agent Studio **out** to third-party MCP servers as a client. To connect a client **in** to PolyAI's own MCP server, see the [PolyAI MCP server](/mcp/server/introduction).</Note>
