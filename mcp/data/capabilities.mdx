...
description: Reference for every tool the PolyAI Data MCP server exposes, grouped by capability, with request parameters and expected response shapes for each one.
mode: wide
---
