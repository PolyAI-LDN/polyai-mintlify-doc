...
| ----------------- | --------------------------------------------------- | -------------------------------------------------- |
| **What it's for** | Query conversation data: transcripts and metrics    | Build, test, and deploy agents                     |
...
Data MCP exposes 4 tools — conversation search, transcript search, single-conversation fetch, and a metrics catalog. See [Capabilities](/mcp/data/capabilities) for each tool and its parameters.
