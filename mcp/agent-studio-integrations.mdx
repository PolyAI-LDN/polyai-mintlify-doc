---
title: Agent Studio MCP integrations
sidebarTitle: Agent Studio integrations
description: Connect your agent to external MCP servers so it can call their tools during conversations.
---
...
<Note>This page covers connecting Agent Studio **out** to third-party MCP servers as a client. To connect a client **in** and build agents from your IDE, see [Builder MCP](/mcp/builder/introduction).</Note>
