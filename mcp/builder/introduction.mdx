...
description: Build, test, and publish PolyAI agents from your IDE or MCP client, without calling the API directly.
mode: wide
---
...
| **What it's for** | Build, test, and publish agents | Give a live agent extra tools during a conversation |
...
- **Conversational workflows.** Ask your assistant to create a Branch, update its greeting, test it, and move it to Staging, and it runs the tool calls in order.
