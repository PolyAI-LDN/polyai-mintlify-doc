...
Connect the [Builder MCP](/mcp/builder/introduction) to your client and you can build PolyAI agents from your IDE in minutes. You need a [workspace-scoped API key](/mcp/authentication) and your region's endpoint.
