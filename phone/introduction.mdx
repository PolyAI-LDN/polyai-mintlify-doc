...
| | [Numbers](/voice-channel/numbers/introduction) | [Web Calling](/widgets/web-calling) |
|---|---|---|
...
Both transports run the same agent – same conversation logic, same [voice](/voice-channel/introduction), same flows. Switching a customer from one to the other doesn't require a separate build.
...
<Note>
Web Calling is a website voice entry point that complements your existing phone channel. It's not a replacement for phone support, and v1 doesn't include live-agent, voice-to-chat, or chat-to-voice handoffs. See [Where Web Calling fits today](/widgets/web-calling#where-web-calling-fits-today) for rollout guidance on browser, mobile, and consent considerations.
</Note>

## Channels under Phone

<CardGroup cols={2}>
  <Card title="Numbers" icon="phone" href="/voice-channel/numbers/introduction">
    Buy a phone number, route inbound calls, and integrate with carriers like Twilio.
  </Card>
  <Card title="Web Calling" icon="globe" href="/widgets/web-calling">
...
<CardGroup cols={2}>
  <Card title="Voice & speech" icon="waveform-lines" href="/voice-channel/introduction">
