...
Phone is how customers reach your agent **by voice**. PolyAI offers two voice transports — pick whichever fits the moment, or run both side by side.
...
<Note>
Polyphone is a **website voice entry point**, not a replacement for phone support and not a live-agent or omnichannel handoff product. It currently doesn't support voice-to-chat, chat-to-voice, or live-agent transfer. See [Polyphone limitations](/polyphone/introduction#current-limitations) for browser, mobile, and consent caveats.
</Note>
