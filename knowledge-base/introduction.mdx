...
- Use these examples to clarify the scope of the topic for the agent.
...
- **Consistency**: Use [global rules](/agent-settings/rules) to set tone, style, and boundaries for agent behavior across all topics.
- **Examples in rules**: Include sample responses to guide the agent's tone and length.
...
- Update example queries and responses as needed to ensure the agent aligns with user expectations.

By following these best practices, you'll create a knowledge base that improves retrieval accuracy, improves user interactions, and ensures reliable agent performance.
