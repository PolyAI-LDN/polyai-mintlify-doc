---
title: 'RAG'
description: 'Welcome to the PolyAI documentation on Retrieval-Augmented Generation (RAG). This document explains what RAG is, how it works, and why we utilize it to enhance our GenAI capabilities.'
---
## What is RAG?
...
Using Retrieval-Augmented Generation (RAG) for Jupiter offers enhanced accuracy and relevance by providing informed and contextually appropriate responses. RAG is scalable and efficient, utilizing existing databases without the need for extensive retraining and can be customized for specific domains. This approach improves customer experience through personalized, consistent interactions, and ensures high-quality responses.