...
- You can check if your agent called a function and with what parameters by clicking on the settings button next to the close button in the test panel and enabling the functions toggle.
