...
**Actions** tell your assistant what to do when it retrieves a specific knowledge base topic. They can send [SMS messages](./send-sms), run [custom functions](./function-call), or transfer users to a [live agent](./handoff).
