...
Integrating SMS sending functionality into your knowledge base allows your voice agent to send SMS messages based on user interactions. Before enabling outbound SMS, please ensure that you have completed the setup process described in the [How to Setup SMS Integration](/sms/introduction) page.
...
By following these steps, you can effectively integrate SMS sending capabilities into your knowledge base actions. This allows your voice agent to provide additional information using SMS, enhancing the overall user experience.
