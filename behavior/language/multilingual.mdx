...
<Steps>
  ...
  <Step title="Add translations (optional)">
    If you need manual translation overrides for specific content, use the [Translations](/behavior/language/translations) page under **Channels > Response Control**.
  </Step>
...
- [Managed Topics](/knowledge/faqs/introduction) content
