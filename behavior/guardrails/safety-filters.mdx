...
- **Voice channel** – override in **Channels > Voice > Voice configuration**. See [Voice configuration → Safety filters](/voice-channel/advanced/call-settings#safety-filters).
- **Chat channel** – override in **Channels > Chat > Chat configuration**. See [Chat configuration → Safety filters](/messaging-channel/advanced/chat-configuration#safety-filters).
