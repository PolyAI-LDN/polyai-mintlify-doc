...
<Frame caption="Safety filters on Advanced behavior settings">
  <img src="/images/agent-settings/advanced-safety-filters.png" alt="Safety filter severity sliders for violence, hate, sexual, and self-harm on the Advanced behavior settings page" />
</Frame>
...
3. Save. Voice and project-level changes reach Live when you [publish your Branch](/environments-and-versions/introduction#publishing); chat changes take effect immediately on save.
4. Test with **Chat with Agent** or an in-app call in Sandbox before publishing. To test on a real phone number, move the Branch to Staging and call the Staging number.
