...
The **Behavior** page is organized into three tabs — **General**, **Language**, and **Guardrails**. Manage platform guardrails on the **Guardrails** tab. The **Advanced settings** button (top-right of the Behavior page) opens **Advanced behavior settings**, where the input/output [safety filters](/behavior/guardrails/safety-filters) live.

![Behavior Advanced settings entry point](/images/agent-settings/behavior-advanced-entry.png)
