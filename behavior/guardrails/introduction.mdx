...
3. Test with **Chat with Agent** before publishing to Live.
...
<CardGroup cols={2}>
  ...
  <Card title="Wren" icon="message" href="/wren/introduction">
    Validate guardrail behavior in the preview before publishing a version.
  </Card>
</CardGroup>
