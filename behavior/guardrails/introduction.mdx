...
description: 'Five pre-built platform guardrails that protect your agent from jailbreaks, hallucinations, AI identity leaks, and unsafe tool calls in production.'
keywords:
  - guardrails
  - safety
  - jailbreak
