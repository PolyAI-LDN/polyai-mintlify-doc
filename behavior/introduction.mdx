...
| **[Guardrails](./guardrails)** | Safety protections against jailbreaks, hallucination, crisis escalation, and more | Toggle the five built-in platform guardrails. Lives under **Behavior**. |
