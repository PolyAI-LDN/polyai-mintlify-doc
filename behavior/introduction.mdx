...
|---------|------------|--------|
| **[Agent](/behavior/general/agent)** | For the initial setup or when rebranding | Personality (tone) and role. The greeting is configured per-channel under **Channels > Voice/Chat configuration**. |
...
| **[Guardrails](./guardrails)** | Safety protections against jailbreaks, hallucination, crisis escalation, and more | Toggle the five built-in platform guardrails. Lives under **Configure > General**. |
