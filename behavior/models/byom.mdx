...
description: 'Connect your own LLM endpoint to PolyAI.'
keywords:
  - BYOM
...
<CardGroup cols={2}>
  <Card title="Model selection" icon="brain" href="/behavior/models/model-use">
    Choose which LLM powers your agent.
  </Card>
  <Card title="Rules" icon="list-check" href="/behavior/general/rules">
