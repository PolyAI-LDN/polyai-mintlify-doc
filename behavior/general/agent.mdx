...
description: "Set your agent's personality and role in Behavior > General to control how its responses sound at the most basic level, alongside greeting and behavior rules."
keywords:
  - agent personality
  - role
  - greeting
