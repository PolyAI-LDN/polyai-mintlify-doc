...
description: 'Set global behavior rules to enforce terminology, tone, compliance guardrails, pronunciation overrides, and edge-case handling on every conversation.'
keywords:
  - rules
  - behavior
  - behavior
