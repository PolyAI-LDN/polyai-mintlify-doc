...
Define your agent's behavior by going to **[Build > Agent](/behavior/introduction)** and then scrolling to the **Behavior** section.
...
The same syntax works in [Managed Topics](/knowledge/faqs/introduction) content, [Flow steps](/flows/introduction), and [tool](/tools/introduction) descriptions.
