...
Use behavioral rules to enforce consistency across every conversation. Define correct terminology, compliance guardrails, pronunciation overrides, and edge-case handling, and ensure the LLM does not improvise on these decisions.
