...
<Tip>
Always use the exported file as your starting template. The exported file may use a separator other than a comma (such as a semicolon or tab). If you edit the CSV in a spreadsheet application, re-export it in the same format to avoid import errors.
</Tip>
...
3. **Review changes**
   - The platform shows a comparison of what will change
