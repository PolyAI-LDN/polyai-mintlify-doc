...
<Frame caption="Variant management UI for multi-site configurations">
...
<Frame caption="Example variant table with locations and attributes">
  ![variant-2](/images/variant/example-variant.png)
</Frame>

### Setting up a new variant

<Frame caption="Add variant dialog">
...
<Frame caption="Variant successfully added">
  ![variant-4](/images/variant/added.png)
</Frame>

### Setting up a new attribute

<Frame caption="Add attribute button in variant management">
...
<Frame caption="Attribute successfully added to variant table">
