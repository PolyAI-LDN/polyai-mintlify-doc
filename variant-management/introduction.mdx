...
2. Set up a Knowledge Base aligned with your multi-site configuration goals. Learn more: [Knowledge Base Guide](/knowledge-base/introduction).
3. Understand how to use **functions** in your assistant: [Functions Guide](/function/introduction).
