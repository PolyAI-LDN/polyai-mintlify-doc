...
<Frame caption="Chat configuration interface in Agent Studio">
...
<Tip>
**Recommended for chat:** PolyAI's [Raven 3.5](/agent-settings/raven) is purpose-built for conversational AI and tuned for both voice and chat. It supports custom style instructions (formatting, emoji, persona), auto-reasoning for complex queries, out-of-domain detection for cleaner escalation, and 24+ languages. Raven 3.5 delivers stronger grounding and more natural paraphrasing than general-purpose models, especially when used with [Connected Knowledge](/connected-knowledge/introduction).
</Tip>

<Note>
[Raven V3](/agent-settings/raven) is optimized for voice and can only be selected in [Voice configuration](/voice/voice-configuration). **Raven 3.5** extends all Raven capabilities to chat.
</Note>
