...
description: "Configure language model, greeting, and safety filters for chat."
---
...
<ParamField path="Large language model" type="dropdown">
  Choose the language model for chat responses. Available models include OpenAI (GPT series) and Amazon Bedrock options.
