...
<Note>
[Raven V2 and V3](/agent-settings/raven) are optimized exclusively for voice and can only be selected in [Voice configuration](/voice/voice-configuration). **Raven V3.5** extends all Raven capabilities to chat.
</Note>
