...
<Tip>
**Recommended for chat:** PolyAI's [Raven V3.5](/agent-settings/model-use) is purpose-built for conversational AI and tuned for both voice and chat. It delivers stronger grounding and more natural paraphrasing than general-purpose models, especially when used with [Connected Knowledge](/connected-knowledge/introduction).
</Tip>
