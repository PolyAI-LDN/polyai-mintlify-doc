...
Chat configuration aligns with [environment branching](/environments-and-versions/introduction). Changes made in Sandbox can be promoted to Pre-release and Live environments.
...
- [Environments](/environments-and-versions/introduction) - Manage deployment pipeline for voice and other channels
