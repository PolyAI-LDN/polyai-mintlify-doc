...
Select the language model powering chat responses — PolyAI's [Raven V3.5](/agent-settings/raven) is recommended for chat, delivering natural paraphrasing and strong grounding. Optionally add a style prompt to tailor tone and formatting specifically for the chat channel.
