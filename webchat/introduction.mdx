...
- Info banner: after changing styles, you must deploy via **Test and install → Generate script tag** and update your site so users see the new look.
...
<Tabs>
  ...
  **What the screenshots show:**
  ...
  - The **Preview Demo** section appears at the top of **Test and install**.
  ...
  - The chat is open in the inline preview.
  - Use this to sanity-check message layout, placeholder text, and the “Powered by PolyAI” watermark before you deploy.
  </Tab>

  <Tab title="Embedded script">
  Generate a script tag to add the widget to your website.

  - Choose the **environment**: **Sandbox**, **Pre-release**, or **Live**. This decides where conversations are sent.
