...
description: "Create, style, and deploy chat widgets for your website."
keywords:
  - widget
  - chat widget
  - embed
...
<Frame caption="Widget styling and configuration interface">
  ![webchat-widget](/images/webchat/widget.png)
</Frame>
...
<ParamField path="Header text" type="string">
  The title shown in the widget header. Use your brand name or agent name.
  
  **Example:** "PolyAI Agent"
</ParamField>
