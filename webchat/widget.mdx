...
After installing the widget script, you can customize the widget's position on the page using CSS. The widget renders inside a `#poly-ai-chat` element, which you can target with custom styles.
