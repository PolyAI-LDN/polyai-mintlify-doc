...
description: "Quick reference for terms, acronyms, and concepts used across PolyAI Agent Studio, from A2P 10DLC and Raven to flows, tools, and simulation tests."
keywords:
  - glossary
  - definitions
  - terminology
