...
An optional environment where you can test any Branch with a real phone number and API connections, one Branch at a time. Staging is the new name for Pre-release. See [Deployments](/environments-and-versions/introduction).
