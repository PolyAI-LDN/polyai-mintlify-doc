...
Where a Branch or Sub-branch runs: `sandbox` (no telephony or APIs), `staging` (optional, real phone number and API connections), or `live` (production). See [Deployments](/environments-and-versions/introduction).
