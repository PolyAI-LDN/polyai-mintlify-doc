...
The primary interface for designing, configuring, and deploying AI agents. Agent Studio is organized into sections: **Studio Assistant** (the natural-language builder), **Analytics** (conversations, KPIs, custom metrics, dashboards, PolyScore, Smart Analyst, CSAT), **Behavior** (general, language, guardrails, models), **Knowledge** (FAQs, Sources, Variants), **Flows**, **Tools**, **Simulation testing**, **Real-time config**, **Voice** and **Messaging** channels, **Integrations**, **Deployments**, and **Widgets**. See [Getting started](/get-started/quickstart), [Build essentials](/essentials/order).
