...
- **Decision making**: Determines the appropriate response based on your configured knowledge base, flows, and rules
...
- **[Knowledge base](/managed-topics/introduction)**: Information the agent uses to answer questions
...
<Steps>
  ...
  <Step title="Retrieve knowledge">
    Relevant information is fetched from your knowledge base using RAG (Retrieval-Augmented Generation).
  </Step>
