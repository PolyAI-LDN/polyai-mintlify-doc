...
<Steps>
  <Step title="Start from the home screen">
    ...
    <Frame caption="Home screen with Build, Test, Ask, and Analyze templates">
      <img src="/images/agent-builder/home-templates.png" alt="Agent Builder home screen with prompt templates and usage indicator" style={{ maxWidth: '720px', width: '100%', margin: '0 auto', display: 'block' }} />
    </Frame>
  </Step>
  ...
  <Step title="Ask about your agent">
    ...
    <Frame caption="Ask mode — answers grounded in your project">
      <img src="/images/agent-builder/ask-mode-response.png" alt="Agent Builder response showing a project-specific Agent Overview" style={{ maxWidth: '720px', width: '100%', margin: '0 auto', display: 'block' }} />
    </Frame>
  </Step>
  ...
  <Step title="Make a change on a branch">
    ...
    <Frame caption="A new branch is created automatically — Main stays untouched">
      <img src="/images/agent-builder/branch-created.png" alt="Agent Builder creating a branch before making changes" style={{ maxWidth: '720px', width: '100%', margin: '0 auto', display: 'block' }} />
    </Frame>
  </Step>
  ...
  <Step title="Answer any clarifying questions">
    ...
    <Frame caption="Pick an option, type your own answer, or Skip">
      <img src="/images/agent-builder/clarifying-question.png" alt="Agent Builder asking a clarifying multiple-choice question with a Skip option" style={{ maxWidth: '720px', width: '100%', margin: '0 auto', display: 'block' }} />
    </Frame>
  </Step>
