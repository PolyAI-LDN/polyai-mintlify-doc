---
title: "Prompting Agent Builder"
sidebarTitle: Prompting guide
description: "Practical patterns for getting consistently good results from Agent Builder, with real prompt examples for building, testing, asking, and analyzing."
keywords:
...
Agent Builder can also author and maintain [simulation test cases](/analytics/test-suite/introduction) for you. Generated cases land in the **Simulation tests** workspace next to anything you've saved by hand, and Agent Builder updates them as the underlying flows and topics change. Useful prompts:
...
- *Run the existing test suite against the current draft and summarize any regressions.*
