...
<Warning>
Do not use Raven for webchat deployments. Raven is trained for voice and does not have Azure guardrails automatically applied. Use a GPT model for webchat instead.
</Warning>

Configure which LLM powers each channel in **Agent > Model use** or via the experimental configuration.
