...
<Note>
  Before guardrails shipped as platform features, the same protections had to be pasted into every agent's behavior prompt by hand. Platform guardrails are applied automatically, standardized across projects, and maintained by PolyAI.
</Note>
...
1. Open **Configure > General > Guardrails**.
...
- All five guardrails are on by default for new and existing projects.
