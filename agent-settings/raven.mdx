...
<Note>
**Raven V3** remains available for voice-only deployments. It supports the same 24 languages and core capabilities but does not include auto-reasoning, out-of-domain detection, chat support, or the safety and style improvements in 3.5. Select V3 in [Voice configuration](/voice/voice-configuration) if needed.
</Note>
