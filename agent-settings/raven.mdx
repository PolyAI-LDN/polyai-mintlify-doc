...
<Steps>
  <Step title="Raven V3" icon="globe">
    Native multilingual support for 24+ languages, improved date and time reasoning, natural conversational style, and stronger flow-following.
...
<Note>
Raven V3 is voice-only. Select it in [Voice configuration](/voice/voice-configuration). **Raven V3.5** supports both voice and chat — select it in [Voice configuration](/voice/voice-configuration) and/or [Chat configuration](/webchat/chat-configuration).
</Note>
