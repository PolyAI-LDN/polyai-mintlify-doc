...
|-------|----------|----------|
| **Raven V2** | Voice only | Production-hardened, real-time voice interactions and high retrieval precision |
| **Raven V3** | Voice only | Multilingual support (24+ languages), improved date/time logic, conversational style built in, and stronger flow-following |
| **Raven V3.5** | Voice and chat | All V3 capabilities plus the features below — the most versatile Raven model |

### Raven V3.5

Raven V3.5 is the latest and most capable Raven model. It extends all V3 capabilities to both voice and chat, and adds:
...
|----------|---------------------|
| Voice agent | **Raven V3** or **Raven V3.5** |
| Chat agent | **Raven V3.5** |
| Voice + chat (multichannel) | **Raven V3.5** for both channels |
| Multilingual agent | **Raven V3** or **Raven V3.5** |
