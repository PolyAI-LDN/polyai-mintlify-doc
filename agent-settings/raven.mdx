...
Raven is PolyAI's proprietary model. Raven eliminates the trade-off between speed and accuracy, delivering sub-300ms latency, stronger grounding, and more natural responses than general-purpose LLMs.
