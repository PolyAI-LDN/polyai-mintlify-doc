...
<Note>
**Raven V3 is deprecated.** Earlier Raven versions (including Raven V3) now route to Raven 3.5 automatically. Existing deployments that selected an older version continue to work without change, but all requests are served by Raven 3.5. Update your agent configuration to select **Raven 3.5** directly.
</Note>
