...
description: 'Configure your agent to handle conversations in multiple languages with automatic detection and switching.'
---
...
Select a language-appropriate voice for each supported language:
...
- [Voice settings](/voice/introduction) — Configure voice options per language
