...
| **ASR & Voice**   | ASR keywords and corrections                     | <Icon icon="check" iconType="solid" color="#2ecc71" size={14} /> |                                                                   | Leave in native language                                         |
|                   | Response control and pronunciations              | <Icon icon="check" iconType="solid" color="#2ecc71" size={14} /> |                                                                   | Leave in native language                                         |
