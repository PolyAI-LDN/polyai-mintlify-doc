...
Alternatively, you can return a dictionary of [locale-specific utterances](/tools/return-values#locale-specific-utterances) instead of branching manually:
...
The agent automatically selects the utterance matching the caller's current language.
