---
title: 'Multi-lingual'
description: 'Set up your agent so that it is ready to speak more than one language.'
---
...
> There is currently **no built-in routing** between language-specific projects. Some teams use custom logic or even a third routing agent to ask the user which language they want, then forward the call to the right assistant.
...
| **ASR & Voice**   | ASR keywords and corrections                     | <Icon icon="check" iconType="solid" color="#2ecc71" size={14} /> |                                                                   | Translate as needed                                              |
|                   | Response control and pronunciations              | <Icon icon="check" iconType="solid" color="#2ecc71" size={14} /> |                                                                   | Translate as needed                                              |
...
> Example: Instead of `Ask the user for their number`, write:
>
