...
Use multi-language support when your agent serves callers who speak different languages. A multilingual agent detects the caller's language, switches mid-conversation if needed, and uses language-appropriate voices and content — all within a single project.
...
<Frame><img src="/images/agent-settings/multilingual-settings.png" alt="Multi-language settings in Configure > General showing Response language and Additional languages fields" /></Frame>
...
<Steps>
  ...
  <Step title="Configure voices per language">
    ...
    - Multi-voice is supported per language — assign multiple voices to a single language for A/B testing or persona variation
  </Step>
...
<Frame caption="Setting a voice per language in Agent Voice">
...
<Frame caption="Language label in conversation review">
...
- [Translations](/response-control/translations) — Manually override auto-translations for specific content
