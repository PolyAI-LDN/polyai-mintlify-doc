...
<Steps>
  <Step title="Add languages">
    Go to **Build > Agent > Multi-language** and click **Add language**. You can add up to 10 additional languages. The first language you set during project creation becomes the **main language**.
  </Step>
...
Language information is visible in:
- **Conversation review list** — see the language used in each conversation
- **Conversation review detail** — see per-turn language information
- **Audio management** — language metadata on audio files
