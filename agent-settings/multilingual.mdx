...
Agent Studio supports multiple approaches to multi-language deployments. You can create separate projects for each language or use a single project with language detection and switching.

## Recommended approach: separate projects per language

For most use cases, we recommend creating a separate project for each language. This approach provides:
...
<Note>Contact your PolyAI representative for help setting up routing between language-specific projects.</Note>
...
* Choose a **voice** that supports your language. Use PolyVoice for the best quality and lowest latency.
