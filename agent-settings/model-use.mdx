...
<Tip>
**Recommended:** PolyAI's **Raven** model family is purpose-built for conversational AI and is the recommended choice for most deployments. Raven delivers superior grounding, natural paraphrasing, and lower hallucination rates compared to general-purpose models. See [Training data](/legal/training-data) for transparency on how Raven is built.
</Tip>
...
<Tabs>
  <Tab title="PolyAI Raven (Recommended)" icon="brain">
    PolyAI's proprietary **Raven** model family is purpose-built for conversational AI. Raven models are trained specifically for customer service interactions and deliver stronger grounding, more natural paraphrasing, and higher retrieval precision than general-purpose LLMs.
    ...
    | **Raven V3.5** | All the capabilities of Raven V3, also tuned for chat interactions — the most versatile Raven model |

    **Why choose Raven:**
    - **Built for conversation** — trained on high-quality customer service interactions, not general web data
    - **Better grounding** — less likely to hallucinate or deviate from your knowledge base
    - **Natural paraphrasing** — produces responses that sound human and conversational, especially for voice
    - **Optimized for PolyAI** — deeply integrated with Agent Studio's retrieval, voice, and flow systems
