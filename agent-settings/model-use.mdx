...
<Tabs>
  <Tab title="PolyAI" icon="brain">
    ...
    <Warning>
      Raven models are purpose-built for conversational voice AI and are **not available for webchat**. They can only be selected in [Voice configuration](/voice/voice-configuration).
    </Warning>
  </Tab>
