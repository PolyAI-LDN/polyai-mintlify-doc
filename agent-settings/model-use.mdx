...
The **Model** section in the Agent Settings allows you to choose the Language Model (LLM) that best suits your needs. Currently, we support two models: ChatGPT 4 and ChatGPT 3.5. Here's a detailed comparison of each model:
