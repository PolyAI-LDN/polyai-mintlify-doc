...
<Tabs>
  <Tab title="PolyAI Raven (Recommended)" icon="brain">
    ...
    |-------|----------|----------|
    | **Raven V2** | Voice | Production-hardened, real-time voice interactions |
    | **Raven V3** | Voice | 24+ languages, improved date/time logic, conversational style |
    | **Raven V3.5** | Voice and chat | All V3 capabilities plus auto-reasoning, out-of-domain detection, custom style following, and safety — the most versatile Raven model |

    <Card title="Learn more about Raven" icon="arrow-right" href="/agent-settings/raven">
      Full details on capabilities, version comparison, supported languages, and why Raven is recommended for most deployments.
    </Card>
  </Tab>
