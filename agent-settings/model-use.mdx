...
<Tabs>
  <Tab title="PolyAI Raven (Recommended)" icon="brain">
    ...
    | **Raven V3.5** | Voice and chat | All V3 capabilities plus auto-reasoning, out-of-domain detection, custom style following, and built-in safety — the most versatile Raven model |
