---
title: 'Model'
description: 'Choose which LLM powers your agent, or connect your own endpoint.'
---

Choose the LLM that powers your agent or connect your own endpoint. The model directly affects response quality, latency, and cost — a wrong choice can make your agent slow, expensive, or inaccurate.
...
**Send the following to [support@poly.ai](mailto:support@poly.ai) to complete setup:**
