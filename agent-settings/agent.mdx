...
Use the Agent page to control how the agent introduces itself and communicates. The greeting is the first thing a caller hears – if it sounds wrong, callers lose confidence before the conversation begins.
...
The agent's opening line. This is the first thing the caller hears.
...
This field sets the tone and communication style across every response. Common options include friendly, professional, empathetic, and casual. Define a custom personality string to match your brand voice.
