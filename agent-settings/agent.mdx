...
This field sets the tone and communication style across every response. Pick from the built-in tags – `Polite`, `Kind`, `Funny`, `Energetic`, `Calm`, `Thoughtful` – or select **Other** to write a custom personality string that matches your brand voice.
