...
For detailed information on each setting, please refer to the [About Settings](./about-settings) page.
...
For more information on selecting the best model for your use case, please visit the [Model Use Settings](./model-use-settings) page.
...
For guidance on setting rules for your assistant, please refer to the [Rules Settings](./rules-settings) page.
