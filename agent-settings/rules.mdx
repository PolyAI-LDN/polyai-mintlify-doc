...
Do not use `$1`, `$2`, etc. — these will be interpreted literally and may be read out as "one dollar," "two dollars," etc.
...
This uses SSML breaks between capture groups, allowing for natural readback of phone numbers or similar patterns.
