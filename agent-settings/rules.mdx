...
description: 'Set global rules that control your agent behavior across all conversations.'
---

Define your agent's behavior with **Global Rules** in **[Build > Agent](/agent-settings/introduction)**. Use rules to set tone, ensure compliance, and handle edge cases.
