...
Define your agent's behavior with **Global Rules** in the [Agent Settings](/agent-settings/introduction). Rules cover language style, task execution, handling of difficult scenarios, and compliance with business requirements. Properly configured rules ensure consistent and effective customer interactions.
...
You can edit behavior by going to the **Agent** tab and scrolling to the **Behavior** section.
