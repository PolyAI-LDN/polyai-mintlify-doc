...
4. **Test and iterate**: Regularly review and refine rules.
...
- **Domain-specific customization**: Adapt to industry-specific terminology (e.g., historical or scientific terms).
...
Pronunciations use the [International Phonetic Alphabet (IPA)](https://pronunciationstudio.com/english-ipa-chart/) to define pronunciation rules. By creating TTS rule objects with regular expressions and IPA replacements, you can customize how the assistant speaks specific terms.
