...
PolyAI uses [Text-to-Speech (TTS)](https://www.nvidia.com/en-gb/glossary/text-to-speech/) to convert text into spoken language. Occasionally, domain-specific terms, proper nouns, or uncommon words may be mispronounced. Use **TTS Pronunciations** to define pronunciation rules directly in the platform, ensuring accurate and professional speech.
...
TTS Pronunciations use the [International Phonetic Alphabet (IPA)](https://pronunciationstudio.com/english-ipa-chart/) to define pronunciation rules. By creating TTS rule objects with regular expressions and IPA replacements, you can customize how the assistant speaks specific terms.
