...
Define your agent's behavior with **Global Rules** in [Agent Settings](/agent-settings/introduction). Use rules to set tone, ensure compliance, and handle edge cases.
