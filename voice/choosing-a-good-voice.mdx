...
<Frame caption="Voice library with region filter">
  ![Voice library with region filter](/images/voice/voice-library-filtered.png)
</Frame>
...
<Frame caption="Voice card close-up">
  ![Voice card close-up](/images/voice/voice-card-closeup.png)
</Frame>
