...
description: "Configure the voice settings for your agent in Agent Studio."
---

The **Agent Voice** page in Agent Studio allows you to configure voice settings for your agent. Select, preview, and adjust voices using the **Voice library** to create the best interaction experience for your users.

<Info>
Access the Agent Voice page from **Channels > Voice > Agent Voice** in the sidebar.
</Info>
