...
Fine-tune the selected voice's settings:
...
<ParamField path="Clarity and Similarity" type="slider">
  Adjusts how closely the generated voice matches the original recording. Higher values sound more realistic and detailed, but may produce occasional imperfections with unusual or unexpected text. Lower values smooth the voice slightly, making it better suited for dynamic or ASR-driven content.
</ParamField>
...
- [Add a voice](/voice/add-a-new-voice) – Add voices from external providers using code
