...
<ParamField path="Clarity and Similarity" type="slider">
  Adjusts how closely the generated voice matches the original recording. Higher values sound more realistic but may occasionally produce imperfections with unusual text.
</ParamField>
...
<Warning>
Some documentation may show the previous voice selection interface. The new Voice library includes tabbed navigation, advanced filtering, custom text preview, and favorites.
</Warning>
