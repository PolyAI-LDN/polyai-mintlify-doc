...
<Tabs>
  ...
  - In the **Voice Settings** popup:
    - **Stability** controls how consistent the voice sounds over time. (0–100%)
    - **Clarity and Similarity** adjusts how natural and clear the voice sounds compared to the original recording. (0–100%)

  Adjust the sliders according to your preferences and click **Done** to save changes.

  </Tab>

  <Tab title="Changing voice">
