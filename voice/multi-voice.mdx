...
<Frame caption="Multi-voice configuration interface showing voice list and weights">
...
<Frame caption="Adding new voices to the multi-voice configuration">
...
<Frame caption="Voice weight distribution interface">
...
<Frame caption="Voice-specific parameter settings">
