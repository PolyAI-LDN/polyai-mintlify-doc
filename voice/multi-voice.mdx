...
- **Stability (%):** Control how consistent the voice sounds across responses.
...
To use multiple voices, you need the voice identifiers from your chosen voice provider. See the [voice provider setup guide](/function/classes) for full details on supported providers and their configuration options.
