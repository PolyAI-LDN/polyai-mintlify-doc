...
Assigning different voices to repeat callers can help create a sense of interacting with different team members, which may reduce escalation requests. Use the `conv.randomize_voice()` method in your [start function](/function/start-function) to vary voice selection across interactions.