...
<ParamField path="Large language model" type="dropdown">
  Choose the language model for voice conversations. All available models are listed here, including PolyAI's Raven models.
</ParamField>
...
- Promote to **Pre-release** for testing and review
