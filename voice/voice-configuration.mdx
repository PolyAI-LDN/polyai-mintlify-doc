...
description: "Configure greeting, disclaimer, and call handling settings."
---

The **Voice Configuration** page (**Channels > Voice**) controls voice-specific settings including greeting and disclaimer behavior.
