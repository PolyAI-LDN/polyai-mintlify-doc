...
<Tip>
**Recommended for voice:** PolyAI's [Raven models](/agent-settings/model-use) are purpose-built for conversational voice AI. They produce more natural-sounding responses, handle paraphrasing better, and ground more reliably to your knowledge base than general-purpose models. **Raven V3** is ideal for voice-only agents; **Raven V3.5** adds chat support for multichannel deployments.
</Tip>
