...
<Tip>
[Raven models](/agent-settings/model-use) are purpose-built for conversational voice AI and are only available on this page — they cannot be selected for [webchat](/webchat/chat-configuration).
</Tip>
