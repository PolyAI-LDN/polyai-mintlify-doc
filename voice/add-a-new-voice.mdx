...
The PolyAI platform supports flexible voice selection for external providers including Cartesia, ElevenLabs, Hume, AWS Polly, Microsoft Azure TTS, Rime, Minimax, and Google TTS.

## Provider classes

When picking models, adjusting stability, or accessing third-party providers — use provider-specific `TTSVoice` classes. See the [Voice classes](/function/classes/voice) reference for the full list of providers and parameters.
