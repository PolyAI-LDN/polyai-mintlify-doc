...
<Tip>
For the best voice experience, pair your voice settings with PolyAI's [Raven](/agent-settings/model-use) LLM — it is purpose-built for conversational voice AI and produces responses that sound natural when spoken aloud.
</Tip>
