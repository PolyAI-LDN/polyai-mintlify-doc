...
- **Keyphrase Boosting** tells the speech recognition system to listen more carefully for specific words *while converting speech to text*.
- **Transcript Corrections** fixes mistakes in the text *after speech has been converted*, by finding and replacing incorrect words or phrases.
