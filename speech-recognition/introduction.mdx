...
Keyphrase Boosting biases the ASR model toward recognizing specific words and phrases. By curating a list of keyphrases relevant to your domain, you can improve transcription accuracy for those terms, resulting in better inputs for the Large Language Model (LLM) and improved agent performance.
