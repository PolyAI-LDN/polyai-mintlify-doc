...
PolyAI uses advanced [Automatic Speech Recognition (ASR)](https://en.wikipedia.org/wiki/Speech_recognition) models to convert spoken language into written text. To improve the
