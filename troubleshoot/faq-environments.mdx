...
<AccordionGroup>
  <Accordion title="How do I test changes safely before going live?" icon="flask">
    Work in a [Branch](/environments-and-versions/introduction), your own isolated copy of the agent branched off Live.
  ...
  <Accordion title="Do I have to go through Staging?" icon="arrow-right-arrow-left">
    No. A Branch publishes straight to Live once you have tested it. Move it into Staging only when you want to test with a real phone number and staging API connections first. Only one Branch can sit in Staging at a time.
  </Accordion>
