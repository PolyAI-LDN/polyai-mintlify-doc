...
<AccordionGroup>
  ...
  <Accordion title="Do I have to go through Staging?" icon="arrow-right-arrow-left">
    No. A Branch publishes straight to Live once you have tested it. Move it into Staging only when you want to test with a real phone number and API connections first. Only one Branch can sit in Staging at a time.
  </Accordion>
