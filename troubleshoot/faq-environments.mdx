...
<AccordionGroup>
  <Accordion title="How do I test changes safely before going live?" icon="flask">
    In [Simple mode](/environments-and-versions/simple-mode), test your copy, then publish. In Branches or Sub-branches mode, work in a [Branch](/environments-and-versions/branches-mode), your own separate copy of the agent, and publish it when ready.
