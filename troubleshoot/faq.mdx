...
Common questions about Knowledge (Managed Topics and Connected), rules, and agent configuration.
...
<AccordionGroup>
  <Accordion title="What are actions?" icon="bolt">
    Actions let the agent perform tasks like sending SMS, calling functions, or triggering handoffs. They are defined in Managed Topics (under the Knowledge area), directly under the content field.
