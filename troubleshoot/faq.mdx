...
This guide answers common questions about Managed Topics, rules, and agent configuration.
...
Actions let the agent perform tasks like sending SMS, calling functions, or triggering handoffs. They are defined in Managed Topics, directly under the content field of a Managed Topic.
* **Example use case**:
