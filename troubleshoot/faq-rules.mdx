...
title: Rules FAQ
sidebarTitle: Rules
description: Guidance on writing effective global rules, channel filtering, and handling edge cases.
---

Answers to common questions about global rules including best practices, examples, channel and language filtering, and planning for risky scenarios. See [Rules](/agent-settings/rules) for full documentation.
