...
description: Guidance on writing effective behavioral rules, channel filtering, and handling edge cases.
---
...
<AccordionGroup>
  ...
  <Accordion title="How should I plan for risky scenarios?" icon="shield-halved">
    ...
    **Example for refunds:**
    ...
    <Warning>
      Always test risky scenario handling in [Sandbox](/environments-and-versions/environments#sandbox) before publishing to Live.
    </Warning>
  </Accordion>
</AccordionGroup>
