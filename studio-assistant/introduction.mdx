...
<Warning>
**Four screenshots on this page still use internal test agents (Bella Vista, Bella Noches).** Specifically: the Ask-mode response, the clarifying question, and the two plan-modal captures. Replace each one with an external-facing capture before Agent Builder launch.
</Warning>
