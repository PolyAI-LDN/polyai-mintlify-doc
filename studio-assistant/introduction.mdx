...
<Steps>
  <Step title="Start from the home screen">
    ...
    <Frame caption="Home screen with Build, Test, Ask, and Analyze templates">
      <img src="/images/studio-assistant/home-templates.png" alt="Studio Assistant home screen with prompt templates and usage indicator" />
    </Frame>
  </Step>
  ...
  <Step title="Ask about your agent">
    ...
    <Frame caption="Ask mode — answers grounded in your project">
      <img src="/images/studio-assistant/ask-mode-response.png" alt="Studio Assistant response showing a project-specific Agent Overview" />
    </Frame>
  </Step>
  ...
  <Step title="Make a change on a branch">
    ...
    <Frame caption="A new branch is created automatically — Main stays untouched">
      <img src="/images/studio-assistant/branch-created.png" alt="Studio Assistant creating a branch before making changes" />
    </Frame>
  </Step>
  ...
  <Step title="Answer any clarifying questions">
    ...
    <Frame caption="Pick an option, type your own answer, or Skip">
      <img src="/images/studio-assistant/clarifying-question.png" alt="Studio Assistant asking a clarifying multiple-choice question with a Skip option" />
    </Frame>
  </Step>
