...
Agent Builder is **channel-aware**: on chat projects it pulls in chat-specific guidance (message length, formatting, async turn-taking) when planning and writing prompts; on voice projects it stays voice-first. The plan-and-approve workflow is identical across channels.
...
<CardGroup cols={3}>
  ...
  <Card title="Managed topics" icon="book" href="/knowledge/faqs/introduction">
