...
<Steps>
  <Step title="Start from the home screen">
    ...
    <Frame caption="Home screen with Build, Test, Ask, and Analyze templates">
      <img src="/images/studio-assistant/home-templates.png" alt="Agent Builder home screen with prompt templates and usage indicator" />
    </Frame>
  </Step>
  ...
  <Step title="Ask about your agent">
    ...
    <Frame caption="Ask mode — answers grounded in your project">
      <img src="/images/studio-assistant/ask-mode-response.png" alt="Agent Builder response showing a project-specific Agent Overview" />
    </Frame>
  </Step>
  ...
  <Step title="Make a change on a branch">
    ...
    <Frame caption="A new branch is created automatically — Main stays untouched">
      <img src="/images/studio-assistant/branch-created.png" alt="Agent Builder creating a branch before making changes" />
    </Frame>
  </Step>
  ...
  <Step title="Answer any clarifying questions">
    ...
    <Frame caption="Pick an option, type your own answer, or Skip">
      <img src="/images/studio-assistant/clarifying-question.png" alt="Agent Builder asking a clarifying multiple-choice question with a Skip option" />
    </Frame>
  </Step>
  ...
  <Step title="Approve or revise the plan">
    ...
    <Frame caption="Expand the plan to review details or write feedback">
      <img src="/images/studio-assistant/approve-flow-revise.png" alt="Expanded plan modal with a feedback textarea and Cancel/Send buttons" />
    </Frame>
    ...
    <Frame caption="Your feedback is shown above the regenerated plan">
      <img src="/images/studio-assistant/approve-flow-revised.png" alt="Plan card after revisions with Changes requested pill and feedback block" />
    </Frame>
    ...
    <Frame caption="Changes applied to the branch with a summary of additions">
      <img src="/images/studio-assistant/change-applied.png" alt="Approved plan card with a Quick Edit summary listing the additions made" />
    </Frame>
  </Step>
  ...
  <Step title="Merge to main">
    ...
    <Frame caption="Merge the branch back to Main when you're ready">
      <img src="/images/studio-assistant/merge-dialog.png" alt="Merge to main branch dialog with an optional message" />
    </Frame>
  </Step>
</Steps>
