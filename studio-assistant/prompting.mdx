...
Agent Builder can also author and maintain [simulation test cases](/simulation-testing/introduction) for you. Generated cases land in the **Simulation tests** workspace next to anything you've saved by hand, and Agent Builder updates them as the underlying flows and topics change. Useful prompts:
