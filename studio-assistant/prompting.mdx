...
Studio Assistant can also author and maintain [simulation test cases](/testing/simulation-tests) for you. Generated cases land in the **Simulation tests** workspace next to anything you've saved by hand, and Studio Assistant updates them as the underlying flows and topics change. Useful prompts:
