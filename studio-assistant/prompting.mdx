...
A separate **Agent wizard** entry on the home screen kicks off the guided builder that bootstraps a new agent from a company URL.
...
You can also ask about your own configuration:
