...
<CardGroup cols={3}>
  ...
  <Card title="Architecture" icon="sitemap" href="/glossary/architecture">
    How PolyAI agents work under the hood
  </Card>
</CardGroup>

## Build your agent

Set up your agent's personality, knowledge, voice, and conversation flows — no code required.
...
Write Python functions, connect APIs, and configure advanced telephony routing.
...
<CardGroup cols={3}>
  <Card title="Maintain" icon="screwdriver-wrench" href="/learn/maintain/introduction">
