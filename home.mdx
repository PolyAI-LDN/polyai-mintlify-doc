...
![Agent Studio in Agent Builder mode: Studio Assistant chat panel ready to accept a prompt, with Build, Configure, and Deployments in the sidebar](/images/platform/open-platform-sidebar.png)
