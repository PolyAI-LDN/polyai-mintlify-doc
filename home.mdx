...
<Note>
  You're in [simplified mode](/platform/simplified-mode). Developer, API, and advanced docs are hidden. Use the **Simplified — exit** pill in the top bar (or visit the simplified-mode page) to switch back to full docs.
</Note>
...
<CardGroup cols={3}>
  ...
  <Card title="SMS" icon="comment-sms" href="/sms/introduction">
    Send confirmations, links, and follow-ups
  </Card>
  <Card title="Connected knowledge" icon="link" href="/connected-knowledge/introduction">
    Add external documents and sources
  </Card>
</CardGroup>
