...
<Note>
  You're in Open platform mode. These docs are scoped to your 60-day free trial. Click **Open platform — exit** in the top-right pill to see the full enterprise docs.
</Note>

You're in. The home screen at [studio.poly.ai](https://studio.poly.ai/) is Studio Assistant. Tell it what you want, paste a URL or a doc, and it builds the agent. The fastest first agents are live in under ten minutes.

If you don't know where to start, copy one of these prompts:
...
Studio Assistant proposes a plan before it writes anything. Read it, ask for changes, then approve. You can test the agent in the browser the second the plan applies.

## Where to go next

<CardGroup cols={2}>
  <Card title="Quickstart" icon="rocket" href="/get-started/quickstart">
    The full first-agent walkthrough, with the steps spelled out.
  </Card>
  <Card title="Embed PolyPhone on your site" icon="phone" href="/polyphone/introduction">
    The script tag your visitors click to talk to your agent.
  </Card>
  <Card title="Improve your agent after a real call" icon="rotate" href="/learn/iterate-open-platform">
    Review the transcript, spot the failure, ask Studio Assistant to fix it.
  </Card>
  <Card title="The Open platform in detail" icon="circle-info" href="/platform/open-platform">
    What's included, what's enterprise, and answers to the trial questions.
  </Card>
</CardGroup>
