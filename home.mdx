...
PolyAI builds AI agents for real customer conversations. Agents answer questions, make bookings, resolve issues, and anything else you can think of. They run on [Raven](/agent-settings/raven), PolyAI's proprietary LLM with sub-300ms latency across 24+ languages.
...
PolyAI is a platform for building agents that handle real customer conversations. Agent Builder is the self-serve way in: describe what you want, get a working agent in minutes.

# Build a voice agent in minutes

Tell [Agent Builder](https://studio.poly.ai/) what you need. It builds the agent. You test it in the browser and drop it on your site. No code, no sales call, just describe and deploy.
