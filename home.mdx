...
Build, deploy, and monitor agents through [Agent Studio](/get-started/introduction), the [ADK](/extend/adk) CLI, or [REST APIs](/api-reference/introduction).
...
<CardGroup cols={3}>
  ...
  <Card title="Build like an engineer" icon="terminal" href="/extend/adk">
    The ADK (Agent Development Kit) goes beyond a standard SDK — it provides purpose-built abstractions for agent orchestration, tool use, and multi-agent management with Git-native workflows.
  </Card>
...
Write Python functions, connect APIs, or use the ADK and REST APIs to manage agents programmatically. The ADK is not a general-purpose SDK — it is purpose-built for agentic workflows like orchestration, tool integration, and multi-agent coordination.
...
<CardGroup cols={3}>
  ...
  <Card title="ADK" icon="terminal" href="/extend/adk">
    Agent-native development kit with orchestration, tool use, and Git workflows
  </Card>
  <Card title="API reference" icon="square-terminal" href="/api-reference/introduction">
