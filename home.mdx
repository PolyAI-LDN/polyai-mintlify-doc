...
<Note>
  You're in [simplified mode](/platform/simplified-mode). Developer, API, and advanced docs are hidden. Click the **Simplified — exit** pill in the top-right corner (or visit the simplified-mode page) to switch back to full docs.
</Note>
