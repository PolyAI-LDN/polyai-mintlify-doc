...
The self-serve, 60-day free trial of Agent Studio. These docs are scoped to what you can actually do on the Open platform — enterprise pages stay browsable but lock behind a banner.

<Note>
  Click **Open platform — exit** in the top-right corner of any page to see the full enterprise docs.
</Note>

## You're here. Now what?

Open Studio Assistant on the home screen at [studio.poly.ai](https://studio.poly.ai/), tell it what you want, paste a URL or a document for context. It proposes a plan; you read it, ask for changes, approve. The agent is testable in the browser the moment the plan applies, and embeddable on your site with a single script tag.
