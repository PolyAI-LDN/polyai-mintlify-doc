...
sidebarTitle: "Home"
mode: "wide"
description: "PolyAI is a self-serve platform for building voice and chat agents — sign up free at studio.poly.ai and start building today."
keywords:
  - "PolyAI"
  - "documentation"
  - "agent studio"
...
Every change lands in [Sandbox](/environments-and-versions/environments) before it reaches Live. An optional Staging environment lets you try the agent on a real call before your customers do.
