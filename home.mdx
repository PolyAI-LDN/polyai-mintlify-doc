...
PolyAI builds voice AI agents that handle real customer calls — answering questions, making bookings, resolving issues, and handing off to humans. Powered by [Raven](/agent-settings/raven), a proprietary LLM with sub-300ms latency across 24+ languages.
...
<CardGroup cols={3}>
  <Card title="Build in the UI" icon="browser" href="/get-started/introduction">
    Build and manage agents visually — no code required.
  </Card>
