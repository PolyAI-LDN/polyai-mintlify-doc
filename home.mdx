...
Open [Agent Studio](https://studio.us.poly.ai/), describe what you want, and you'll have a working agent you can talk to. No code required.

<CardGroup cols={2}>
  <Card title="Quickstart" icon="rocket" href="/get-started/quickstart">
    Describe → test → embed. Your first agent, end to end.
  </Card>
  <Card title="Put it on your website" icon="code" href="/widgets/install">
    One script tag. Live in minutes.
  </Card>
</CardGroup>

## Copy-paste prompts for Studio Assistant

Paste any of these into [Studio Assistant](/studio-assistant/introduction) to scaffold an agent instantly.
...
<CardGroup cols={3}>
  <Card title="Add knowledge" icon="brain" href="/managed-topics/introduction">
    Teach your agent what it needs to know.
  </Card>
  <Card title="Build flows" icon="diagram-project" href="/flows/no-code/introduction">
    Multi-step conversations, no code.
  </Card>
  <Card title="Fix a bad call" icon="wrench" href="/learn/iterate-open-platform">
    Listen, diagnose, iterate.
  </Card>
</CardGroup>
