...
<Note>
  You're in [free trial mode](/platform/free-trial-mode). Enterprise-only, developer, API, and advanced docs are hidden. Click the **Free trial — exit** pill in the top-right corner (or visit the free trial mode page) to switch back to full docs.
</Note>
...
<Tip>
  **On the free trial?** Try [free trial mode](/platform/free-trial-mode) – hides enterprise, developer, API, and advanced docs so you only see what's available to self-serve users.
</Tip>
