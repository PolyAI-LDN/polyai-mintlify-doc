...
<Note>
  You're in the [Open Platform docs view](/platform/open-platform#open-platform-docs-view). Enterprise-only docs are dimmed and gated behind a Talk to sales banner. Click the **Exit Open Platform view** pill in the top-right corner (or visit the Open Platform page) to switch back to full docs.
</Note>
...
<Tip>
  **On the self-serve plan?** Try the [Open Platform docs view](/platform/open-platform#open-platform-docs-view) – dims enterprise, developer, API, and advanced docs behind a Talk to sales banner so you only act on what's available to self-serve users.
</Tip>
