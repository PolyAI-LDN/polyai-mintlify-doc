...
<Note>
  You're in the [Open Platform docs view](/platform/open-platform#open-platform-docs-view). Enterprise-only docs are dimmed and locked behind a banner explaining what they need. Click the **Exit Open Platform view** pill in the top-right corner (or visit the Open Platform page) to switch back to full docs.
</Note>
