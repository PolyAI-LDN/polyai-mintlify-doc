...
{/* TODO image — alt: "Test widget preview page running a live Polyphone call" — path: /images/polyphone/test-widget-preview.png */}
## Opening the test widget

1. Open your Polyphone widget in **Deployment > Widget** (select your phone widget from the list).
...
{/* TODO image — alt: "Polyphone call states: launcher, call-start screen, connecting, in call, ended" — path: /images/polyphone/call-states.png */}
<Steps>
