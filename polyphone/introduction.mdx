...
Web Calling is a voice widget you embed on your website. Visitors click it, their browser connects to PolyAI over WebRTC, and they're in a call with your agent. No phone number, no app install, no callback queue. You configure it from **Deployment > Widget** in Agent Studio.

<Frame caption="Web Calling launcher on a website">
  <img src="/images/polyphone/hero-launcher.png" alt="Web Calling launcher in the bottom-right of a website" />
</Frame>
...
- [Studio Assistant](/studio-assistant/introduction), ask the assistant to adjust Web Calling behavior in plain language
