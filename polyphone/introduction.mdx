...
Web Calling is a voice widget you embed on your website. Visitors click it, their browser connects to PolyAI over WebRTC, and they're in a call with your agent. No phone number, no app install, no callback queue. You configure it from <span className="simplified-only">**Configure > Web Calling**</span><span className="full-only">**Deployment > Widget**</span> in Agent Studio.
