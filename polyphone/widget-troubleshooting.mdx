...
Polyphone runs in the visitor's browser, so the issues you'll hit usually fall into a small, well-understood set: launcher rendering, microphone permissions, network/WebRTC, and audio routing. Walk through the checks below and you'll resolve most of them in a few minutes.
