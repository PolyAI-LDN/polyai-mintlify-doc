...
- **Test before publishing** – verify handoff destinations route correctly over an in-app call in Sandbox, or by moving your Branch to Staging and calling the Staging number
