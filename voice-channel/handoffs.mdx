...
- **[Handoff actions in Managed Topics](/knowledge/faqs/actions/handoff)** - Add handoff triggers to Knowledge topics
...
1. **Connect your Twilio account**:
   ...
   - Go to **[Configure > Numbers](/voice-channel/numbers/introduction)** in the Agent Studio.
...
<CardGroup cols={3}>
  ...
  <Card title="Twilio handoff" icon="phone" href="/voice-channel/numbers/twilio/how-to-handoff">
