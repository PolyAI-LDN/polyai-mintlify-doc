...
title: Handoff
description: "Set up handoff destinations to transfer callers to human agents mid-conversation, with routing rules, transfer messages, and context handover."
tag: "Code"
keywords:
  - handoff
  - call transfer
