...
description: 'Purchase phone numbers directly from PolyAI inside Agent Studio, without a third-party telephony provider, preconfigured to route calls to your agent.'
keywords:
  - buy number
  - purchase number
  - phone number
