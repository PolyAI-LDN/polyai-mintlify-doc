...
<CardGroup cols={2}>
  <Card title="SMS messaging" icon="message" href="/voice-channel/message-templates">
    Set up SMS messaging with your Twilio account
  </Card>
  <Card title="Handoff integration" icon="phone-volume" href="/voice-channel/numbers/twilio/how-to-handoff">
