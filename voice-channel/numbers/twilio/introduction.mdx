...
<CardGroup cols={2}>
  ...
  <Card title="SMS integration" icon="message" href="/voice-channel/message-templates">
...
<CardGroup cols={2}>
  <Card title="Call handoffs" icon="phone-volume" href="/voice-channel/handoffs">
    Configure handoff destinations for live agent transfers
  </Card>
  <Card title="Telephony overview" icon="phone" href="/voice-channel/numbers/introduction">
