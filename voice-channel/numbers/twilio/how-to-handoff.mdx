...
description: 'Configure handoff destinations for your Twilio-connected PolyAI number so the agent can transfer live calls to human agents or specific departments.'
tag: "Advanced"
---
