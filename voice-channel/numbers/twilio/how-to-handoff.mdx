...
2. Test over an in-app call in **Sandbox**, or move your Branch to **Staging** and call the Staging number, then trigger the topic that should initiate the transfer.
3. Verify the call routes to the correct destination.

## Next steps

<CardGroup cols={2}>
  <Card title="Call Handoffs overview" icon="phone-volume" href="/voice-channel/handoffs">
  ...
  <Card title="Phone number integration" icon="phone" href="/voice-channel/numbers/twilio/how-to-integrate-voice">
