...
2. Click **Publish** in the top right corner to publish your changes to Live.

<Warning>
Voice changes reach callers on Live only after you publish your Branch. Test the new voice over an in-app call before publishing. After publishing, call your Live number to confirm it sounds as expected.
</Warning>
