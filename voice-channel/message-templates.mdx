...
description: "Send SMS confirmations, links, and follow-ups from your PolyAI voice agent using Twilio, with reusable message templates and A2P 10DLC compliance."
keywords:
  - SMS
  - text message
  - messaging
