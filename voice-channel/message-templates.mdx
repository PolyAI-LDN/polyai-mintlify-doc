...
The phone number you select in the template form applies to the **Live** environment. Sandbox and Staging can be configured separately. This prevents test messages from being sent from your production number during development.
