...
description: "Start flows from FAQs, global functions, or transition functions using conv.goto_flow()."
keywords:
  - triggering flows
  - goto_flow
  - start flow
...
<Info>
**This page requires Python familiarity** for the programmatic examples. Non-technical operators can trigger flows from FAQs actions without writing code – see [Start a flow from a FAQs action](#start-a-flow-from-a-managed-topics-action) below. All code-focused content is also available in the **Developer** tab.
</Info>
