...
<Frame caption="Global function icon in a flow step">
  ![Global function icon shown next to a function reference in a flow step](/images/flows/global-function-ui.png)
</Frame>

Global functions also have profile items in the functions tab.

<Frame caption="Global functions in the functions tab">
  ![Global functions listed in the functions tab with profile details](/images/flows/global-function-menu.png)
</Frame>
...
<Frame caption="Flow functions modal">
  ![Flow functions modal showing a list of transition functions for the current flow](/images/flows/transition-function-menu.png)
</Frame>
...
<Frame caption="Transition function editor">
  ![Transition function editor showing code and step references](/images/flows/transition-function.png)
</Frame>
...
<CardGroup cols={3}>
  ...
  <Card title="Triggering flows" icon="play" href="/flows/triggering-flows">
    All the ways to start a flow using conv.goto_flow().
  </Card>
  <Card title="No-code flows" icon="wand-magic-sparkles" href="/flows/no-code/introduction">
