...
Function names directly affect how the agent behaves. Use **retrospective, intent-based names** that describe what just happened or what was resolved — not where the flow is going next.
