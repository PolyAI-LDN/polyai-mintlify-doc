---
title: 'Example flow'
description: 'A complete reservation confirmation flow showing prompts, transitions, and ASR biasing patterns.'
---
...
<Frame caption="Example flow in the Flow Editor">
  ![Example flow in the Flow Editor](/images/flows/flow-default-page.png)
</Frame>
...
<Frame caption="Start step with annotated components">
  ![Start step with annotated components](/images/flows/flow-hotel-start-step.png)
</Frame>
...
<Frame caption="Middle steps collecting first and last name">
  ![Middle steps collecting first and last name](/images/flows/flow-example-middle.png)
</Frame>
...
<Frame caption="End step with reservation matching logic">
  ![End step with reservation matching logic](/images/flows/flow-example-end.png)
</Frame>
