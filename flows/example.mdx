...
<Frame caption="Example flow in the Flow Editor">
  ![Example flow in the Flow Editor](/images/flow-default-page.png)
</Frame>
...
<Frame caption="Start step with annotated components">
  ![Start step with annotated components](/images/flow-hotel-start-step.png)
</Frame>
...
```python
@func_description("Saves the confirmation code and moves to the next step")
@func_parameter(name="confirmation", description="The confirmation code provided by the user")
...
<Frame caption="Middle steps collecting first and last name">
  ![Middle steps collecting first and last name](/images/flow-example-middle.png)
</Frame>
...
<Frame caption="End step with reservation matching logic">
  ![End step with reservation matching logic](/images/flow-example-end.png)
</Frame>
