...
description: 'Guide callers through structured, multi-step processes such as bookings, routing, and identity verification, with entity extraction and branching logic.'
mode: wide
keywords:
  - flows
  - conversation flow
