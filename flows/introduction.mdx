...
To make global Knowledge functions available while a flow is running, add the following to your agent's **Voice configuration** or **Chat configuration** settings (under the advanced LLM configuration section). Contact your PolyAI representative if you need help locating this setting.
