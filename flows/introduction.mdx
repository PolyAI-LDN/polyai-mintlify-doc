...
- **Functions**: Logic blocks that validate input, call APIs, store values, or move the conversation forward.
...
1. System prompt (includes Rules and About)
2. Any relevant KB entries (if applicable)
3. Conversation history
4. The **step prompt** (appended last)
