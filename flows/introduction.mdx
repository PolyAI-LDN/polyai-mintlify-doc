...
Flows are triggered by specific [functions](/function/introduction) or [action fields](/knowledge-base/how-to-setup-action/introduction), and once a flow is active, the assistant will progress through its steps sequentially,
