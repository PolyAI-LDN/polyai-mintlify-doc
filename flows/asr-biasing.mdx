...
<Info>
**This page covers flow-level ASR configuration.** For dynamic ASR biasing from Python functions, see [`conv.set_asr_biasing()`](/function/classes/conv-object). Setting up ASR biasing in the flow editor does not require code.
</Info>
