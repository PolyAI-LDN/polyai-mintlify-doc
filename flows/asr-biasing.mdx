...
In the [flow taken from the example page](example), the assistant is collecting a confirmation code. Because users often say mixed letters and numbers, we toggle **Alphanumeric** biasing.
