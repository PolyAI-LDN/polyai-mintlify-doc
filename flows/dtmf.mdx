...
<Warning>DTMF configuration is available on **Advanced** and **Default** flow steps. Function steps do not support DTMF. Additionally, DTMF output is not currently supported with the **realtime model** — if your agent uses the realtime model, DTMF collection will not work.</Warning>

## Configuring DTMF in a flow step

1. Open your **flow** in the editor.
2. Select the **Advanced** or **Default** step where you want to collect numeric input.
