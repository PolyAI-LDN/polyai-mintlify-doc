...
<Frame caption="DTMF configuration options in the flow step settings panel">
...
<Frame caption="Timing diagram showing DTMF collection during agent greeting">
...
<Frame caption="Flow logic showing DTMF-based routing for recording opt-out">
