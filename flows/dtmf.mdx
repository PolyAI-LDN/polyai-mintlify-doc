...
<Warning>
In some cases, calling `conv.discard_recording()` in the `start_function` may not reliably prevent the recording from being stored. If you call it and the recording still persists, contact **PolyAI support** to resolve the issue.
</Warning>
