...
<Frame caption="Number entity config panel">
  ![Number entity config panel](/images/flows/entity-number-config.png)
</Frame>
</Accordion>
...
<Frame caption="Alphanumeric entity validation dropdown">
  ![Alphanumeric entity validation dropdown](/images/flows/entity-alphanum-config.png)
</Frame>
</Accordion>
...
<Tip>
In [Conversation Review](/analytics/conversations/review), you can see system-generated events for entity validation and condition evaluation. These help you identify whether an entity was rejected or a condition was skipped.
</Tip>
