...
PolyAI uses RAG to match user queries to knowledge base topics and generate contextual responses. Here is how it works in Agent Studio:
...
You do not need to retrain a model when you update your knowledge base. Changes to topics take effect immediately because RAG retrieves from the current knowledge base at query time.