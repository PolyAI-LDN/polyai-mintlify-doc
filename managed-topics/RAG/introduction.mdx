...
2. **Retrieval**: The retriever component searches structured knowledge to find matching topics. The knowledge is organized to optimize RAG's performance and ensure precise matches.
...
<Note>
Behavior may vary depending on your agent's configuration. For example, agents using the real-time (speech-to-speech) model may trigger retrieval differently than standard voice agents.
</Note>
