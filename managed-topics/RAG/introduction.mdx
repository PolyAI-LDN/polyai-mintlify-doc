...
<Note>
You can add up to **20** sample questions per topic. More questions help the retriever find the right match, but only a small subset (typically the top 3) are passed into the LLM context at query time. Write your most representative questions first.
</Note>
