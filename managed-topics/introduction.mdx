...
The Managed Topics (MTs), found under **Build > Knowledge** in the sidebar, are the brain of your agent. Each topic defines a single intent — how users might phrase it, what the agent should say, and what it should do next.
...
- Add 5–20 realistic sample phrasings.
