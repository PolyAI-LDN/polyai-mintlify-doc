...
<Tip>
If you need to add custom logic to your topics — such as API calls, data lookups, or conditional behavior — see the [Functions](/function/introduction) documentation in the **Developer** tab.
</Tip>
