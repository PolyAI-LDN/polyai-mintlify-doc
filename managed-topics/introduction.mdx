...
The Managed Topics interface lists all your topics in a searchable, filterable view. Each topic appears as a card showing its name, sample questions count, and status. Click any topic card to open the editor and modify its content, sample questions, or actions. You can also bulk import topics via CSV, toggle activation status, or delete topics directly from this interface.

## How retrieval works

<Frame caption="RAG-powered topic retrieval flow">
...
<Frame caption="Toggle topic activation status in the UI">
