...
<Tip>
For best topic matching and response quality, use PolyAI's [Raven](/agent-settings/model-use) model — it is optimized for grounding responses in retrieved knowledge and produces more natural paraphrasing of topic content.
</Tip>
