...
<Tip>
**Use [Agent Builder](/agent-builder/introduction) to maintain topics in natural language.** Ask it to *"add a topic for store hours"*, *"tighten the refund answer"*, or *"create topics from `https://example.com/faq`"* — it edits Managed Topics on a branch you review before merging. You can also edit topics directly in this tab.
</Tip>
