...
Managed Topics (**Build > Knowledge**) define what your agent knows. Each topic contains sample questions, an answer, and optional actions.
...
- [How to maintain a KB](/learn/maintain/knowledge-base)