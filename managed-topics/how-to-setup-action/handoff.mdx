...
Add a handoff action to a Managed Topic so your agent can transfer callers to a live agent or specific department when the topic is matched. For voice, this routes the call via [SIP (Session Initiation Protocol)](https://en.wikipedia.org/wiki/Session_Initiation_Protocol); for webchat, this connects users to live chat agents.
