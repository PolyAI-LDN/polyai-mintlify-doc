...
<Frame caption="The Actions field menu showing Functions, Call handoff, and SMS options">
...
<Frame caption="Handoff destination dropdown">
  ![Handoff destination dropdown](/images/managed-topics/handoff-destination-dropdown.png)
</Frame>
...
<Frame caption="Completed handoff action reference">
  ![Completed handoff action reference](/images/managed-topics/handoff-completed.png)
</Frame>
