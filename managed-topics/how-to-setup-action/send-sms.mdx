...
2. To create a new template, click **+ add sms template**. You will be redirected to the [SMS Messaging](/sms/introduction) section to define the message content and phone number.
