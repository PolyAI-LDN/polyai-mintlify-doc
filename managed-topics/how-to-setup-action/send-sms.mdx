...
Integrating SMS sending functionality into your topics allows your agent to send SMS messages based on user interactions. Before enabling outbound SMS, please ensure that you have completed the setup process described in the [How to Setup SMS Integration](/sms/introduction) page.

## Adding an SMS trigger to a topic

You can add "trigger sending out SMS" into a topic in three ways:
...
By following these steps, you can effectively integrate SMS sending capabilities into your actions. This allows your agent to provide additional information using SMS, enhancing the overall user experience.
