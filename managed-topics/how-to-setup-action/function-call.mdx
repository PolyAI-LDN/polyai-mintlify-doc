...
<Warning>
  When a function is referenced inside a flow action, it may not be included in the LLM's tool definitions. This means the LLM cannot see or call the function. If you encounter this, add the function reference to the [Behavior](/agent-settings/rules) section so the LLM is aware of it.
</Warning>
