...
description: "Guide to invoking functions within a topic of your agent"
---

Using functions, you can enhance the actions your of your agent performs by including custom functionalities. Here's how you can invoke a function in an action:

## Introduction

Now that we've ensured our function works, we want to get our agent to use it. Open an action and start writing your instructions.

## Adding a Function

You can add a function into an action in three ways:
...
You can use a function as many times as you like to cover all the use cases you want your agent to handle.

<Tip>
  It may require some iterative testing to get your agent to call your function and behave as expected.
</Tip>
...
- You can check if your agent called a function and with what parameters by clicking on the settings button next to the close button in the test panel and enabling the tool calls toggle.

By following these steps, you can successfully invoke functions from an action of your agent.
