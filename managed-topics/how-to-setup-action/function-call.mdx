...
<Frame caption="Function picker slash menu">
  ![Function picker slash menu](/images/managed-topics/fn-picker-menu.png)
</Frame>
...
<Steps>
  ...
  <Step title="Inspect tool calls">
    ...
    <Frame caption="Testing a function call with the test panel">
...
- [Using tools in topics](/tools/using-tools-in-knowledge-base) — detailed guide on integrating functions into managed topics
- [Create a function](/tools/how-to-setup) — set up a new function with parameters and Python code
- [Return values](/tools/return-values) — control agent behavior with function return values
- [Transition functions](/flows/transition-functions) — flow-scoped functions using `{"{{ft:...}}"}` syntax
