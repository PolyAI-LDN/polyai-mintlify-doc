...
Configures the assistant to listen in the next turn. This uses the [Listen](https://www.notion.so/Policy-Fundamentals-126097db17f780e8aeaae0d703d8624d?pvs=21) configuration from policy:
