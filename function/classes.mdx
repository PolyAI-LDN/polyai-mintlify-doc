...
Parameters:
- `provider_voice_id`: This must be an **S3 path to a manifest file** that contains the voice configuration.
...
- `speed`: Controls the speed of speech (1.0 is normal).
- `language`: Sets the language code for synthesis (e.g., "en" for English).
- `emotion`: Sets the emotional tone of the speech.
