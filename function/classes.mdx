...
The `PlayHTVoice` class configures voice settings for [PlayHT](https://docs.play.ht/reference/voice-parameters) TTS system, allowing selection of a specific voice ID and style.
