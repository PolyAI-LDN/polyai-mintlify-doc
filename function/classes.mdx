...
<Tabs>
  ...
  <Tab title="Cartesia">
    ...
    | `emotions` | List of `Emotion` objects (see [voice reference](/function/classes/voice)) |
...
<Tip>For full voice configuration examples including ElevenLabs model IDs, Cartesia emotions, and cache behavior, see the [Voice class reference](/function/classes/voice).</Tip>
