...
<Warning>
Cache invalidation when switching models is a known limitation. Cached audio may continue to use the previous model's configuration even after you update `model_id`. If you are changing models on an active voice, use the voice ID prefix approach below to avoid stale cache entries.
</Warning>
