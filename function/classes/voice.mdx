...
<Warning>
**`eleven_v3` and `optimize_streaming_latency`:** Do not set `optimize_streaming_latency` when using `eleven_v3` — this parameter is not supported by the v3 model and will cause an error. Ensure your configuration omits this parameter when using `eleven_v3`.
</Warning>
