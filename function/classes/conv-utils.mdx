...
<Note>This method is **opt-in** and must be enabled for your account. A `NotImplementedError` is raised if it has not been enabled — contact your admin to request access.</Note>
