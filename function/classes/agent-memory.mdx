...
<Warning>This is an **advanced** feature requiring explicit configuration. It is not enabled by default.</Warning>

Agent Memory allows your assistant to persist data about users across conversations. This enables experiences like repeat-caller logic, customer preferences, and cross-channel continuity.

<Note>This feature is in early access. Functionality may evolve. Contact [PolyAI support](mailto:support@poly.ai) for guidance on production use.</Note>
