...
You can use the [`conv.env`](./conv-object#env) property to define environment-specific platform functions and activate test features in sandbox or pre-release environments.
