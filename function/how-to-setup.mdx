...
description: 'Create a function in Agent Studio.'
---
...
### 6. **Define the function**
   ...
   - The function should return a string or dictionary. A string is provided to the LLM as additional context for the next response. A dictionary can include structured fields like `utterance`, `handoff`, or `hangup`. See [Return values](/function/return-values) for the full list of supported return types.
