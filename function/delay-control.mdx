...
<Note>
Sound-based utterances (such as keyboard typing sounds) require the audio to be **pre-cached by the voice team** before they can be used. If you configure a sound effect utterance without requesting the cache upload, it will not play as expected. Contact the voice team to set this up before deploying.
</Note>
...
* If you want to use sound effects (e.g., typing sounds), contact the voice team to pre-cache the audio before deploying. Without this step, the sound will not play.
