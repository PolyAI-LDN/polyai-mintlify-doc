...
* If you want to use sound effects (e.g., typing sounds), contact your PolyAI representative to pre-cache the audio before deploying. Without this step, the sound will not play.
