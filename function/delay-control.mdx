...
The **delay control** feature helps improve the user experience when a function takes longer than expected by inserting filler utterances while the function is still processing. This prevents long silences, making interactions feel more natural and responsive.
