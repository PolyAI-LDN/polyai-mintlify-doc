...
<Tip>
You can reference state variables using the `$` symbol inside delay responses.
For example, a response might say:
`Your booking has been made at $branch_name...`
The assistant will substitute the value of the `branch_name` state variable automatically.
</Tip>
