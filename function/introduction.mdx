...
4. **Control over triggering**:
   ...
   - Avoid over-triggering or under-triggering by refining language inputs and prompts. See [agent settings](/agent-settings/introduction) for configuration options.
...
6. **Iterative testing**:
   - Test functions in multiple scenarios to refine behavior and improve reliability. Use [Test Cases and Test Sets](/analytics/test-suite/introduction), and optionally configure sets to run automatically on publish/promote.
