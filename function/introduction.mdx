...
<Note>
In the Agent Studio UI, this feature is called **Tools** (found under **Build > Tools** in the sidebar). In these docs, "tools" and "functions" refer to the same thing — Python scripts that extend your agent's capabilities. The special **start function** and **end function** retain their original names.
</Note>
...
<CardGroup cols={2}>
  ...
  <Card title="Function classes" icon="cube" href="./classes">
