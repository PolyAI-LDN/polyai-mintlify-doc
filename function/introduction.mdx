...
ability to interact with external systems and allow for advanced customization of responses. Use [`conv.log`](./classes/conv-log) to write structured logs that appear in **Conversation review → Diagnosis** and using the Conversations API.
