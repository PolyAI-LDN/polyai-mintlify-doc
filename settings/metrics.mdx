...
<Frame caption="Metrics list view">
...
<Frame caption="Metric creation form">
...
<Frame caption="Configuration button on the API Keys page">
...
<Frame caption="Response metrics configuration panel">
