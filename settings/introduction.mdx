...
For the full reference – categories, severity behavior, language support, monitoring, and how filters interact with [Guardrails](/agent-settings/guardrails) – see [Safety filters](/agent-settings/safety-filters). Override the defaults per channel in [Voice configuration](/voice/voice-configuration#safety-filters) and [Chat configuration](/webchat/chat-configuration#safety-filters).
