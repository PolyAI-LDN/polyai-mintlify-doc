...
a scenario where the agent cannot handle a query where a live, human agent is required.
...
- **Example**: A museum agent might have a handoff destination called "School visits" to transfer calls related to group bookings or educational inquiries.
