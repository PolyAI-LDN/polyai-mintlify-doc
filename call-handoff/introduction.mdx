...
<Note>
US-based Twilio SMS numbers must be [registered for A2P 10DLC](https://www.twilio.com/docs/messaging/compliance/a2p-10dlc#who-needs-to-register-for-a2p-10dlc). See the [Twilio handoff guide](/telephony/twilio/how-to-handoff) for details.
</Note>
