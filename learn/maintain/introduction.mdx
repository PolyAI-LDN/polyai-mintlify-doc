...
| Review call quality scores | [PolyScore](/analytics/polyscore) | 5-10 min | No code |
| Check customer satisfaction | [CSAT surveys](/analytics/csat/introduction) | 5 min | No code |
| Categorize calls at scale | [Agent Analysis](/agent-analysis/introduction) | 15-30 min | No code |
| Define custom metrics | [Metrics](/settings/metrics) | 10-20 min | No code |
...
<CardGroup cols={2}>
  ...
  <Card title="PolyScore" href="/analytics/polyscore" icon="star">
    Automated AI quality scoring for every voice conversation.
  </Card>
  <Card title="CSAT surveys" href="/analytics/csat/introduction" icon="face-smile">
    Measure customer satisfaction with post-call surveys.
  </Card>
  <Card title="Agent Analysis" href="/agent-analysis/introduction" icon="tags">
    Categorize calls at scale with custom LLM prompts.
  </Card>
</CardGroup>
...
### Daily (5-10 minutes)
1. Check overnight metrics on the [Standard dashboard](/analytics/dashboards/standard)
2. Review recent calls in [Conversation Review](/analytics/conversations/review)
3. Spot-check [PolyScore](/analytics/polyscore) on recent calls
4. Verify critical functions
5. Address urgent issues

**See:** [Health checks](/learn/maintain/health-checks), [Alerts API](/api-reference/alerts/introduction), [PolyScore](/analytics/polyscore)
...
**See:** [Smart Analyst](/smart-analyst/introduction), [CSAT](/analytics/csat/introduction), [Function maintenance](/learn/maintain/function-maintenance), [Voice and audio](/learn/maintain/voice-audio-updates)
