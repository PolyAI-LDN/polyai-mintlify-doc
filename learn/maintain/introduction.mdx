...
|--------------|---------|------|
| Update FAQs or business info | [Managed Topics](/learn/maintain/knowledge-base) | 10-30 min |
...
<CardGroup cols={2}>
  <Card title="Routing and handoffs" href="/learn/maintain/routing-handoffs">
    Update phone numbers, call routing, or transfer settings.
  </Card>
...
1. Update Managed Topics content
2. Sync Connected knowledge sources
3. Review analytics and trends
4. Fix identified issues
5. Publish and promote changes

**See:** [Managed Topics](/learn/maintain/knowledge-base), [Performance monitoring](/learn/maintain/performance-monitoring)
