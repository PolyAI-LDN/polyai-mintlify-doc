...
The **Connected** tab allows your agent to pull information from external sources like websites, files, and integrations. Keep sources fresh by syncing regularly, managing them per environment, and removing outdated or deprecated sources.
