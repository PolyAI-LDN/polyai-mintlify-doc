...
If you're using [variant management](/knowledge/variants/introduction) to handle multiple locations or configurations:
...
- [Connected knowledge overview](/knowledge/sources/introduction) - Learn about Connected knowledge capabilities
