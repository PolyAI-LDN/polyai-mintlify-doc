...
|---------|--------------|-----------|---------------|
| **My edit isn't live** | You saved in a *Branch* but didn't publish. | Publish the Branch from **Deployments**. | [Environments & versions ↗](/environments-and-versions/introduction) |
...
<AccordionGroup>
  ...
  <Accordion title="Agent says 'I don't know' for a topic that exists" icon="ban">
    **Diagnosis steps:**
    1. Check that the topic is on the Branch you are testing. If you are testing in Live, check that the Branch has been **published**.
...
<AccordionGroup>
  <Accordion title="Changes work in Sandbox but not in Live" icon="rocket">
    You need to **publish** your Branch to Live from the **Publish** menu. Changes on a Branch in Sandbox are not applied to Live until you publish them.

    See [Environments](/environments-and-versions/introduction) for the full publishing flow.
  </Accordion>

  <Accordion title="I published but the old behavior persists" icon="clock-rotate-left">
    1. Wait a few minutes. Publishing can take a short time to propagate.
    2. Check that the right change reached Live. Open **Live history** on the Deployments page and confirm the newest version is yours.
  ...
  <Accordion title="Call drops after the disclaimer" icon="phone-slash">
    If there are no knowledge topics published to the Live environment, the agent has nothing to say after the disclaimer and will end the call. Ensure at least one topic is published to Live before going live.
  </Accordion>
</AccordionGroup>
...
<AccordionGroup>
  ...
  <Accordion title="Call transfers fail or drop" icon="phone-xmark">
    ...
    3. Test in Sandbox first before publishing to Live.
...
- [Branch management](/learn/maintain/version-management) – publishing and rollback issues
