...
| **Audio is silent or distorted** | Voice config mismatch or bad network. | Check **Voice → Config** for the correct TTS voice. Test your network or try another device. | [Voice config ↗](/voice/voice-configuration) |
