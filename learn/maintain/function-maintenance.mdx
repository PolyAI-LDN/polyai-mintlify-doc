...
description: 'Update function code, debug errors using logs, manage credentials, and fix integration issues.'
tag: "Code"
---

Update function code, debug errors using `conv.log`, rotate API credentials, and fix integration issues without taking the agent offline.
...
- [Test sets](/analytics/test-suite/introduction) – automated regression testing to verify function changes
- [Alerts API](/api-reference/alerts/introduction) – automated alerts for function errors, latency, and API failures
