...
A published version includes: FAQs, Connected Knowledge configs, functions, agent settings, response controls, routing rules, API integrations, and test sets.
...
- **Run [test sets](/simulation-testing/introduction) before promoting** – catch regressions early
...
<AccordionGroup>
  <Accordion title="Automate the deployment pipeline via the Agents API" icon="code">
    ...
    A typical CI job publishes to Sandbox, runs your [simulation testing](/simulation-testing/introduction), promotes to Pre-release on success, and blocks promotion to Live behind a manual approval gate.
  </Accordion>
</AccordionGroup>
...
- [Simulation testing](/simulation-testing/introduction) – automated validation
