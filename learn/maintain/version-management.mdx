...
<AccordionGroup>
  <Accordion title="Automate the deployment pipeline via the Agents API" icon="code">
    ...
    A typical CI job publishes to Sandbox, runs your [test suite](/simulation-testing/introduction), promotes to Pre-release on success, and blocks promotion to Live behind a manual approval gate.
  </Accordion>
</AccordionGroup>
...
- [Test suite](/simulation-testing/introduction) – automated validation
