...
**Fixes:** add missing topics to [FAQs](/knowledge/faqs/introduction), add [Connected Knowledge](/knowledge/sources/introduction) sources, improve topic descriptions for better retrieval.
...
| [Simulation tests](/simulation-testing/introduction) | Automated regression testing across versions | **Simulation testing** |
