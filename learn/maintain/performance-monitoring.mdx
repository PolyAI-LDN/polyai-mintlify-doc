...
Go to **Analytics > Conversations > Voice** to drill into individual calls. Search, filter, listen to recordings, review transcriptions, and check the Diagnosis panel for technical details (function logs, knowledge retrieval, LLM prompts, timing breakdown).
...
|------|---------|-----------------|
| [Diagnosis panel](/analytics/conversations/diagnosis) | Inspect tool calls, knowledge retrieval, LLM prompts, and latency per turn | **Analytics > Conversations > Voice** → select a call → Diagnosis |
