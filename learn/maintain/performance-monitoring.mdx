...
description: 'Track latency, containment, and ASR accuracy – use dashboards and Smart Analyst for deep insights.'
---
...
Use [test sets](/simulation-testing/introduction) for automated regression testing and version comparison. Run them before promoting versions.
...
**Fixes:** add missing topics to [Managed Topics](/knowledge/faqs/introduction), add [Connected Knowledge](/knowledge/sources/introduction) sources, improve topic descriptions for better retrieval.
...
| [Test sets](/simulation-testing/introduction) | Automated regression testing across versions | **Analytics > Test suite** |
