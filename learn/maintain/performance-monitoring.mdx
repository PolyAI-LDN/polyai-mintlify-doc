...
|------|---------|-----------------|
| [Diagnosis panel](/analytics/conversations/diagnosis) | Inspect tool calls, knowledge retrieval, LLM prompts, and latency per turn | **Analytics > Conversations** → select a call → Diagnosis |
