...
description: 'Track latency, containment, and ASR accuracy – use dashboards and Wren for deep insights.'
---
...
| Track version performance | **Compare changes** in **Deployments** |
...
Use [test sets](/testing/simulation-tests) for automated regression testing and version comparison. Run them before publishing a Branch.
