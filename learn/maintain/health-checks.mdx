...
3. **Spot-check handoff reasons** for new patterns
...
3. Listen to 5-10 calls (mix of successful and unsuccessful)
4. Check [test set](/analytics/test-suite/introduction) results for regressions
5. Plan improvements for the following week
...
2. Break down containment by handoff reason — set goals for next month
3. Audit all [Managed Topics](/managed-topics/introduction) for outdated content
