...
| Change interaction style (latency) | Channels > Voice > Audio Management → Interaction style | 2 min |
| Enable/disable barge-in | Channels > Voice > Audio Management → Enable barge-in toggle | 1 min |
...
See [Add a voice](/voice/add-a-new-voice) and [Voice classes](/tools/classes/voice) for the full list of providers and parameters.
...
1. Locate the **Interaction style** section in **Channels > Voice > Audio management**
2. Choose a mode:
...
1. Find **Enable barge-in** in **Channels > Voice > Audio management**
2. Toggle it on or off
3. Test in Agent Chat to ensure it feels natural

**When to enable:**
- Using Turbo interaction mode
...
|-------|--------------|----------|
| Voice sounds robotic | Low-quality TTS provider | Switch to Cartesia or ElevenLabs, or upgrade voice model |
...
2. Set interaction style to Turbo
3. Enable barge-in
