...
<Tip>Use a multilingual voice model (such as ElevenLabs multilingual or Cartesia sonic) to ensure proper pronunciation across all languages. See [Voice classes](/function/classes/voice) for available providers.</Tip>
...
See [Voice classes](/function/classes/voice) for the full list of providers and configuration options.
...
- [Functions](/function/introduction) - Handle language in code
