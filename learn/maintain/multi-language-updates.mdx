...
| I need to... | Action |
|---|---|
| Add a new language | **Build > Agent > Multi-language** → Add language |
...
1. Go to **Build > Agent > Multi-language** and click **Add language**
...
Remove the language from **Build > Agent > Multi-language**, then update any language-specific knowledge, translations, and functions. The agent will fall back to the default language for callers speaking the removed language.
