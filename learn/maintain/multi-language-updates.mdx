...
You can also use `conv.translations` to reference pre-translated utterances without manual branching:
...
Define translation keys in the **Translation** page with per-language values. For centralized utterance management in code, see the [custom `Utterances` helper pattern](/tools/return-values#multilingual-utterances).
