...
6. Update [Agent Behavior rules](/agent-settings/rules) to handle the new language
...
If the agent is switching languages too aggressively or not enough, adjust via [Agent Behavior rules](/agent-settings/rules). For example, you can instruct the agent to only switch languages when the caller has spoken consistently in a different language for multiple turns.
...
- Adjust [Agent Behavior rules](/agent-settings/rules) to accommodate mixed-language input
...
| Agent switches languages incorrectly | Detection too aggressive | Adjust language-switching behavior in [Agent Behavior rules](/agent-settings/rules) |
...
2. Update [Agent Behavior rules](/agent-settings/rules) to handle the new language
...
3. Adjust language-switching behavior in [Agent Behavior rules](/agent-settings/rules)
