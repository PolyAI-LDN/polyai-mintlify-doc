---
title: "Maintaining FAQs"
description: "Quickly edit, add, or bulk-update FAQs – the agent's FAQ and knowledge."
---
...
<Tip>
**Prefer natural language?** Ask [Wren](/wren/introduction), for example *"tighten the refund answer to mention the 30-day window"*, *"add a topic for store hours: 9-5 Mon-Fri"*, *"create topics from `https://example.com/faq`"*. Changes land on a Branch you review before publishing.
</Tip>
...
| Publish to Live | Publish menu → Compare changes → Publish | 5 min |

<Tip>
   Always test in a _Branch_ first and only publish once the change is validated. Details are in [Environments & versions](/environments-and-versions/introduction). 
</Tip>
...
If you want to test with a real phone number or widget first, move the Branch to Staging (Branches and Sub-branches modes only). See [Staging](/environments-and-versions/environments#staging).
...
- [Branch management](/learn/maintain/version-management) - Publish changes and roll back
