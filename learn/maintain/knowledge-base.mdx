...
<Tip>
**Prefer natural language?** Ask [Agent Builder](/agent-builder/introduction) — *"tighten the refund answer to mention the 30-day window"*, *"add a topic for store hours: 9-5 Mon-Fri"*, *"create topics from `https://example.com/faq`"*. Changes land on a branch you review before merging.
</Tip>
