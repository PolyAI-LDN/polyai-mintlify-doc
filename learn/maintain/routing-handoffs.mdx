...
3. Update [Managed Topics](/learn/maintain/knowledge-base) to reference the new handoff
...
- [Smart Analyst](/smart-analyst/introduction) - Analyze handoff reasons at scale
- [Performance monitoring](/learn/maintain/performance-monitoring) - Track handoff rate changes
- [Standard dashboard](/analytics/dashboards/standard) - Monitor handoff metrics
- [Conversation Review](/analytics/conversations/review) - Verify handoff behavior
- [Health checks](/learn/maintain/health-checks) - Post-deployment monitoring
- [Common issues](/learn/maintain/common-issues) - Troubleshooting
