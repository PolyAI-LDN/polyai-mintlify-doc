...
<Steps>
  <Step title="Open Configuration Builder">
    Open the **Real-Time Configuration** page, click **Configure schema** in the page header to open the Configuration Builder side panel, then switch to the **Data** tab.
  </Step>
