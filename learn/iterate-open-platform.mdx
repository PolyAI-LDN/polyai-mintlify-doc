...
description: "Read the transcript, find the failure, ask Wren to fix the topic, flow, or behavior rule, and share the branch for review. The core iteration loop."
keywords:
  - iterate
  - improve agent
  - conversation review
