...
<Note>
  This page covers the iterate-after-a-call loop with [Agent Builder](/agent-builder/introduction): read the transcript, ask Agent Builder to fix it, share the link. Agent Builder is available to **project admins on enterprise clusters** as well as free-trial accounts — the workflow is the same in both.
</Note>
...
<CardGroup cols={2}>
  ...
  <Card title="Prompting Agent Builder" icon="message-pen" href="/agent-builder/prompting">
