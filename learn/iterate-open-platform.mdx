...
<Note>
  You're in [Agent Builder mode](/studio-assistant/introduction). This page covers the self-serve iterate-after-a-call loop: read the transcript, ask Agent Builder to fix it, share the link. Click the **Free trial — exit** pill in the top-right corner for the full enterprise view.
</Note>
