...
<CardGroup cols={3}>
  ...
  <Card title="Environment" icon="server">
    A place where a specific version is running and can be used by real callers.
  </Card>
</CardGroup>
...
<AccordionGroup>
  ...
  <Accordion title="Key actions" icon="ellipsis-vertical">
    ...
    - **Compare versions** – see changes side by side
...
<Tabs>
  ...
  <Tab title="Pre-release" icon="vial">
    Pre-release is your **testing environment** for final checks before going live.
    ...
    **Use Pre-release for:**
    ...
    <AccordionGroup>
      <Accordion title="Best practices" icon="circle-check">
        ...
        - Re-run your full test checklist:
          - Simple FAQ
          - Multiturn FAQ
          - SMS offer
          - Handoff
...
<CardGroup cols={2}>
  <Card title="What it shows" icon="code-compare">
    ...
    - Modified content
    - Removed actions
    - Changes to how functions are connected
...
<Tip>
  **Example comparison insight:**
  ...
  If you can't explain every change in the comparison, don't promote.
</Tip>
