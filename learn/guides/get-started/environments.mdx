...
<iframe
  src="https://tally.so/embed/rjVaKp?alignLeft=1&hideTitle=1&transparentBackground=1&dynamicHeight=1"
  width="100%"
  height="500"
  frameBorder="0"
  title="Knowledge check: Environments"
/>

<AccordionGroup>
  <Accordion title="Q1: What does clicking 'Publish' do?">
    **Answer:** It creates a **snapshot (version)** of the agent at that moment. It does NOT immediately push to Live — you still need to promote the version to an environment.
  </Accordion>
  <Accordion title="Q2: Which environment should real user traffic come from?">
    **Answer:** **Live.** Sandbox is for development, Pre-release is for QA and UAT — neither should receive real user traffic.
  </Accordion>
</AccordionGroup>
