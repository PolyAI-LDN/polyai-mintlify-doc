...
<AccordionGroup>
  <Accordion title="Q1: What should you avoid in a project name?">
    **Answer:** Including the environment name (like "Prod" or "Live"). Project names should be descriptive and reusable across environments.
  </Accordion>
  <Accordion title="Q2: What is the Project ID used for?">
    **Answer:** It determines the project's URL inside Agent Studio. Treat it as a stable identifier — it's hard to change later.
  </Accordion>
</AccordionGroup>
