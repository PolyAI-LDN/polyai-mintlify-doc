...
<AccordionGroup>
  ...
  <Accordion title="Verify navigation access" icon="bars">
    ...
    **Deployments**
    ...
    - You may also see other areas (Numbers under Voice, Settings & admin, Real-time config, Analytics > Dashboards). You won't need to configure them for Level 1, but you may return to them later.
  </Accordion>
</AccordionGroup>
