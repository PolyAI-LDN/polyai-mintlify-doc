...
<Warning>
  Choose a clear name—poorly named projects cause confusion with environments and variants.
</Warning>
...
<Steps>
  ...
  <Step title="Configure your agent settings">
    Fill out the fields carefully (these settings are your starting point and affect all future testing):
...
<CardGroup cols={3}>
  ...
  <Card title="Center canvas" icon="window">
    Main workspace where you edit your agent's content and settings
  </Card>
