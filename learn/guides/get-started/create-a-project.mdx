...
<AccordionGroup>
  <Accordion title="Confirm agent identity" icon="circle-check">
    ...
    - The agent has not been published yet. Your changes save to your Branch as you go.
  </Accordion>
  ...
  <Accordion title="Verify navigation access" icon="bars">
    ...
    **Deployments**
    - Where you'll test and publish changes safely. You build and test in **Sandbox**, then publish to **Live**. Branches and Sub-branches modes add an optional **Staging** step.
...
<Quiz questions={[
  {
    ...
    correct: 2,
    explanation: "Including an environment name like 'Live' in the project name is a problem – the same project runs across Sandbox, Staging, and Live. A name tied to one environment becomes misleading in the others.",
  }
]} />
...
<Quiz questions={[
  {
    ...
    options: [
      ...
      "The ID will conflict with the environment name and block publishing",
    ],
    correct: 1,
...
<CardGroup cols={2}>
  ...
  <Card title="Quickstart" icon="rocket" href="/get-started/quickstart">
    The shortest path from account creation to a published agent
  </Card>
</CardGroup>
