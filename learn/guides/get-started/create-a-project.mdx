...
<Frame caption="The Agent Studio interface after project creation — Navigate, Build, and Configure your agent here.">
...
<Frame caption="Project setup is complete when all navigation areas load without errors.">
...
<CardGroup cols={2}>
  ...
  <Card title="Agent Studio UI" icon="window" href="/get-started/agent-studio-ui">
    Detailed walkthrough of the Agent Studio interface
  </Card>
</CardGroup>
