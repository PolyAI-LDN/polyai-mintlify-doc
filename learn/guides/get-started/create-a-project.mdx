...
<AccordionGroup>
  ...
  <Accordion title="Verify navigation access" icon="bars">
    ...
    **Build**
    - **Agent**: personality, role, and Behavior rules.
    ...
    **Channels**
    - Under the **Voice** subheader: **Agent voice** (voice/disclaimer selection) and **Voice configuration** (greeting, disclaimer text, and channel-specific settings).
...
<Check>
  **Success criteria:**
  ...
  - You can access (at minimum):
    - **Build > Agent** (personality, role, Behavior)
    - **Build > Knowledge**
    - **Build > Variant management**
    - **Channels > Voice > Agent voice**
