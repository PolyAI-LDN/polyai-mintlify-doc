...
description: "Select a voice, configure tuning, and set up your disclaimer."
icon: "microphone"
---
...
<Info>
  **Lesson 4 of 6** — Choose and tune your agent's [voice](/voice/introduction).
</Info>
...
<Quiz questions={[
  {
    q: "What are the two configurable voice sections on the Agent Voice page?",
    options: [
      "Greeting and Farewell",
      "Assistant and Disclaimer",
      "Primary and Backup",
      "Standard and Custom",
    ],
    correct: 1,
    explanation: "The Agent Voice page has two configurable sections: Assistant (the primary speaking voice) and Disclaimer (used for legal or informational disclosures).",
  }
]} />
