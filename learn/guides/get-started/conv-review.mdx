...
This page shows transcripts, basic system decisions, and supporting metadata so you can confirm whether the agent behaved as expected. At Level 1, the goal is not optimisation — it is **verification**.
