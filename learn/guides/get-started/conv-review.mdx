...
<Frame caption="Conversation Review shows the transcript with matched topics beneath each turn.">
...
<Quiz questions={[
  {
    q: "Where can you see which Managed Topic the agent used for each response?",
    options: [
      "In the transcript — matched topics appear beneath each turn",
      "In the left panel under Conversation details",
      "In the agent's Rules configuration",
      "In the Environments page version history",
    ],
    correct: 0,
    explanation: "The transcript shows matched topics beneath each turn, letting you verify which Managed Topic the agent selected for every response.",
  }
]} />
