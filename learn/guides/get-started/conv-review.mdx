...
<iframe
  src="https://tally.so/embed/GxL91Q?alignLeft=1&hideTitle=1&transparentBackground=1&dynamicHeight=1"
  width="100%"
  height="500"
  frameBorder="0"
  title="Knowledge check: Conversation review"
/>

<AccordionGroup>
  <Accordion title="Q1: What is your primary diagnostic signal at Level 1?">
    **Answer:** **Matched topics.** They tell you whether the agent selected the right Managed Topic for each response — which is the most important thing to verify at this stage.
  </Accordion>
  <Accordion title="Q2: The agent answers a billing question, but the matched topic is 'general_help'. What does this indicate?">
    **Answer:** A **Managed Topic design problem** — either the billing topic's name is too generic or its sample questions don't match how users actually ask billing questions. This is not a phrasing or ASR issue.
  </Accordion>
</AccordionGroup>
