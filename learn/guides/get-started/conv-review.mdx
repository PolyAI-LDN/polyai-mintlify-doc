---
title: "Tutorial: Conversation reviews"
sidebarTitle: "Conversation reviews"
description: "PolyAcademy Level 1 – Review transcripts, check topic citations, and diagnose agent behavior."
...
![Columns panel Visibility tab showing toggleable pre-built metric columns](/images/analytics/conv-review-columns-visibility.png)
...
![Filter builder showing environment, date, and duration conditions](/images/analytics/conv-review-filters.png)
...
![Conversation Review side panel open showing the Transcription tab and agent-caller transcript](/images/analytics/conv-review-side-panel.png)
...
<Quiz questions={[
  {
    ...
    options: [
      ...
      "In Live history on the Deployments page, which tracks topic usage",
    ],
    correct: 0,
...
<CardGroup cols={2}>
  <Card title="← Previous: Deployments" icon="arrow-left" href="/learn/guides/get-started/environments">
    Lesson 5 of 6
  </Card>
