...
For each turn, check:
- What the user said (automatic speech recognition / ASR text)
...
### Function calls
If your agent includes function-driven actions (such as SMS or handoff, covered in Level 2), use this section to confirm:
