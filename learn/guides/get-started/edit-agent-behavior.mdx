...
<Info>
  **Lesson 2 of 6** — Define how your agent speaks, what it's responsible for, and how it behaves.
</Info>

Now let's cover the **Agent** tab.

Agent behavior defines how the agent speaks, what it is responsible for, and how it behaves when things are unclear or go wrong. This work should be completed **before** adding any Managed Topics, so that all later content inherits a consistent posture.
...
## 1. About
        ...
        ![about-agent](/images/academy/agent.png)
...
If this baseline feels solid, you’re ready to start adding Managed Topics.
