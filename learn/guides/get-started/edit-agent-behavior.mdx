...
<Quiz questions={[
  {
    ...
    correct: 1,
    explanation: "Personality defines tone and style – 'warm and professional', 'friendly and concise', and so on. Hard constraints like 'Never discuss pricing' belong in Rules. Topics and knowledge go in the Knowledge section.",
  }
]} />
...
<Quiz questions={[
  {
    ...
    correct: 2,
    explanation: "Rules are hard constraints, not suggestions. 'Try to avoid' gives the model permission to make exceptions. Rewrite as 'Never share guest personal information' – the model treats 'Never' and 'Always' as non-negotiable.",
  }
]} />
...
<CardGroup cols={3}>
  ...
  <Card title="Agent behavior" icon="user-tie" href="/agent-settings/agent">
    Detailed guide for the Agent page – greeting, personality, and role
  </Card>
  <Card title="Rules reference" icon="shield-halved" href="/agent-settings/rules">
    Full reference for writing and scoping rules
  </Card>
</CardGroup>
