...
<iframe
  src="https://tally.so/embed/81Gaek?alignLeft=1&hideTitle=1&transparentBackground=1&dynamicHeight=1"
  width="100%"
  height="500"
  frameBorder="0"
  title="Knowledge check: Edit agent behavior"
/>

<AccordionGroup>
  <Accordion title="Q1: How should Rules be written?">
    **Answer:** As hard constraints, not suggestions. Use "Never" and "Always" — not "Try to" or "Consider".
  </Accordion>
  <Accordion title="Q2: If a start function returns an utterance, what does it override?">
    **Answer:** The **Greeting** field. Changes to the greeting text box won't affect what callers hear if a start function is returning its own utterance.
  </Accordion>
</AccordionGroup>
