...
<Frame caption="A simple Managed Topic completes in one turn with no actions or follow-ups.">
...
<Frame caption="Topic citations in the Chat panel confirm which Managed Topic the agent selected.">
...
<Frame caption="In Conversation Review, topic citations appear under each turn to show what triggered the response.">
...
<CardGroup cols={2}>
  <Card title="Managed Topics" icon="book-open" href="/managed-topics/introduction">
    Complete reference for creating and managing knowledge base topics
  </Card>
