...
The topic name is the main clue the agent uses to find the right answer.
...
Sample questions help the agent learn the different ways people ask this question.
