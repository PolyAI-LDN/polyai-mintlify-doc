...
A [Managed Topic](/knowledge/faqs/introduction) is how your agent learns to answer questions. In this lesson, you'll create the simplest kind: one question, one answer, no follow-ups.
...
Want the full reference for FAQs? These pages cover everything – including the more complex topics you'll learn in Level 2:

<CardGroup cols={2}>
  <Card title="FAQs" icon="book-open" href="/knowledge/faqs/introduction">
