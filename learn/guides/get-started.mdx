...
- Lives safely in versioned environments (build and test in Sandbox, publish to Live)
...
<CardGroup cols={2}>
  ...
  <Card title="5. Deployments" icon="code-branch" href="/learn/guides/get-started/environments">
    Test changes safely in Sandbox, then publish to Live
  </Card>
...
<Check>
  **You've completed Level 1 when:**
  ...
  - <Icon icon="check" iconType="solid" color="#16a34a" /> You've published a change from Sandbox to Live
