...
<Note>
  This lesson assumes familiarity with Python, [functions](/learn/guides/advanced/using-functions), and [flows](/learn/guides/expert/flow-fundamentals). If those concepts are new, complete the earlier lessons first.
</Note>
