...
description: "Techniques for making voice agents sound natural, smooth, and enjoyable."
...
Once the agent works and is easy to use, the final layer is polish. This lesson covers voice quality, natural filler, turn-taking, and personalisation — the techniques that make voice interactions feel smooth and human.
...
<Steps>
  ...
  <Step title="It's easy to use">
    The interaction is efficient, intuitive, and follows the [design checklist](/learn/guides/design-checklist).
  </Step>
  <Step title="It sounds good">
    Copywriting, voice quality, turn-taking, and personalisation make the experience enjoyable. This is the focus of this lesson.
  </Step>
</Steps>
...
<ProgressTracker lessonKey="l3-3-voice-polish" lessonNum={3} totalLessons={3} level="Level 3" />
