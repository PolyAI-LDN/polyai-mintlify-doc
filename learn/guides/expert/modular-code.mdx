---
title: "Modular code"
description: "Organise functions, imports, and utility code in Agent Studio projects."
icon: "cubes"
---
...
<Info>
  **Level 3 — Lesson 1 of 3** — Structure your Agent Studio code for maintainability and reuse.
</Info>

As projects grow, code organisation becomes critical. This lesson covers how Agent Studio's file system works, how to import functions between files, and when to use each import method.
...
<ProgressTracker lessonKey="l3-1-modular-code" lessonNum={1} totalLessons={3} level="Level 3" />
