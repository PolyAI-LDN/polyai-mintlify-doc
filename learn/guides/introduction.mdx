...
<AccordionGroup>
  <Accordion title="Level 1: Your first working agent" icon="circle-1">
    By the end, you'll have a real agent that answers questions, speaks with a configured voice, and is safely versioned and published to Live.
  ...
  <Accordion title="Level 2: Advanced capabilities" icon="circle-2">
