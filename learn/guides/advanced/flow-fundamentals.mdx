...
<Info>
  **Level 2 — Lesson 7 of 8** — Understand flows, steps, and transitions for structured multi-turn interactions.
</Info>
...
<ProgressTracker lessonKey="l2-7-flow-fundamentals" lessonNum={7} totalLessons={8} level="Level 2" />
