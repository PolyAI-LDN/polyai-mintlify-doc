---
title: "Tutorial: Global ASR"
sidebarTitle: "Global ASR"
description: "PolyAcademy Level 2 – Improve speech recognition accuracy with keyphrase boosting and transcript corrections."
icon: "ear-listen"
noindex: true
---
  ...
  <Tab title="Transcript Corrections">
    ...
    <Warning>
      **Important guidance:**
      ...
      - If unsure, test in Sandbox over an in-app call with real speech before publishing
...
<Steps>
  ...
  <Step title="Publish carefully">
    Only publish after confirming improvement
  </Step>
</Steps>
...
<Check>
  ...
  - Behavior remains consistent after publishing to Live
