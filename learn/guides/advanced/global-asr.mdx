...
[Automatic Speech Recognition (ASR)](/speech-recognition/introduction) determines what the agent *hears*. Every downstream system depends on this layer: Knowledge retrieval, routing, response control, and handoff logic. Small transcription errors here can silently break otherwise well-designed agents.
