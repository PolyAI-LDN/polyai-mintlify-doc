...
{/* VIDEO PLACEHOLDER — record a 2–5 min walkthrough of Global ASR configuration and replace VIDEO_ID below */}
<iframe
  width="100%"
  height="400"
  src="https://www.youtube.com/embed/VIDEO_ID"
  title="Global ASR walkthrough"
  frameBorder="0"
  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
  allowFullScreen
/>

Automatic Speech Recognition (ASR) determines what the agent *hears*. Every downstream system depends on this layer: Knowledge retrieval, routing, response control, and handoff logic. Small transcription errors here can silently break otherwise well-designed agents.
...
flowchart TD
    ...
    B -->|Word is correct but under-recognised| C[Keyphrase Boosting]
...
<iframe
  src="https://tally.so/embed/7RoLWz?alignLeft=1&hideTitle=1&transparentBackground=1&dynamicHeight=1"
  width="100%"
  height="500"
  frameBorder="0"
  title="Knowledge check: Global ASR"
/>

<AccordionGroup>
  <Accordion title="Q1: When should you use Transcript Corrections instead of Keyphrase Boosting?">
    **Answer:** When ASR **consistently mishears one specific thing as another** — for example, "refund" → "reef fund". Keyphrase Boosting is for words that are correct but under-recognised; Transcript Corrections rewrite after transcription.
  </Accordion>
  <Accordion title="Q2: What is the main risk of over-biasing many keyphrases?">
    **Answer:** Bias strength is **cumulative** — boosting too many terms can degrade overall ASR accuracy. Always start with Default bias and increase only if errors persist.
  </Accordion>
</AccordionGroup>

---

<ProgressTracker lessonKey="l2-4-global-asr" lessonNum={4} totalLessons={6} level="Level 2" />
