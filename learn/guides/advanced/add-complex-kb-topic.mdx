---
title: "Tutorial: Add complex topics"
sidebarTitle: "Add complex topics"
description: "PolyAcademy Level 2 – Build multi-turn FAQs with SMS, handoffs, and conditional logic."
...
<Info>
  **Level 2 – Lesson 1 of 8** – Build multi-turn flows with [SMS](/knowledge/faqs/actions/send-sms), [handoffs](/knowledge/faqs/actions/handoff), and conditional logic.
</Info>
...
<Note>
  **Reading the action notation in this lesson:**
  This lesson references functions like `start_sms_flow` and `transfer_call`. You'll learn how to create and wire these in [Lesson 2: Using tools](/learn/guides/advanced/using-tools) and [Lesson 3: Return values](/learn/guides/advanced/tool-return-values).
...
Some [FAQs](/knowledge/faqs/introduction) need to guide a decision, send a text, or route the conversation. This lesson covers reliable patterns for topics that retrieve correctly, behave in Chat and Call, and recover from unexpected responses.
...
- It reduces collisions with any other billing topics you may add as your FAQs grow.
...
<Quiz questions={[
  {
    ...
    options: [
      ...
      "The topic triggered but the Actions section is empty – no SMS action was configured",
      "Response Controls are blocking the SMS offer",
    ],
    correct: 1,
    explanation: "If the complex topic never triggers, the agent falls back to simpler matches. Fix retrieval first: check the topic name is specific (e.g., 'send_bill_sms'), add sample questions like 'can you send me my bill' and 'email me my invoice', then re-test before debugging actions.",
  }
]} />
...
- Prefer clarity over complex branching
...
<CardGroup cols={2}>
  ...
  <Card title="Next: Using tools →" icon="arrow-right" href="/learn/guides/advanced/using-tools">
    Lesson 2 of 8
  </Card>
</CardGroup>
