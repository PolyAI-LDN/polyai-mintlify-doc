...
<Info>
  **Level 2 – Lesson 1 of 8.** By the end of Level 2, your agent will handle multi-turn conversations with [SMS](/managed-topics/how-to-setup-action/send-sms), [handoffs](/managed-topics/how-to-setup-action/handoff), conditional logic, and Python functions connected to external systems.
</Info>
