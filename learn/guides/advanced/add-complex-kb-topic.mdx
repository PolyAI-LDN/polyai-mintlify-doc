...
<Info>
  **Level 2 — Lesson 1 of 6** — Build multi-turn flows with [SMS](/managed-topics/how-to-setup-action/send-sms), [handoffs](/managed-topics/how-to-setup-action/handoff), and conditional logic.
</Info>

Not all [Managed Topics](/managed-topics/introduction) are simple question-and-answer entries. Some need to guide the user through a decision, send information by text, or route the conversation to the right place when the request isn't clear.
