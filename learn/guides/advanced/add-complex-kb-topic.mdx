...
If a topic doesn’t retrieve reliably, nothing else matters. Finding the right topic depends on three things, in this order:

1. Topic name
2. Sample questions
3. Content

Most early problems happen because the agent can't find the right topic.
...
- It matches how the agent categorizes the request.
- It avoids confusion with similar billing topics you may add as your Managed Topics grow.
...
Think of sample questions as examples that teach the agent what to listen for.
