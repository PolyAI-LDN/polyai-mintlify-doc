...
{/* VIDEO PLACEHOLDER — record a 2–5 min walkthrough of creating a complex topic and replace VIDEO_ID below */}
<iframe
  width="100%"
  height="400"
  src="https://www.youtube.com/embed/VIDEO_ID"
  title="Add complex topics walkthrough"
  frameBorder="0"
  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
  allowFullScreen
/>

Not all Managed Topics are simple question-and-answer entries. Some need to guide the user through a decision, send information by text, or route the conversation to the right place when the request isn't clear.
...
Complex topics work best when you make some decisions and plan.
...
<iframe
  src="https://tally.so/embed/81Gako?alignLeft=1&hideTitle=1&transparentBackground=1&dynamicHeight=1"
  width="100%"
  height="500"
  frameBorder="0"
  title="Knowledge check: Complex Managed Topics"
/>

<AccordionGroup>
  <Accordion title="Q1: What is the most important step when building a complex topic?">
    **Answer:** **Making retrieval work reliably.** If a topic doesn't trigger correctly, nothing else matters — the best content in the world is useless if it's never reached.
  </Accordion>
  <Accordion title="Q2: Which pattern should you use when the agent can answer but escalation may still be useful?">
    **Answer:** **Pattern 4: Answer, then offer handoff.** The agent provides the information first, then offers a transfer — rather than transferring immediately or withholding the answer.
  </Accordion>
</AccordionGroup>

---

<ProgressTracker lessonKey="l2-1-complex-topics" lessonNum={1} totalLessons={6} level="Level 2" />
