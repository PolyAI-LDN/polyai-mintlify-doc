...
[Variants](/variant-management/introduction) let you maintain **one agent** while tailoring its responses for specific contexts—without creating separate projects or forking your build work. Think of a variant as a **named configuration profile** that can change selected content or settings depending on where or how the agent is being used.
