...
<Quiz questions={[
  {
    ...
    correct: 2,
    explanation: "A variant is a named configuration profile — same core agent, different values for specific fields. This avoids project sprawl when you need context-specific behaviour.",
  },
  {
