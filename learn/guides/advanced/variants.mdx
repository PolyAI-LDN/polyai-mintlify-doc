...
{/* VIDEO PLACEHOLDER — record a 2–5 min walkthrough of Variant management and replace VIDEO_ID below */}
<iframe
  width="100%"
  height="400"
  src="https://www.youtube.com/embed/VIDEO_ID"
  title="Variants walkthrough"
  frameBorder="0"
...
<iframe
  src="https://tally.so/embed/oboeyM?alignLeft=1&hideTitle=1&transparentBackground=1&dynamicHeight=1"
  width="100%"
  height="500"
  frameBorder="0"
  title="Knowledge check: Variants"
/>

<AccordionGroup>
  <Accordion title="Q1: What are variants for?">
    **Answer:** Tailoring agent responses for **different contexts without creating separate projects**. A variant is a named configuration profile — same core agent, different values for specific fields.
  </Accordion>
  <Accordion title="Q2: Which type of content is best suited for variants?">
    **Answer:** **Location-specific facts** like hours, addresses, and escalation language — content that is frequently repeated, specific to context, and risky if wrong. Safety policies and core tone should NOT vary.
  </Accordion>
</AccordionGroup>

---

<ProgressTracker lessonKey="l2-5-variants" lessonNum={5} totalLessons={6} level="Level 2" />
