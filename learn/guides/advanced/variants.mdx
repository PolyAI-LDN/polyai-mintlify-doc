...
description: "PolyAcademy Level 2 – Use variants to manage site-specific, brand-specific, or channel-specific content."
icon: "code-compare"
noindex: true
---
...
<Tabs>
  ...
  <Tab title="What variants are NOT">
    <Warning>
      ...
      - **Not environments** - Sandbox/Staging/Live are about publishing changes safely; variants are about contextual behavior
