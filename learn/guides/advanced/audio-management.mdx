...
<AccordionGroup>
  <Accordion title="Q1: When is audio cached?">
    **Answer:** When the **same utterance is generated at least twice within a 24-hour window**. One-off utterances don't persist in cache by default.
  </Accordion>
  <Accordion title="Q2: Which interaction style has the lowest latency?">
    **Answer:** **Turbo** (~400ms). It is the fastest but carries the highest interruption risk — it should only be used with careful phrasing and latency tuning.
  </Accordion>
</AccordionGroup>
