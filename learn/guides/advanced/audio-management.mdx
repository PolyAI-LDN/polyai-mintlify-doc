...
description: "Manage cached audio, interaction styles, and pronunciation corrections."
...
Pronunciations are defined in the **Pronunciations** tab under **Channels > Voice > [Response Control](/response-control/pronunciations)** and applied globally. They modify how text is converted to speech, without changing the underlying text.
