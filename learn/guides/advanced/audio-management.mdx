...
Pronunciations are defined in the **Pronunciations** tab under **Channels > Voice > [Response Control](/voice-channel/advanced/pronunciations)** and applied globally. They modify how text is converted to speech, without changing the underlying text.
