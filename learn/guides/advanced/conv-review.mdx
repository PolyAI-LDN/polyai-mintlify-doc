...
<iframe
  src="https://tally.so/embed/2ELaeA?alignLeft=1&hideTitle=1&transparentBackground=1&dynamicHeight=1"
  width="100%"
  height="500"
  frameBorder="0"
  title="Knowledge check: Advanced conversation review"
/>

<AccordionGroup>
  <Accordion title="Q1: At Level 2, the transcript is considered...">
    **Answer:** Only a **symptom** of deeper issues. The real diagnostic work happens in diagnosis layers, function traces, variant attribution, and latency signals — not by reading the transcript alone.
  </Accordion>
  <Accordion title="Q2: The agent asks for SMS consent but never calls start_sms_flow. What are the most likely causes?">
    **Answer:** Three likely causes: (1) a **missing action branch** in the KB topic, (2) a **Response Control** is interrupting output before the function fires, or (3) a **rules conflict** is preventing the action from executing.
  </Accordion>
</AccordionGroup>
