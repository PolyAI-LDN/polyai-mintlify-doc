...
At Level 2, Conversation Review stops being a sanity check and becomes a **diagnostic instrument**.

You are no longer asking *“Did the agent basically work?”*
You are asking *“Why did the agent behave this way, and how do I shape it deliberately?”*

This page is where you learn to **trace behaviour back to configuration**, distinguish between upstream and downstream causes, and make changes with intent rather than guesswork.

## What Conversation Review is for (Level 2)

At this stage, use Conversation Review to answer questions like:

> Why did the agent choose *this* KB topic instead of a near-duplicate?
>
