...
{/* VIDEO PLACEHOLDER — record a 2–5 min walkthrough of advanced conversation diagnostics and replace VIDEO_ID below */}
<iframe
  width="100%"
  height="400"
  src="https://www.youtube.com/embed/VIDEO_ID"
  title="Advanced conversation review walkthrough"
  frameBorder="0"
...
<ProgressTracker lessonKey="l2-6-conv-review" lessonNum={6} totalLessons={6} level="Level 2" />
