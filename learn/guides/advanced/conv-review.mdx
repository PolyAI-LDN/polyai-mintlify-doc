---
title: "Tutorial: Conversation reviews (advanced)"
sidebarTitle: "Conversation reviews (advanced)"
description: "PolyAcademy Level 2 – Use advanced diagnostics to trace behavior to its source and identify system-level improvements."
icon: "stethoscope"
noindex: true
---
...
- Spot regressions after publishing
...
![Columns Visibility panel showing toggleable pre-built metric columns for the conversations table](/images/analytics/conv-review-columns-visibility.png)
...
![Filter builder panel with multiple active conditions](/images/analytics/conv-review-filters.png)

![Active filter chips above the conversations table summarising applied conditions](/images/analytics/conv-review-filter-chips.png)
