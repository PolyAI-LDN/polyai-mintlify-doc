...
<Info>
  **Level 2 — Lesson 8 of 8** — Learn common flow patterns for collecting, validating, and acting on user input.
</Info>
...
<ProgressTracker lessonKey="l2-8-flow-patterns" lessonNum={8} totalLessons={8} level="Level 2" />
