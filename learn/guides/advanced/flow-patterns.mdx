...
<Info>
  **Level 2 — Lesson 10 of 10** — Learn common flow patterns for collecting, validating, and acting on user input.
</Info>
...
<ProgressTracker lessonKey="l2-8-flow-patterns" lessonNum={10} totalLessons={10} level="Level 2" />
