...
[Response Controls](/response-control/introduction) regulate the agent's *own output*. They run **after** the model generates text and before anything is spoken or sent to the user.
