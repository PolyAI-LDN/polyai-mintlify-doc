...
[Response Controls](/response-control/introduction) regulate the agent's *own output*. They run **after** the model generates text and **before** anything is spoken or sent. Powerful for tone, safety, and flow — easy to misuse if patterns are too broad.
...
<CardGroup cols={2}>
  <Card title="← Previous: Return values" icon="arrow-left" href="/learn/guides/advanced/function-return-values">
    Lesson 3 of 8
  </Card>
