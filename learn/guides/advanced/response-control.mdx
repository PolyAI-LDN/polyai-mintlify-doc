...
{/* VIDEO PLACEHOLDER — record a 2–5 min walkthrough of configuring Response Controls and replace VIDEO_ID below */}
<iframe
  width="100%"
  height="400"
  src="https://www.youtube.com/embed/VIDEO_ID"
  title="Response controls walkthrough"
  frameBorder="0"
...
```mermaid
flowchart TD
    A[Unwanted agent behaviour] --> B{What type of problem?}
...
<iframe
  src="https://tally.so/embed/pbGyLE?alignLeft=1&hideTitle=1&transparentBackground=1&dynamicHeight=1"
  width="100%"
  height="500"
  frameBorder="0"
  title="Knowledge check: Response Controls"
/>

<AccordionGroup>
  <Accordion title="Q1: What do Response Controls regulate?">
    **Answer:** **What the agent says** — its own generated output. They run after the LLM generates a response, before it's spoken or sent to the user. They don't affect what the user says or how ASR works.
  </Accordion>
  <Accordion title="Q2: If a phrase should never appear in any response, what should you do?">
    **Answer:** **Halt it** by setting "Say phrases" to TRUE. Logging (FALSE) lets the phrase through while tracking it — use that for monitoring, not for phrases that should never appear.
  </Accordion>
</AccordionGroup>

---

<ProgressTracker lessonKey="l2-2-response-control" lessonNum={2} totalLessons={6} level="Level 2" />
