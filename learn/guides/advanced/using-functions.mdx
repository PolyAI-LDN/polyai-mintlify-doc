...
<Info>
  This lesson explains what [functions](/tools/introduction) are, why they exist, and how the LLM uses them. By the end you will understand the full request-response loop and be able to create and reference a function correctly.
</Info>
