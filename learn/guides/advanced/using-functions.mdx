---
title: "Tutorial: Using functions"
sidebarTitle: "Using functions"
description: "PolyAcademy Level 2 — How the LLM calls Python functions to integrate with external systems."
icon: "code"
noindex: true
---
...
<FillBlank
  prompt='To make a function visible to the LLM, you reference it in a topic, flow, or Rules field using the syntax: @________'
  answer={["function_name", "@function_name"]}
  hint="What prefix makes a function reference?"
  explanation='Use @function_name in Rules, a topic action, or a flow step. Agent Studio highlights it and registers the function in the LLM request.'
/>
...
<CardGroup cols={2}>
  ...
  <Card title="Next: Return values →" icon="arrow-right" href="/learn/guides/advanced/function-return-values">
    Lesson 3 of 8
  </Card>
</CardGroup>
