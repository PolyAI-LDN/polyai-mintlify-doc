...
<Info>
The Translations page is only visible for [multilingual projects](/agent-settings/multilingual) with additional languages configured. Translations apply agent-wide – to both **voice** and **chat** channels.
</Info>
