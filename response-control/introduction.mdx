...
The **Response Controls** tab lets you regulate agent outputs by defining keywords and phrases to block or monitor. These controls ensure appropriate and on-brand interactions while preserving user experience.
