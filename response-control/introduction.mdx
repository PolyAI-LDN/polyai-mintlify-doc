...
```python
@func_description("Returns a standard response when a restricted phrase is detected")
    ...
    **After:** "Here are your cancellation options."
    ...
    <Steps>
      ...
      <Step title="Optional: redirect to a function">
        ...
        ```python
        @func_description("Replaces blocked preamble text with a clean response")
