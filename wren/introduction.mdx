...
If you're starting from nothing, the **Agent wizard** bootstraps a brand-new agent from a single company URL — it reads the site, creates topics, sets up behavior, and gives you a working draft in minutes.
