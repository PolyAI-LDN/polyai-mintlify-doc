...
- **Full screen** — the Wren home screen, with [prompt suggestions](#a-full-session-step-by-step) grouped by **Build**, **Test**, **Ask**, and **Analyze**. Best for starting a build session.
