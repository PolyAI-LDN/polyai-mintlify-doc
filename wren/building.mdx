...
None of this touches Live. See [Branches](/wren/introduction#branches).

## Real-time configuration

Wren can read your [real-time config](/real-time-config/introduction) schema and values, and edit both.

Because real-time config takes effect immediately, **writes to Live always ask first**. Wren shows you exactly what it intends to change and waits for your confirmation. Sandbox and Staging edits follow the normal plan-and-approve flow.
