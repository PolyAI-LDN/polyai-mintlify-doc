...
<CardGroup cols={2}>
  ...
  <Card title="Test" icon="flask">
    Run conversations and validation against the current Branch.
  </Card>
...
- *Run the existing simulation tests against the current Branch and summarize any regressions.*
...
- **Edit anything other than your Branch.** It never publishes to Live, moves a Branch to [Staging](/environments-and-versions/environments#staging), or merges anything. You review and publish the Branch yourself.
...
Every change Wren makes appears on your Branch just like a manual edit. Inspect it, tweak it, or revert it before you publish.
