...
Visual overview of agent performance – call volume, containment, safety, and business-specific metrics.
...
| **[Custom](./custom)** | Business-specific metrics (enterprise) | Any metric tailored to your use case – booking conversions, revenue impact, custom function metrics. Built with your PolyAI account team. |
...
<CardGroup cols={3}>
  ...
  <Card title="Custom" icon="chart-pie" href="./custom">
    Enterprise dashboards tailored to your specific metrics and business outcomes.
  </Card>
</CardGroup>
