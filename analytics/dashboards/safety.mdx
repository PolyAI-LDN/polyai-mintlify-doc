...
- **Low**: More content is allowed to pass to the AI model.
- **Medium**: Medium amount of content is allowed to pass to the AI model.
- **High**: Strict rules on what content can pass to the AI model.

Content detected at **low, medium, and high severity levels** is subject to filtering, with the degree of action taken varying based on the severity.
