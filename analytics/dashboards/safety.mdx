...
PolyAI content filters are designed to catch harmful input from users and prevent inappropriate output from your agent. Filters combine PolyAI's models with third-party services like [Azure OpenAI](https://learn.microsoft.com/en-us/azure/ai-services/content-safety/) to keep conversations safe.
