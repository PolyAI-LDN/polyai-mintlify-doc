...
PolyAI content filters are designed to catch harmful input from users and prevent inappropriate output from your assistant. Filters combine PolyAI’s models with third-party services like [Azure OpenAI](https://learn.microsoft.com/en-us/azure/ai-services/openai/concepts/safety) to keep conversations safe.
...
- **Standardise features**: If you're using filters in templates or shared projects, try to use the same flows and function names across them.

For more technical background on Microsoft’s content filtering service, see [Azure OpenAI safety documentation](https://learn.microsoft.com/en-us/azure/ai-services/openai/concepts/safety).
