...
Safety filters are configured project-wide in **Configure > General** and overridden per channel in **Channels > Voice** and **Channels > Chat**. See [Safety filters](/behavior/guardrails/safety-filters) for the full reference – categories, severity levels, language support, and how filters fit with [Guardrails](/behavior/guardrails/introduction).
