...
Track call volumes, containment rates, and performance metrics.
...
### Key metrics
- **Containment rate**: The percentage of calls handled entirely by the agent without requiring a human handoff.
- **Total calls**: The number of calls processed within the selected date range.
- **Total automated minutes**: The total duration of calls handled by the agent.
