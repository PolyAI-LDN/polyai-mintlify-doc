...
### SMS sent vs failed
Shows the number of [SMS](/voice-channel/message-templates) messages successfully sent compared to failed delivery attempts.
...
<CardGroup cols={3}>
  ...
  <Card title="Metrics" icon="sliders" href="/analytics/kpis/introduction">
    Define custom metrics that flow into dashboards and Wren.
  </Card>
</CardGroup>