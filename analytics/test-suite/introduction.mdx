...
- Modify test case parameters to simulate new inputs
...
Test cases store the functions triggered in the original interaction. You can optionally adjust these—such as altering parameter values—to simulate new versions of the same conversation.
