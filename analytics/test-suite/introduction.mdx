...
Save conversations as **Test Cases** and group them into **Test Sets** (**Build > Test suite**). Run against Draft or Sandbox to validate agent behavior before promotion.
