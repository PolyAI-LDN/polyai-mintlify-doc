...
| **Task success** | Did the conversation deliver on its objective, so the user won't need to make contact again for the same reason? | Good (Completed) / Fair (Handoff) / Poor (Not completed) |
