...
description: "PolyScore is an automated 1-5 conversation quality score for voice, messaging, and email, combining agent quality and task success on every eligible call."
keywords:
  - PolyScore
  - quality score
