...
**PolyScore** is the automated quality score assigned to every eligible conversation with your agent — a **1–5 rating** backed by a transparent evaluation rubric that works across voice, messaging, and email, for both inbound and outbound conversations.
