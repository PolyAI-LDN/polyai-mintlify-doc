...
**Top-box scoring (client-side)**
Some organizations apply a percentage-based calculation to their exported CSAT data. This is not calculated by PolyAI — you would apply it to your own data exports:
- CSAT Score = (Satisfied - Dissatisfied) / Total responses
...
<Note>
Have specific CSAT requirements or want to learn about upcoming features? Contact your PolyAI representative.
</Note>
