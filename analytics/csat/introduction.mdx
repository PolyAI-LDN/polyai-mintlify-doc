---
title: 'CSAT surveys'
description: 'Measure customer satisfaction with in-call voice CSAT surveys and webchat CSAT surveys.'
keywords:
  - CSAT
...
![goodbye_and_hang_up function definition in Tools](/images/analytics/csat.png)
...
<ParamField path="Survey title" type="string">
...
- **Test thoroughly** - Try different phrasings in Sandbox before publishing
