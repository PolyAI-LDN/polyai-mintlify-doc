...
PolyAI is actively expanding CSAT capabilities:

### Voice CSAT enhancements (Q1 2026)

- **One-click CSAT configuration** - Configure and launch CSAT surveys directly in Agent Studio without code
- **Enhanced analytics** - Improved dashboards and reporting for voice CSAT data
- **Supervisor Suite integration** - CSAT metrics integrated into supervisor tools

### Webchat CSAT (Q2 2026)

SMS and in-chat CSAT surveys for webchat channels, with potential to accelerate delivery based on demand.

### SMS/RCS configuration UI

User interface in Agent Studio for configuring SMS CSAT surveys without editing JSON configuration files.

<Note>
Roadmap timelines are subject to change. Contact your PolyAI representative for the latest feature availability.
</Note>
