...
Copy the function call `conv.goto_csat_flow()` shown on the page and paste it into your existing hang-up function in **Build > Tools**. This instructs the agent to route callers into the survey flow before ending the call.
