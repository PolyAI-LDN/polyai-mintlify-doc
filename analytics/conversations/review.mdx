...
- **Conversation turns**: Displays agent and human dialogue in chronological order.
- **Topic mapping**:
  - For human responses: Displays matched topics in the knowledge base.
  - For agent responses: Shows the cited knowledge base topics.
- **Call audio**: Replay and analyze the interaction between the customer and the agent.
