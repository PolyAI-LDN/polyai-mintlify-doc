...
<Note>
**Looking for workflows?** See [QA and analytics](/learn/maintain/qa-analytics) for quick review workflows. For transcript export and data access, see [Call Data](/call-data/introduction).
</Note>
...
- **Conversation turns**: Shows agent and user utterances in chronological order. Live calls update automatically as new turns arrive. Each turn may display matched [knowledge base](/managed-topics/introduction) topics where relevant.
