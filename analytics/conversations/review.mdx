...
- **Browse and filter**: Navigate and filter through past or live conversations using metadata, time filters, duration, tags, flows, or call activity such as functions invoked and SMS messages sent.
