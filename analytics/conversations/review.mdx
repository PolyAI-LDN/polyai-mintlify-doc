...
- **Select rows** to create a [test case](/simulation-testing/introduction) batch from the toolbar.
...
| **Custom metrics** | Searchable, sortable list of any [custom metrics](/analytics/kpis/introduction) configured for the project |
...
- **Sources**: When the agent retrieves content from [Connected Knowledge](/knowledge/sources/introduction) sources, a **Sources** tag appears beneath the turn. Click a source name to open an inline preview panel showing the retrieved content. Enable this layer from the **Diagnosis** dropdown.
...
When the agent matches [Knowledge](/knowledge/faqs/introduction) topics or retrieves content from [Connected Knowledge](/knowledge/sources/introduction) sources, both surfaces appear under the relevant turn:
