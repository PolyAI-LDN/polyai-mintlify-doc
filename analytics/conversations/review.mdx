...
- **Production** — conversations from the Live environment only
- **Test** — Sandbox, Draft and Staging conversations
...
Use the Live conversations panel during launches, A/B rollouts, or incident response to watch live traffic without leaving the Conversations workspace. The panel respects the active scope and filter chips, so a Test-scope view shows only Sandbox, Draft and Staging traffic in progress.
...
![Conversation review display settings](/images/analytics/review-display-settings.png)
...
- **Environment and metadata**: Includes information such as [variant name](/knowledge/variants/introduction), timezone, timestamp, [environment](/environments-and-versions/introduction) (Live, Staging, Sandbox or Draft), and version ID.
...
Each scope opens on the **Production** System View. If you are working in Sandbox or haven't yet published to Live, switch to the **Test** System View, or create a Custom View with your preferred filters and set it as your default.
