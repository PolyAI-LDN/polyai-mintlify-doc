...
- **Custom metrics** — filter by any [custom metric](/settings/metrics) recorded on the conversation. String metrics support *equals*, *not equals*, *contains*, and *not contains*; numeric metrics support *equals*, *less than*, *greater than*, and range comparisons.
