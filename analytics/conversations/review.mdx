...
- **Conversation turns**: Shows agent and user utterances in chronological order. Each turn may display matched [knowledge base](/knowledge-base/introduction) topics where relevant.
- **Caller identity**: Displays the user email address if available (for [web chat](/get-started/agent-chat)), or phone number if applicable.
...
- **Diagnosis panel**: Toggle to view any system-level debugging tools.
