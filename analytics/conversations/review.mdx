...
Live conversations follow the same PII rules as completed ones – users without [PII-level access](/tools/classes/conv-log#pii) see contact details and transcripts redacted in real time.
