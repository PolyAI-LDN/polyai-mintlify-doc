...
[PLACEHOLDER - Conversations page in Open platform mode: Voice scope selected, list of PolyPhone calls with timestamps, durations, and PolyScore values, filter bar above with environment and date filters]
