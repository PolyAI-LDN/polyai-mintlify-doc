...
<div className="simplified-only">
<Note>
Every PolyPhone call your agent handles is captured here as a transcript and recording. [Smart Analyst](/smart-analyst/introduction) is built into the [Studio Assistant](/studio-assistant/introduction) home as a chat panel, and [PolyScore](/analytics/polyscore) shows on the standard dashboard.
</Note>
</div>
