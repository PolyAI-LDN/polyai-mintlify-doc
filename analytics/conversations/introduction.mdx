...
<div className="simplified-only">
<Note>
**On Agent Builder**, Conversations covers **Voice** only. Every PolyPhone call is captured here as a transcript and recording. Webchat is enterprise. Smart Analyst is built into the [Studio Assistant](/studio-assistant/introduction) home as a chat panel rather than a standalone tab; the [PolyScore](/analytics/polyscore) overview ships on the standard dashboard, with the full PolyScore breakdown view reserved for enterprise.
</Note>
</div>
