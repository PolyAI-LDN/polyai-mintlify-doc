...
description: "Inspect individual voice and messaging conversations to debug agent behavior, audit call quality, and review transcripts, function calls, and latency."
mode: wide
keywords:
  - conversations
  - calls
