...
<Tip>
**Iterate from a conversation with [Agent Builder](/studio-assistant/introduction).** After reading a transcript, ask Agent Builder to fix what broke — *"the agent kept asking for the date even after the caller said 'tomorrow'; fix relative-date extraction in the booking flow"*. See [Iterate after a call](/learn/iterate-open-platform).
</Tip>
