...
<Note>
**On the Open platform**, Conversations covers **Voice** only — every PolyPhone call is captured here as a transcript and recording. Web chat conversations, [Smart Analyst](/smart-analyst/introduction), and the full [PolyScore](/analytics/polyscore) breakdown are enterprise-only. PolyScore still shows on the standard dashboard.
</Note>
</div>
