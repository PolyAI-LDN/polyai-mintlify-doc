...
- **Wrong transcription** — the ASR (automatic speech recognition) produced an incorrect transcript. Use this when the agent misheard the caller. Feeds back into ASR tuning and [keyphrase boosting](/speech-recognition/introduction).
- **Missing topic** — the caller asked something the agent could not answer because no matching topic exists in the [Knowledge](/managed-topics/introduction) area. Feeds the prioritization of new topics.
...
- **Missing topic** annotations directly prioritize your [Knowledge](/managed-topics/introduction) backlog.
...
- **Act on annotations** — Use them as input when updating your Knowledge area, [ASR keyphrase boosting](/speech-recognition/introduction), [transcript corrections](/speech-recognition/introduction), or agent behavior configuration.
