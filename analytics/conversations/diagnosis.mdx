...
Displays live variable values captured during the call (e.g., booking IDs, customer names, flags), with diff markers when a variable changes turn-to-turn.
...
![conversations-tool](/images/analytics/conversations-tool-call.png)
