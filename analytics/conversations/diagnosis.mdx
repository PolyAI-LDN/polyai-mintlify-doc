...
| **Tool calls** | Time spent executing tools (Python functions), including API calls and data processing |
| **Total response time** | Combined time from user speech end to agent response start |

Use these breakdowns to:
- Identify slow tool calls that need optimization
...
<Tip>
High LLM latency may indicate complex prompts that could be simplified. High tool call latency often points to slow external API dependencies.
</Tip>
