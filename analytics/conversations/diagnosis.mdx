...
Shows which [Connected Knowledge](/knowledge/sources/introduction) source files the agent retrieved for each turn. Click a source name to open an inline preview panel showing the retrieved content. Use **Open in Knowledge** in the panel to navigate directly to the source.
