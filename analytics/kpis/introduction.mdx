...
Go to **Analyze > Analytics** and select **Metrics** in the top right.

![Opening the Metrics panel from Agent analytics](/images/configuration-builder/metrics-open.png)
...
- [Post-call reporting](/analytics/custom-metrics/introduction) – combine real-time metrics with LLM extraction queries
