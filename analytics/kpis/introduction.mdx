...
description: "Define, register, and track boolean and categorical custom metrics for your agent so dashboards, Wren, and the Conversations API surface business KPIs."
keywords:
  - custom metrics
  - metrics
  - KPI
