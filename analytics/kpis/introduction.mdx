...
![The Metrics panel listing the metrics defined for an agent](/images/analytics/metrics-list.png)
...
![Selecting Metrics from the Edit menu on the Analytics page](/images/analytics/metrics-location.png)
...
![The Add Metric dialog with a name, description and metric type](/images/analytics/add-metric.png)
</Step>
