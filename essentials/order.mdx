...
This page explains how a PolyAI agent processes each turn of a conversation — from the moment a caller speaks to the moment the agent responds. Understanding this pipeline helps you diagnose latency, debug unexpected behavior, and decide where to place logic (start function vs. flow step vs. end function).
...
- **Postprocessing**: [Stop keywords](/response-control/introduction#use-stop-keywords-to-remove-unnecessary-preambles) remove unnecessary phrases before delivery.
