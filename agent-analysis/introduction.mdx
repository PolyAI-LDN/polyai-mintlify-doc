...
**Agent Analysis** uses an LLM to analyze and categorize calls based on a configurable prompt and list of categories. You can use it to generate quick, repeatable analysis of conversation quality and outcomes across groups of calls of up to **250**.
...
To request help setting up a useful prompt or category set, contact your PolyAI representative.