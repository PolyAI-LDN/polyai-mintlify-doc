...
<Frame caption="Agent Analysis dashboard with call categorization breakdown">
  ![Agent Analysis main dashboard](/images/analytics/agent-analysis-main.png)
</Frame>
...
<Frame caption="Analysis configuration interface">
  ![agent-analysis-config](/images/analytics/analysis-config.png)
</Frame>
...
Agent Analysis can run automatically on a **daily or weekly schedule**, helping you track category trends over time. This is useful for long-term performance monitoring and training outcome validation.
