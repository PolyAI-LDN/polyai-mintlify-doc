...
**Agent Analysis** uses an LLM to analyze and categorize calls based on a configurable prompt and list of categories, across groups of up to **250** calls.

![agent-analysis](/images/assistant-analysis-main.png)
