...
sidebarTitle: ADK
description: Manage Agent Studio projects locally with YAML and Python files using the PolyAI CLI.'
tag: "Code"
keywords:
  - ADK
...
Use ADK to version-control your agent, automate project authoring, and collaborate with Git-based workflows.
