...
When clicking around in Studio runs out, drop into Python. Write a function, hit your APIs, talk to your database, encode the business logic that lives in your head — and the agent calls it like any other tool. This is the path for the moments where the UI can't take you the last mile.
...
<Steps>
  ...
  <Step title="Explore advanced patterns">
    Read [flows](/flows/introduction), [call handoffs](/call-handoff/introduction), and [secrets management](/secrets/introduction) to build production integrations.
  </Step>
</Steps>
