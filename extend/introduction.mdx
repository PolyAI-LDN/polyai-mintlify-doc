...
Write Python functions to extend your agent beyond what the visual interface covers — call APIs, query databases, validate input, and encode custom business logic. The agent invokes your function like any other tool. Use this path when the UI can't express what you need.
