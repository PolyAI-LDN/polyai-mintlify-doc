...
- After logged in, click on the top right **“Create Assistant”** button to start the assistant creation process.

![create-assistant](/images/02-02-01-01-create-assistant.png]

## Step 2: Set Name, Response Language, Voice, and Greeting Line
...
## Step 5: [Optional] Select a Number for Telephony Integration
