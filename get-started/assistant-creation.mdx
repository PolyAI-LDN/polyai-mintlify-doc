...
## Updating/Configuring Assistant Settings
- In order to update addiitonal assistant settings, navigate to the CONFUGURE/Settings left nav item. I.e. the "Settings" item in the CONFIGURE section on the left navigation pane.
- Here you can udpate the following information
  - Assistant name
  - LLM that powers the interaction
  - Add a phone number (if you did not before)
  - Connect the Twilio account (if you did not before)

See the [Voice Configuration](/voice/introduction) section for more details on how to update Voice settings.
