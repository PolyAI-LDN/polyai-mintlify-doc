...
An even faster and simpler way to test your agent's voice and automatic speech recognition (ASR) without setting up telephony services is to use in-browser calling using your device microphone.
...
- **Knowledge testing**: Test items added to your [knowledge base](/managed-topics/introduction) or [global rules](/agent-settings/rules), including [TTS pronunciations](/agent-settings/rules#pronunciations).