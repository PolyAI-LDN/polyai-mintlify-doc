...
2. **Click the Webchat Button**:
   - Click on the top right **"Webchat"** button to open the chat interface.
...
Click on the "Settings" button to show or hide the function calls and topic citations settings.
