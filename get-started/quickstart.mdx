...
<Note>
  You're in [Agent Builder mode](/studio-assistant/introduction). This quickstart walks the self-serve 60-day free-trial path: Agent Builder scaffolds the agent, you embed via Web Calling. Click the **Free trial — exit** pill in the top-right corner for the full enterprise quickstart.
</Note>
...
<Steps>
  <Step title="Create your account (~1 min)">
    ...
    Your 60-day free trial starts now. No billing, no metering, no contract.
  </Step>
