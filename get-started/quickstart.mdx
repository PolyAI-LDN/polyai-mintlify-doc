...
By the end of this guide, you will have a working voice agent in Agent Studio — answering real questions, tested in Sandbox, and ready to promote to live. Total time: about 10 minutes.
...
<CardGroup cols={2}>
  ...
  <Card title="Voice conversation style guide" icon="comments" href="/voice/conversation-style-guide">
    Make your agent sound natural — linguistic patterns for spoken conversations
  </Card>
