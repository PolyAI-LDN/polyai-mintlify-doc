...
PolyAI supports different workflows depending on your role:

<CardGroup cols={3}>
  <Card title="Operator" icon="browser">
    **Agent Studio, no code**

    Build and manage agents through the visual UI. Configure knowledge, voice, and analytics without writing code. This quickstart is your starting point.
  </Card>
  <Card title="Developer" icon="terminal">
    **ADK + API**

    Build agents locally with Python and Git using the [PolyAI ADK](/extend/adk), or integrate programmatically with the [REST APIs](/api-reference/introduction). Start here for the basics, then move to the ADK docs.
  </Card>
  <Card title="Admin" icon="gear">
    **Deployment + analytics**

    Manage the [deployment pipeline](/environments-and-versions/introduction), configure [monitoring and alerts](/platform/monitoring), review [analytics](/analytics/dashboards/introduction), and control [user access](/user-management/introduction).
  </Card>
</CardGroup>

All three paths use the same platform and the same agents. An agent built through the UI can be updated via the ADK or APIs, and vice versa.
