...
<Steps>
  <Step title="Create your account (~1 min)">
    ...
    <Frame caption="Sign up with email or Google">
      <img src="/images/get-started/enter-your-details.png" alt="PolyAI sign-up page with email form and Google SSO option" />
    </Frame>
  ...
  <Step title="Describe your agent (~3 min)">
    ...
    <Frame caption="Agent Builder researches your website and searches for relevant blueprints">
      <img src="/images/studio-assistant/sa-researching.png" alt="Agent Builder researching a website and planning a new voice agent" />
    </Frame>

    <Frame caption="It asks clarifying questions about what the agent should do">
      <img src="/images/studio-assistant/sa-interactive-questions.png" alt="Agent Builder asking interactive questions about the agent's capabilities" />
    </Frame>

    <Frame caption="Review the plan — nothing changes until you click Approve">
      <img src="/images/studio-assistant/sa-plan-review.png" alt="Agent plan card with Revise and Approve buttons" />
    </Frame>
  ...
  <Step title="Refine knowledge and behavior (~3 min)">
    ...
    <Frame caption="Add or edit knowledge base topics in Build > Knowledge">
      <img src="/images/quickstart/add-kb-item.png" alt="Adding a knowledge base topic in Agent Studio" />
    </Frame>
    ...
    <Tabs>
      <Tab title="In-browser call">
        ...
        <Frame caption="Call your agent directly from the browser">
          <img src="/images/quickstart/op-voice-test.png" alt="Call agent side panel with environment set to Sandbox and a Start test call button" />
        </Frame>
      </Tab>
      <Tab title="Webchat preview">
        ...
        <Frame caption="Text-based chat preview with topic matching">
          <img src="/images/quickstart/op-webchat-test.png" alt="Test agent chat side panel showing matched topics and agent response" />
        </Frame>
      </Tab>
    </Tabs>
...
<Steps>
    ...
    <Tabs>
      <Tab title="Google SSO">
        ...
        <Frame caption="Sign in with Google SSO">
          <img src="/images/get-started/select-google-sso.png" alt="Google SSO sign-up screen" />
        </Frame>
      </Tab>
      <Tab title="Email and password">
        ...
        <Frame caption="Create an account with email and password">
          <img src="/images/get-started/enter-your-details.png" alt="Email and password sign-up form" />
        </Frame>
      </Tab>
    </Tabs>
  ...
  <Step title="Create your agent (~2 min)">
    ...
    <Frame caption="Agent creation wizard">
      <img src="/images/quickstart/create-agent.png" alt="Agent creation wizard with name, language, voice, and greeting fields" />
    </Frame>
  ...
  <Step title="Test your agent (~2 min)">
    <Tabs>
      <Tab title="In-browser call">
        ...
        <Frame caption="Call your agent directly from the browser">
          <img src="/images/get-started/test-call.png" alt="In-browser call test panel" />
        </Frame>
      </Tab>
      <Tab title="Webchat">
        Test with text-based chat, directly from Agent Studio.
        ...
        <Frame caption="Webchat test interface with topic matching">
          <img src="/images/get-started/webchat.png" alt="Webchat interface showing tool calls and topic citations" />
        </Frame>
  ...
  <Step title="Deploy to production (~1 min)">
    ...
    <Frame caption="Promote through environments to go live">
      <img src="/images/deployment/publish.png" alt="Deployment pipeline showing Sandbox to Live promotion" />
    </Frame>
