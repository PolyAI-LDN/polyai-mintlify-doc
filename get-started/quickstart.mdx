...
<Note>
  This quickstart walks the [Agent Builder](/agent-builder/introduction) path: Agent Builder scaffolds the agent, you embed via Web Calling. Agent Builder is available to **project admins on enterprise clusters** as well as free-trial accounts — the workflow is the same in both. Free-trial users can switch to the full enterprise quickstart from the **Free trial — exit** pill in the top-right corner.
</Note>
...
<Steps>
  ...
  <Step title="Describe your agent (~3 min)">
    ...
    <Frame caption="Agent Builder researches your website and searches for relevant blueprints">
      <img src="/images/agent-builder/sa-researching.png" alt="Agent Builder researching a website and planning a new voice agent" style={{ maxWidth: '720px', width: '100%', margin: '0 auto', display: 'block' }} />
    </Frame>

    <Frame caption="It asks clarifying questions about what the agent should do">
      <img src="/images/agent-builder/sa-interactive-questions.png" alt="Agent Builder asking interactive questions about the agent's capabilities" style={{ maxWidth: '720px', width: '100%', margin: '0 auto', display: 'block' }} />
    </Frame>

    <Frame caption="Review the plan — nothing changes until you click Approve">
      <img src="/images/agent-builder/sa-plan-review.png" alt="Agent plan card with Revise and Approve buttons" style={{ maxWidth: '720px', width: '100%', margin: '0 auto', display: 'block' }} />
    </Frame>

    See [Prompting Agent Builder](/agent-builder/prompting) for prompt patterns that work well.
  </Step>
...
<CardGroup cols={2}>
  <Card title="Master Agent Builder" icon="wand-magic-sparkles" href="/agent-builder/prompting">
