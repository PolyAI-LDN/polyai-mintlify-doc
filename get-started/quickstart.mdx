...
<Steps>
  <Step title="Create your agent">
    ...
    - **Voice** – Choose what your agent will sound like ([text-to-speech](https://en.wikipedia.org/wiki/Speech_synthesis) voice)
  ...
  <Step title="Add knowledge">
    ...
    **Optional:** Add more topics to expand your agent's capabilities. You can also:
    ...
    - Add [actions](/managed-topics/how-to-setup-action/introduction) to trigger [functions](/function/introduction) or [flows](/flows/introduction)

    See the full [Managed Topics guide](/managed-topics/introduction) for details on how [the system automatically finds the best answer for each question](/managed-topics/RAG/introduction).
  </Step>
  ...
  <Step title="Deploy to production">
    ...
    <Note>
      Some projects use a simplified pipeline that promotes directly from Sandbox to Live, skipping Pre-release.
    </Note>
...
<CardGroup cols={2}>
  ...
  <Card title="Configure voice settings" icon="microphone" href="/voice/introduction">
    Customize text-to-speech, add multiple voices, and tune audio settings
  </Card>
