...
<Steps>
  ...
  <Step title="Add knowledge">
    ...
    **Optional:** Add more topics to expand your agent's capabilities. You can also:
    ...
    - Connect external knowledge sources like [Zendesk](/integrations/zendesk) or [Google Sheets](/integrations/google-sheets) using [Connected Knowledge](/connected-knowledge/introduction)
