...
<Note>
  This quickstart uses [Agent Builder](/agent-builder/introduction) to scaffold the agent, then Web Calling to embed it. Available to project admins on enterprise clusters and to free-trial accounts. Free-trial users can switch to the full enterprise quickstart via the **Free trial — exit** pill.
</Note>
...
<Tip>
**Project admin?** [Agent Builder](/agent-builder/introduction) (Beta, admin-only) is the fastest way to scaffold an agent — describe what you want and it generates flows, topics, entities, and settings on a branch you can review. The manual steps below still work for any role.
</Tip>
