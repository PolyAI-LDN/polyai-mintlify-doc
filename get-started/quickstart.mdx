...
<Steps>
  <Step title="Create your account (~1 min)">
    ...
    ![Agent Studio onboarding screen asking for your company website URL](/images/home/agent-builder-onboarding.png)
  ...
  <Step title="Describe your agent to Studio Assistant (~3 min)">
    ...
    ![Studio Assistant researching a website and planning a new voice agent](/images/studio-assistant/sa-researching.png)

    ![Studio Assistant asking interactive questions about the agent's capabilities](/images/studio-assistant/sa-interactive-questions.png)

    ![Agent plan card with Revise and Approve buttons — nothing changes until you approve](/images/studio-assistant/sa-plan-review.png)
