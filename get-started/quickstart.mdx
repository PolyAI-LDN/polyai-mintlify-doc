...
<Note>
  This quickstart uses [Agent Builder](/studio-assistant/introduction) to scaffold the agent, then Web Calling to embed it. Available to project admins on enterprise clusters and to free-trial accounts. Free-trial users can switch to the full enterprise quickstart via the **Free trial — exit** pill.
</Note>
...
<Tip>
**Project admin?** [Agent Builder](/studio-assistant/introduction) (Beta, admin-only) is the fastest way to scaffold an agent — describe what you want and it generates flows, topics, entities, and settings on a branch you can review. The manual steps below still work for any role.
</Tip>
...
<Steps>
  ...
  <Step title="Add knowledge (~5 min)">
    ...
    **Optional:** Add more topics to expand your agent's capabilities. You can also:
    ...
    See the full [Managed Topics guide](/knowledge/faqs/introduction) for details on how [RAG](/knowledge/faqs/RAG/introduction) (retrieval-augmented generation) powers topic matching.
  </Step>
