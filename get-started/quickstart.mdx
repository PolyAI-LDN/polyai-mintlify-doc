...
<Steps>
  ...
  <Step title="Test your agent">
    First, publish your draft to Sandbox by clicking **Publish** in the top bar. Then click the **phone icon** <Icon icon="phone" size={18} /> in the top-right corner to start an in-browser call.
