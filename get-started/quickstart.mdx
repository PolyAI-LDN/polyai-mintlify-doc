...
<Steps>
  ...
  <Step title="Describe your agent (~3 min)">
    ...
    <Frame caption="Studio Assistant researches your website and searches for relevant blueprints">
      <img src="/images/agent-builder/sa-researching.png" alt="Studio Assistant researching a website and planning a new voice agent" style={{ maxWidth: '720px', width: '100%', margin: '0 auto', display: 'block' }} />
    </Frame>

    <Frame caption="It asks clarifying questions about what the agent should do">
      <img src="/images/agent-builder/sa-interactive-questions.png" alt="Studio Assistant asking interactive questions about the agent's capabilities" style={{ maxWidth: '720px', width: '100%', margin: '0 auto', display: 'block' }} />
    </Frame>
