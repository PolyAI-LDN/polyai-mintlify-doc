...
<Info>
  You can also a custom disclaimer message to precede the call using an alternate voice.
</Info>
...
* You may buy a number or connect an existing number to interact with your assistant. You can also skip this step and return later.
