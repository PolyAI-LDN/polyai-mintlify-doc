---
title: Quickstart
description: Sign up self-serve at studio.poly.ai, start free, and build and deploy your first agent in minutes.
keywords:
  - quickstart
  - getting started
  - first agent
...
<Tip>
**In a hurry?** [Wren](/wren/introduction) is the fastest way to scaffold an agent. Describe what you want and it generates flows, topics, entities, and settings on a Branch you can review and publish. The manual steps below still work if you'd rather build it by hand.
</Tip>
...
<Steps>
  ...
  <Step title="Add knowledge (~5 min)">
    ...
    Changes save to your Branch in **Sandbox** as you go, ready to test. Learn more about [environments and versions](/environments-and-versions/introduction).
  ...
  <Step title="Publish to Live (~1 min)">
    Publish your agent onto Live:

    1. Go to **Deployments** in the sidebar
    2. Optional: move your Branch to **Staging** for user acceptance testing (Branches and Sub-branches modes only)
    3. Click **Publish** (top-right) to put your Branch on Live
    ...
    <Frame caption="Publish onto Live to go live">
      <img src="/images/deployment/publish.png" alt="Publishing from Sandbox onto Live" style={{ maxWidth: '720px', width: '100%', margin: '0 auto', display: 'block' }} />
    </Frame>

    When you publish, your changes merge onto Live. If a change goes wrong, you can roll Live back to any previous version in one step. See the [Deployments guide](/environments-and-versions/introduction#rolling-back-a-change) for details.
  </Step>
</Steps>
