...
<Note>
  This quickstart walks the [Agent Builder](/studio-assistant/introduction) path: Agent Builder scaffolds the agent, you embed via Web Calling. Agent Builder is available to **project admins on enterprise clusters** as well as free-trial accounts — the workflow is the same in both. Free-trial users can switch to the full enterprise quickstart from the **Free trial — exit** pill in the top-right corner.
</Note>
...
<Tip>
**Project admin?** [Agent Builder](/studio-assistant/introduction) (Beta) is now available on enterprise clusters and is the fastest way to scaffold an agent: describe what you want, it generates flows, topics, entities, and settings on a branch you can review before merging. The manual steps below still work — Agent Builder edits the same building blocks. See the [Agent Builder overview](/studio-assistant/introduction) and [prompting guide](/studio-assistant/prompting).
</Tip>
