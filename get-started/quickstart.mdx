...
<Note>
  You're in [Agent Builder mode](/platform/open-platform). This quickstart walks the self-serve 60-day free-trial path: Agent Builder scaffolds the agent, you embed via Web Calling. Click the **Free trial — exit** pill in the top-right corner for the full enterprise quickstart.
</Note>
