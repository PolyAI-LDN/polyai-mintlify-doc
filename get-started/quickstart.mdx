...
<Steps>
  ...
  <Step title="Deploy to production (~1 min)">
    ...
    2. Move it to **Staging** for user acceptance testing (optional)
    3. **Publish** to make your agent production-ready
    ...
    When ready, publish: your changes merge onto Live, and you can roll Live back to any previous version if issues arise. See the [Deployments guide](/environments-and-versions/introduction) for details.
  </Step>
</Steps>
