...
<Steps>
  ...
  <Step title="Describe your agent to Studio Assistant (~3 min)">
    ...
    <Frame caption="Studio Assistant researches your website and searches for relevant blueprints">
      <img src="/images/studio-assistant/sa-researching.png" alt="Studio Assistant researching a website and planning a new voice agent" />
    </Frame>

    <Frame caption="It asks clarifying questions about what the agent should do">
      <img src="/images/studio-assistant/sa-interactive-questions.png" alt="Studio Assistant asking interactive questions about the agent's capabilities" />
    </Frame>
