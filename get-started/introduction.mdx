...
The sidebar organizes Agent Studio into the sections below. The [top toolbar](/get-started/top-toolbar) runs across every page — project and branch selectors, Studio Assistant, Share, Preview agent, and Promote. Coming from the old Build/Channels/Configure layout? See [What's new](/get-started/whats-new).
