...
The Agent Studio sidebar groups related features into focused sections. The [top toolbar](/get-started/top-toolbar) runs across every page and holds the controls you use most: project and branch selectors, Studio Assistant, Share, Preview agent, and Promote. See [Meet the new Agent Studio](/get-started/whats-new) if you're coming from the previous Build/Channels/Configure layout.
