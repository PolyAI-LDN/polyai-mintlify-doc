---
title: Agent Studio
description: Agent Studio is PolyAI's self-serve visual interface for building, deploying, and monitoring voice agents. Sign up at studio.poly.ai.
...
<Steps>
  <Step title="Build your first agent">
    [Quickstart guide](/get-started/quickstart) – create an account, build an agent, add knowledge, test, and publish.
  </Step>
...
Manage your Branches, publish to Live, view Live history, roll back and run A/B tests. See [Deployments](/environments-and-versions/introduction).
...
<Frame caption="Theme options under Appearance: light, dark, or match your system">
  <img src="/images/get-started/theme-toggle.png" alt="Theme setting with light, dark, and system options" style={{ maxWidth: '820px', width: '100%', margin: '0 auto', display: 'block' }} />
</Frame>
