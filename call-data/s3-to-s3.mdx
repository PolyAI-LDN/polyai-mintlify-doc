...
description: "Automatically sync call recordings and transcripts to your S3 bucket for long-term storage and compliance."
tag: "Code"
---

Automatically sync call transcripts and audio recordings to your own [AWS S3](https://aws.amazon.com/s3/) bucket for long-term storage, compliance archiving, and integration with internal data pipelines. This approach provides scalable, downloadable access to conversation data.
