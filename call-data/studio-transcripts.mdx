...
<Info>
PolyScore is now powered by **GPT-5**, providing more accurate and nuanced quality assessments.
</Info>
...
<Info>
Call summaries are now powered by **GPT-5** for improved accuracy and comprehensiveness.
</Info>