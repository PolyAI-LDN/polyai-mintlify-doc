...
![test-suite](/images/polyscore.png)

When enabled, PolyScore appears at the top of certain transcripts and provides an automatic quality rating for the conversation. Scores are generated using internal criteria like clarity, escalation handling, and issue resolution. Use PolyScore to quickly identify strong and weak calls for review, coaching, or reporting.