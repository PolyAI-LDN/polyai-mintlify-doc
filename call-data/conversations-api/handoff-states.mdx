...
* [The Handoff State feature page](/managed-topics/how-to-setup-action/handoff)
...
Use the [handoff tab](/managed-topics/how-to-setup-action/handoff) to set up a basic handoff function without using the API directly.
...
For detailed integration steps, visit the [Handoff State](/managed-topics/how-to-setup-action/handoff) feature page. Below are some general recommendations:
...
* [The handoff state feature page](/managed-topics/how-to-setup-action/handoff): More information on integrating handoff states into studio flows and functions.