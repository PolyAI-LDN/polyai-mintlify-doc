...
<Tip>New integrations should use the [Conversations API](/api-reference/conversations/introduction) (`https://api.{region}.platform.polyai.app/v3/{account_id}/{project_id}/conversations`). It is the official supported offering. The [Data API](/api-reference/data/introduction) (`https://api.{region}.poly.ai/v1/agents/{agent_id}/conversations`) is deprecated but remains available for existing integrations.</Tip>
