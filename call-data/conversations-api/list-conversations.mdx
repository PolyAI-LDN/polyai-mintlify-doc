...
Each conversation in the response includes a `state` field containing all [conversation variables](/tools/variables) (`conv.state` values) set during the call — both built-in keys and custom variables your agent writes.
