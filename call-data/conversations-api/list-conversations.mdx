...
<Tip>**New integrations should use the [Data API – List conversations](/api-reference/data/endpoint/list-conversations) endpoint** (`https://api.{region}.poly.ai/v1/agents/{agent_id}/conversations`). It is the official supported offering. The legacy [Conversations API v3](/api-reference/conversations/introduction) (`https://api.{region}.platform.polyai.app/v3/{account_id}/{project_id}/conversations`) remains available for existing integrations.</Tip>
