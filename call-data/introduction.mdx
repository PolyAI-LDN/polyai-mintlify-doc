...
<Info>
For programmatic data export, transfer state tracking, and automatic file sync, expand **API and export** in the sidebar. These guides may require help from your technical team.
</Info>
...
<CardGroup cols={2}>
  ...
  <Card title="Studio transcripts" icon="desktop" href="/call-data/studio-transcripts">
    Access conversation transcripts and recordings directly in [Agent Studio](https://jupiter.polyai.app/).
  </Card>
