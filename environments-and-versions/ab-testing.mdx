...
You also need write access to environments. Run a regression pass on the variant against your [test suite](/simulation-testing/introduction) before promoting it to Pre-release — A/B testing measures real-world performance, not correctness.
