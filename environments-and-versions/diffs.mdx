...
The **Compare versions** tool lets you view a side-by-side diff of any two versions in your project. It covers your entire project — knowledge base topics, functions, flows, variants, and settings — so you can see exactly what changed before promoting or publishing.
...
- [Project history](/environments-and-versions/project-history) — View a chronological record of all published versions. Use Project history to find versions to compare, audit when changes went live, and roll back if needed.
