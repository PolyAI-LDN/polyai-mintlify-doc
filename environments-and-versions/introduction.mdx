...
<Note>
**Draft** is the unpublished working state inside the Sandbox environment. When you publish a draft, it becomes a new version deployed to Sandbox. There are three deployment environments: **Sandbox**, **Pre-release**, and **Live**.
</Note>
...
A <Tooltip tip="An unpublished set of changes to your agent. Publishing a draft creates a new version in Sandbox.">draft</Tooltip> version
...
2. Click the **options menu** (three vertical dots) next to the version.
