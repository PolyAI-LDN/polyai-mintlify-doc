...
<Frame caption="Draft banner with delete and publish options">
...
<Frame caption="Published version in Sandbox environment">
...
<Frame caption="Assign phone numbers to different environment versions">
