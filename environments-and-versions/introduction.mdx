...
description: 'Manage assistant versions, testing, and deploying updates.'
---

The PolyAI user platform uses project versioning to develop, test, and deploy updates to assistants. Each version represents a
...
is created whenever changes are made to an assistant. A draft banner appears at the top of the page, allowing you to:

![delete-publish](/images/deployment/deployments-1.png)
...
Once published, the version becomes your active <Tooltip tip="Development environment where users build, change, and test versions of an assistant.">Sandbox</Tooltip> deployment
you can access it from the **Environments and Versions** page.

![delete-publish](/images/deployment/deployments-2.png)
...
and <Tooltip tip="The production environment. This is where the assistant handles live traffic.">Live</Tooltip>.
...
The live environment, also referred to as production, is where your assistant handles real traffic.
...
<Tabs>
  <Tab title="Confirm">
    ![initiate release](/images/deployment/deployments-3.png)

  </Tab>
  <Tab title="Complete">
    ![release confirmed and live](/images/deployment/deployments-4.png)
...
<Tabs>
  <Tab title="Initiate">
    ![initiate rollback](/images/deployment/deployments-5.png)

  </Tab>
  <Tab title="Confirm">
    ![confirm rollback](/images/deployment/deployments-6.png)
...
Main page: [Assistant Chat](/get-started/assistant-chat)

You can test your assistant by interacting with it in different environments. This helps identify issues and refine prompts.
...
![assign version phone numbers](/images/deployment/deployments-7.png)
