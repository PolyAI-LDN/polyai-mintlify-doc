...
1. Click **Test** in the top-right corner of the agent page to open the **Agent Debugging** side panel.

2. Choose how you want to debug:
    - **Call agent** — voice debugging via in-app call.
    - **Chat with agent** — voice agent debugging via in-app chat.
    - **Webchat** — webchat agent debugging via in-app chat.

3. Select the environment containing the version you want to test.
