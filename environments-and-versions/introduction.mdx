...
Studio Assistant uses two environments: **Sandbox** for testing changes, and **Live** where real callers reach your agent. Publish a version to Sandbox, validate it, then promote it to Live.
...
<Frame caption="Deployments page in Studio Assistant mode showing the Sandbox tab with a list of published versions">
  <img src="/images/deployment/op-deployments-list.png" alt="Deployments page in Studio Assistant mode showing the Sandbox tab with a list of published versions" style={{ maxWidth: '720px', width: '100%', margin: '0 auto', display: 'block' }} />
</Frame>
...
<CardGroup cols={2}>
  ...
  <Card title="Simulation testing" icon="flask-vial" href="/simulation-testing/introduction">
