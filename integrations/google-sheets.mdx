---
title: "Google Sheets"
description: "Read and write to Google Sheets from your agent."
---

Read from and write to Google Sheets for lookup tables, call logging, or dynamic content.

## Quick setup (Paragon integration)

Connect Google Sheets directly from the **Integrations** page in Agent Studio using OAuth.
...
4. Click **Connect new account** and authenticate with Google via OAuth
5. Enable Google Sheets actions in your agent's prompt
...
Reference Google Sheets actions in your agent's prompts. See the [Zoom integration](/integrations/zoom#enabling-zoom-actions) for detailed examples of this pattern.

---

## Manual setup (service account)

For advanced use cases requiring write access or custom API calls, you can integrate Google Sheets manually with a service account.
