...
<CardGroup cols={3}>
  ...
  <Card title="Chat handoff" href="/integrations/chat/introduction" icon="comments">
    Hand off webchat and SMS to Salesforce, Zendesk, NICE CXone, Amazon Connect, Genesys, or Webex
  </Card>
</CardGroup>
...
<CardGroup cols={3}>
  <Card title="MCP integrations" href="/mcp/agent-studio-integrations" icon="plug">
