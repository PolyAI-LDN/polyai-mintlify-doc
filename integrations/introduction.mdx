...
<CardGroup cols={3}>
  ...
  <Card title="Genesys Cloud chat handoff" href="/integrations/messaging/genesys" icon="comments">
    Hand off webchat conversations to live agents via Open Messaging
  </Card>
</CardGroup>
