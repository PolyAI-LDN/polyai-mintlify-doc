...
description: PolyAI integrates with the platforms enterprises already use — telephony, CRM, hospitality, healthcare, and payments — so your agent can take real action during calls.
mode: wide
---

A voice agent is only as useful as the systems it can reach. PolyAI integrates with the platforms enterprises already use — telephony for call routing, CRMs for customer context, and vertical systems for hospitality, healthcare, and payments — so your agent can take real action during calls, not just answer questions.

Connect to your contact center for live agent handoffs, look up reservations in OpenTable, create tickets in Salesforce, or pull patient records from Epic. All integrations listed here are available from **Configure > Integrations** in Agent Studio.
