---
title: 'OpenTable'
description: 'Connect your PolyAI voice agent to OpenTable Core and Pro to automate restaurant reservations, availability checks, and booking changes over the phone.'
---
