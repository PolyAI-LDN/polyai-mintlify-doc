---
title: "OpenTable"
description: "Connect your PolyAI agent to OpenTable for automated restaurant reservation management."
---
...
`POST` [https://oauth.opentable.com/api/v2/oauth/token?grant_type=client_credentials](https://oauth.opentable.com/api/v2/oauth/token?grant_type=client_credentials)
...
<CardGroup cols={2}>
  <Card title="Integrations overview" icon="plug" href="/integrations/introduction">
