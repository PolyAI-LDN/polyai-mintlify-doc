...
PolyAI's OpenTable integration enables AI voice assistant capability for both [Core](https://www.opentable.com/restaurant-solutions/plans/core/) and [Pro](https://www.opentable.com/restaurant-solutions/plans/pro/) OpenTable
