...
[PCI Pal](https://www.pcipal.com/) enables secure phone payments while maintaining PCI DSS compliance. Callers are transferred to PCI Pal to enter card details, then returned to your agent.
