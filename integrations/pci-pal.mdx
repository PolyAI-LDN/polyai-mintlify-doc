---
title: "PCI Pal"
description: "Enable secure payment processing with PCI Pal and PolyAI."
---

[PCI Pal](https://www.pcipal.com/) is a cloud-based secure payment solution that enables businesses to take payments over the phone while maintaining PCI DSS compliance. The integration allows PolyAI voice agents to securely transfer callers to PCI Pal's payment environment.
