...
<Steps>
  ...
  <Step title="Test in sandbox">
    PolyAI configures the integration for your test environment.
  </Step>
  <Step title="Publish to Live">
    After successful testing, PolyAI configures the integration for Live. You then publish your agent.
  </Step>
</Steps>
