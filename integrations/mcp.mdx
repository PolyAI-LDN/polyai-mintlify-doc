...
<Note>This page covers connecting Agent Studio **to** third-party MCP servers as a client. PolyAI does not currently expose its own MCP server for external tools to connect to your agents.</Note>
