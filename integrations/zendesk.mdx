---
title: 'Zendesk Talk'
description: 'Connect to Zendesk Talk to route inbound calls and hand off calls to live agents via SIP.'
---

Route calls through Zendesk Talk and hand off to Zendesk agents via SIP. This integration enables inbound call handling with seamless agent escalation.
