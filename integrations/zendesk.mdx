---
title: 'Zendesk'
description: 'Connect PolyAI to Zendesk for call handoffs and ticket management.'
---

Zendesk integrates with PolyAI in two ways: **ticket management** (search and update tickets during calls) and **call handoff** (route calls to Zendesk agents via SIP).
...
Reference Zendesk actions in your agent's prompts. See the [Zoom integration](/integrations/zoom#enabling-zoom-actions) for detailed examples of this pattern.
