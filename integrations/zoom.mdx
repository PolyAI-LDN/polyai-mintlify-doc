...
description: "Connect PolyAI to Zoom Contact Center via SIP trunk."
---

PolyAI integrates with **Zoom Contact Center (ZCC)** as a third-party voice agent via a SIP trunk. This allows PolyAI to handle inbound calls within your Zoom Contact Center environment.
