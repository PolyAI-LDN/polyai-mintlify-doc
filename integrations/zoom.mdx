...
description: "Integrate PolyAI with Zoom Contact Center for voice agent handling via SIP trunk."
---

Connect PolyAI to **Zoom Contact Center (ZCC)** as a third-party voice agent via a SIP trunk. This allows PolyAI to handle inbound calls within your Zoom Contact Center environment.
...
PolyAI connects to Zoom Contact Center through a SIP trunk. When a call arrives at your Zoom Contact Center, it can be routed to PolyAI for automated handling. If the agent needs to escalate, the call is transferred back to a live agent within Zoom Contact Center.
