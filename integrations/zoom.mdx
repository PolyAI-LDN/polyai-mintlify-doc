...
To disconnect the Zoom integration and revoke PolyAI's access to your Zoom account:

1. Go to **Configure > Integrations** in your project
2. Find the Zoom integration card
3. Click the **Disconnect** button next to the connected account
4. Confirm the disconnection

**What happens when you disconnect:**
- PolyAI immediately deletes the stored OAuth credentials for your Zoom account
- Your agent will no longer be able to perform Zoom actions (create meetings, manage registrants, etc.)
- Existing meetings created by the agent are not affected — they remain in your Zoom account
- If the agent attempts a Zoom action after disconnection, it will fail gracefully

**To also revoke access from the Zoom side:**
...
4. Find the PolyAI app and click **Uninstall**

<Note>
Disconnecting from PolyAI is sufficient to stop all access. Uninstalling from the Zoom Marketplace is an optional additional step for complete removal.
</Note>
...
- [Review PolyAI integration documentation](/integrations/introduction)
