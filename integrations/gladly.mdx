---
title: "Gladly"
description: "Connect your PolyAI agent to Gladly for real-time knowledge base access."
---
...
<Note>This integration is available from **Configure > Integrations** in Agent Studio under **Knowledge base**.</Note>
