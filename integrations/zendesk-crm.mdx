...
PolyAI integrates with Zendesk CRM so that virtual agents can retrieve ticket information and update records in real time. Authentication uses API tokens with permission-based access.
