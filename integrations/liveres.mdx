---
title: "LiveRes (Zonal)"
description: "Connect PolyAI to LiveRes for restaurant reservation management."
---

[LiveRes](https://www.zonal.co.uk/products/liveres/) is a restaurant reservation system owned by Zonal, widely used across the UK hospitality industry. It provides booking management, table allocation, and guest communication tools.

PolyAI's integration enables voice agents to interact directly with LiveRes, allowing callers to make, modify, and cancel reservations through natural conversation.
