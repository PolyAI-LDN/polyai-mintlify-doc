---
title: 'NICE CXone'
description: 'Connect your PolyAI agent to NICE CXone using the Signal API.'
---

The PolyAI and NICE CXone integration uses NICE's [Signal API](https://developer.niceincontact.com/API/AdminAPI#/Contacts/Signal%20a%20Contact) to manage handoff and voice interactions. This guide provides steps for setup, configuration, and using the integration effectively.
