---
title: 'Five9'
description: 'Connect your PolyAI agent to Five9 via SIP trunk for call routing and handoffs.'
---

Connect PolyAI to Five9 via a shared SIP trunk for call routing and live-agent handoff. This guide covers setup, routing methods, and transfer configuration.
