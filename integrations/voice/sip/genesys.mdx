...
provide call handling, routing, and handoff capabilities. This guide explains how to integrate your Genesys Cloud instance with the PolyAI app available on the
