---
title: 'Custom SIP'
description: 'Access SIP headers for dynamic routing and personalization.'
---

Access SIP headers to extract caller metadata and route calls dynamically.
...
- You're performing an attended or blind transfer within the same SIP domain
...
<Info>
The `outbound_endpoint` value is provided by PolyAI during your SIP integration setup. Contact your PolyAI account manager or [support@poly.ai](mailto:support@poly.ai) if you need this value.
</Info>
