...
<Steps>
  ...
  <Step title="Add your phone numbers">
    Add the Twilio numbers you want to route to PolyAI for **Staging** and **Live**. [Sandbox](/environments-and-versions/environments#sandbox) has no channel connections, so you test there over an in-app call instead. The form still shows a **Sandbox** field; leave it empty. Numbers must be in E.164 format with a country code (e.g. `+441234567890`).
  </Step>
  <Step title="Submit">
