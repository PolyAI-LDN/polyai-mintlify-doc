...
<Note>
For basic Twilio number and SMS setup, see [Configure > Numbers > Twilio](/voice-channel/numbers/twilio/introduction).
</Note>
...
After the integration is connected, configure how calls transfer back to human agents in **Build > Call handoffs**. See [Call handoffs](/voice-channel/handoffs) for the full reference.

## Related pages

- [Configure > Numbers > Twilio](/voice-channel/numbers/twilio/introduction) — basic Twilio number and SMS setup
