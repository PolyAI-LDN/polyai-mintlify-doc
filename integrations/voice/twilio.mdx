...
<Note>
This page covers the **advanced Twilio Flex integration** for contact centers. For basic Twilio phone number and SMS setup, see the [Telephony > Twilio guide](/telephony/twilio/introduction).
</Note>
