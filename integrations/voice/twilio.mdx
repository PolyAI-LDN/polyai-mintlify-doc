...
Route calls to PolyAI through [Twilio Flex](https://www.twilio.com/en-us/flex/use-cases/contact-center) and manage [handoffs](/call-handoff/introduction) to live agents via SIP or Twilio Studio. Handle complex customer queries automatically or escalate to human agents.
