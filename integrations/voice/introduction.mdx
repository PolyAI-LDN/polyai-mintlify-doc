...
PolyAI integrates with voice platforms for call routing, SIP data exchange, and live-agent handoffs. Most telephony integrations can be connected from **Configure > Integrations** in Agent Studio — see [CCaaS quick setup](/integrations/voice/quick-setup) for the shared self-serve flow.
