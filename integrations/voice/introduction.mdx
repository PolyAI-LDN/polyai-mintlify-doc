...
PolyAI supports integrations with various voice platforms to connect your assistant with telephony environments. These integrations enable advanced call routing, real-time data exchange, and smooth handoffs to live agents. Below is an overview of the supported voice platforms, organized by their specific features and purposes.

## Supported voice integrations

### Amazon Connect
- **Purpose**: [Integrate PolyAI voice assistants with Amazon Connect](./amazon-connect) for automated call handling and live-agent handoffs.
...
### NICE CXone
- **Purpose**: [Integrate PolyAI with NICE CXone](./sip/NICEXCOne) to enable pseudo-number routing and Signal API-based handoffs.
- **Features**: Advanced metadata handling and custom configuration options.

### Five9
- **Purpose**: [Route calls to PolyAI assistants using Five9’s flexible SIP trunking options](./sip/five9).
...
- **Features**: Dynamic call routing and integration with PolyAI assistants.
...
For additional assistance, contact **support@polyai.com**.