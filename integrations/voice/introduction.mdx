...
| **[Avaya RCMS](/integrations/voice/avaya-rcms)** | Managed | RCMS WebSocket bridge, live transcripts, queue and URI handoffs |
...
<Note>
Custom SIP, DNI Pooling, and Avaya RCMS require coordination with your PolyAI account manager. All other telephony integrations can be connected directly from Agent Studio.
</Note>
