...
## 1. Create the CXone channel and collect IDs

1. In CXone, go to **Digital > Points of Contact Digital**.
2. Click the red **Chat** button near the top.
3. Create a new messaging channel, or pick an existing one.
4. Open the channel and click **Basics**.
5. Record three values – you'll paste them into Studio:
   - **Brand ID**
   - **Channel ID**
   - **Environment** – read it from the URL (for example `NA1`, `EU1`).
...
In Agent Studio, open **Configure > Integrations** and click **Connect** on the **NICE CXone Messaging** tile. Paste the **Brand ID**, **Channel ID**, and **Environment** values from the CXone channel.
