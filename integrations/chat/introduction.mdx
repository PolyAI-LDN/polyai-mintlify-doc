...
<CardGroup cols={3}>
  ...
  <Card title="Genesys Cloud" href="/integrations/chat/genesys" icon="headset">
    Hand off through Genesys Open Messaging.
  </Card>
  <Card title="Webex by Cisco" href="/integrations/chat/webex" icon="webex">
    Hand off to Webex Contact Center. Generally available 19 June 2026.
  </Card>
</CardGroup>
...
| Genesys Cloud (Open Messaging) | [Genesys Cloud](/integrations/chat/genesys) |
...
Five9 chat handoff is on the roadmap but is currently blocked on the Five9 side. Talkdesk and other CCaaS providers can be scoped as custom integrations.
