...
2. [Adjust the widget position](/widgets/install#widget-positioning-chat-widgets) using CSS on the `#poly-ai-chat` element (Chat widgets). Test on mobile, where banners often cover more screen space.
