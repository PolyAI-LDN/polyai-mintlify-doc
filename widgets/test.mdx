...
- Anyone with the link can place a call against the configured environment, so use **Sandbox**<span className="full-only"> or **Pre-release**</span> for share-outs unless you specifically want stakeholders on production.
