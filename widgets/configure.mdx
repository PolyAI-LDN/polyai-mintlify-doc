...
Build a PolyPhone widget that matches your brand and ship it from **Configure > Polyphone** in Agent Studio. Three tabs: **Styling**, **Content**, **Embed**. The right rail has a live preview that updates as you type.

## Create the widget

From **Configure > Polyphone**, click **Add widget** to open the dialog. Fill in:
...
![Styling tab in Configure > Polyphone with the Agent name field, Color theme toggle, and a live preview of the widget on the right](/images/widgets/op-styling.png)
...
<ParamField path="Color theme" type="dropdown">
  Choose between **Dark** or **Light** – the preset visual treatment applied to the widget background, animation, and buttons. Stored as `theme_color` (`"dark"` or `"light"`) on the PolyPhone configuration. PolyPhone does not accept a custom hex value in v1.
</ParamField>
