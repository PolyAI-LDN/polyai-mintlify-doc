...
Build a Web Calling widget that matches your brand and ship it from **Widgets** in Agent Studio. Three tabs: **Styling**, **Content**, **Embed**. The right rail has a live preview that updates as you type.

## Create the widget

From **Widgets**, click **Add widget** to open the dialog. Fill in:
...
<Frame caption="Styling tab in Widgets with live preview">
  <img src="/images/widgets/op-styling.png" alt="Widget editor Styling tab showing Agent name field, Color theme toggle, and a live preview of the widget" style={{ maxWidth: '720px', width: '100%', margin: '0 auto', display: 'block' }} />
</Frame>
...
<Frame caption="Content tab with disclaimers enabled and consent preview">
  <img src="/images/widgets/content-tab.png" alt="Widget editor Content tab showing disclaimer message, company policies, and a live preview with consent button" style={{ maxWidth: '720px', width: '100%', margin: '0 auto', display: 'block' }} />
</Frame>
...
<Note>
Transient call-state strings (e.g. "Connecting…", "In call", "Mute") aren't editable in v1.
</Note>
...
<Frame caption="Embed tab with script tag and publish status">
  <img src="/images/widgets/embed-tab.png" alt="Embed tab showing the copyable script tag and publish status" style={{ maxWidth: '720px', width: '100%', margin: '0 auto', display: 'block' }} />
</Frame>
...
<Frame caption="Styling tab with agent name and color theme controls">
  <img src="/images/widgets/styling-tab.png" alt="Widget editor Styling tab with agent name and color theme controls" style={{ maxWidth: '720px', width: '100%', margin: '0 auto', display: 'block' }} />
</Frame>
...
<Frame caption="Content tab with disclaimers and consent preview">
  <img src="/images/widgets/content-tab.png" alt="Widget editor Content tab showing disclaimer message, company policies, and live consent preview" style={{ maxWidth: '720px', width: '100%', margin: '0 auto', display: 'block' }} />
</Frame>
