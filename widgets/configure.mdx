...
<ParamField path="Primary / theme color" type="string">
  Accent color for the launcher and primary actions. Pick from the brand swatches or enter a hex code. Example: `#c3da28`. Stored as `theme_color` for Phone widgets and as `color` for Chat widgets – same control, same effect.
</ParamField>
