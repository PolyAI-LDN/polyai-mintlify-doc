...
<Frame caption="Styling tab in Configure > Web Calling with live preview">
  <img src="/images/widgets/op-styling.png" alt="Widget editor Styling tab showing Agent name field, Color theme toggle, and a live preview of the widget" />
</Frame>
...
<Frame caption="Content tab with disclaimers enabled and consent preview">
  <img src="/images/widgets/content-tab.png" alt="Widget editor Content tab showing disclaimer message, company policies, and a live preview with consent button" />
</Frame>
...
<Frame caption="Embed tab with script tag and publish status">
  <img src="/images/widgets/embed-tab.png" alt="Embed tab showing the copyable script tag and publish status" />
</Frame>
...
<Frame caption="Styling tab with agent name and color theme controls">
  <img src="/images/widgets/styling-tab-agent.png" alt="Widget editor Styling tab with agent name and color theme controls" />
</Frame>
...
<Frame caption="Content tab with disclaimers and consent preview">
  <img src="/images/widgets/content-tab.png" alt="Widget editor Content tab showing disclaimer message, company policies, and live consent preview" />
</Frame>
