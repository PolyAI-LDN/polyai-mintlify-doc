...
<Note>
**Phone only on the Open platform.** PolyPhone is the voice widget you embed; the Chat widget is enterprise. The rest of this section covers configuration, install, and testing for the Phone widget.
</Note>
</div>
...
- An **HTTPS** site. Required for the Phone widget (microphone access).<span className="full-only"> Recommended for Chat.</span>
