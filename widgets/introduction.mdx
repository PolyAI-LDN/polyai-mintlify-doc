...
The Web Calling widget embeds your agent on your website. Visitors click the launcher and their browser connects to the agent over WebRTC. Configure it under **Widgets** in Agent Studio: name, domain, environment, branding, copy, and embed snippet.
