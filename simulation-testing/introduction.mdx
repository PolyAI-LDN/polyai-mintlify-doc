...
description: "Save and re-run conversations as simulation tests to check for regressions."
tag: "Advanced"
keywords:
  - simulation testing
  - test suite
...
<Note>
  **Simulation testing replaces Test suite.** The previous Test suite is being sunset. Existing test cases and test sets migrate automatically. Studio Assistant can also author, run, and maintain simulation tests for you — see [Studio Assistant](/studio-assistant/introduction).
</Note>

Use **Simulation testing** to save conversations as test cases, group them into sets, and re-run them against Draft or Sandbox after every change.

Simulation tests are found in the **Simulation testing** section of Agent Studio. The section has two tabs:
...
- Go to **Simulation testing > Test Sets** and select **New set**.
