...
<Frame caption="Configuration Builder with schema and data tabs">
...
<Frame caption="Schema definition editor">
...
<Frame caption="Real-time configuration data entry UI">
...
<Frame caption="Configuration UI available for all environments after schema setup">
