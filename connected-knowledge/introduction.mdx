...
Connected Knowledge does **not** replace [Managed Topics](/managed-topics/introduction). They work together, and each offers different levels of control and complexity. Both use [RAG (retrieval-augmented generation)](https://en.wikipedia.org/wiki/Retrieval-augmented_generation) to match user queries.
...
1. Go to **Build > Knowledge** and select the **Connected Knowledge** tab
2. Select **New source**
3. Choose one of:
   - **Upload files**
   - **Add URL**
...
If the [Managed Topics](/managed-topics/introduction) and Connected Knowledge contain conflicting data, **the Managed Topics wins**. Content from Managed Topics is always prioritised
