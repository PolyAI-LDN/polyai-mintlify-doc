...
Connected knowledge does **not** replace [Managed Topics](/managed-topics/introduction). Both tabs live under the **Knowledge** area in Build, and each offers different levels of control and complexity. Both use smart matching to find the right answer for each question.
...
| **Managed Topics tab**   | Solves the need for actions, functions, flows, SMS triggers, and offers precise, curated control over what the agent says.                | Ideal for agentic behaviour, structured and stable knowledge, and projects requiring complex logic or fine-grained control. |
