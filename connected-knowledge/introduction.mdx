...
Knowledge connection does **not** replace the [Managed Topics](/knowledge-base/introduction). They work together, and each offers different levels of control and complexity.
...
| **URL scraping** | Public documentation pages and help centre articles |
| **Zendesk** _(beta)_ | Help Centre content with API sync |
