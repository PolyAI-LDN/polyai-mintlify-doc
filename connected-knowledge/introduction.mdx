---
title: "Connected Knowledge Overview"
...
## How Connected Knowledge differs from the Knowledge Base

Both the Connected Knowledge and Knowledge Base tabs expose information to your agent. They differ in the following ways:
...
| **Zendesk** _(beta)_ | Help centre + API access                  |
...
If the Knowledge Base and Connected Knowledge contain conflicting data, **the Knowledge Base wins**. Knowledge base content is always prioritised
...
- Connected Knowledge data and Knowledge Base topics are merged at runtime.
